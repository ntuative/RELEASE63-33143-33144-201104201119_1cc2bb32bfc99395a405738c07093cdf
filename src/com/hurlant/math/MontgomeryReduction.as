package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1844 = param1.invDigit();
         this.var_1843 = this.var_1844 & 32767;
         this.var_2529 = this.var_1844 >> 15;
         this.var_2528 = 131071;
         this.var_2530 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_168) > 0)
         {
