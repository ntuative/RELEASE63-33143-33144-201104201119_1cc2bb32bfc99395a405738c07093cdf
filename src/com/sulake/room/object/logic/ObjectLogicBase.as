package com.sulake.room.object.logic
{
   ...
   public class ObjectLogicBase implements IRoomObjectEventHandler
   {
      ...
      private var var_390:IRoomObjectController;
      ...
      {
         if(this.var_390 == param1)
         {
            return;
         }
         if(this.var_390 != null)
         {
            this.var_390.setEventHandler(null);
         }
         if(param1 == null)
         {
            this.dispose();
         ...
         {
            this.var_390 = param1;
            this.var_390.setEventHandler(this);
         }
      }
      ...
      public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         if(param1 != null)
         {
            if(this.var_390 != null)
            {
               this.var_390.setLocation(param1.loc);
               this.var_390.setDirection(param1.dir);
            }
         }
      }
   }
