package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      private var var_390:IRoomObject;
      
      private var var_851:IGraphicAssetCollection;
      
      protected var var_475:int = -1;
      
      protected var var_177:int = -1;
      
      protected var var_91:int = -1;
      ...
      public function set assetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         {
            this.var_851.removeReference();
         }
         this.var_851 = param1;
         if(this.var_851 != null)
         {
            this.var_851.addReference();
         }
      }
      ...
      {
         this.var_475 = 4294967295;
         this.var_177 = 4294967295;
         this.var_91 = -1;
      }
