package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_949:Number = 64;
      
      public static const const_1152:Number = 32;
      ...
      private var var_419:Number = 1.0;
      ...
      private var var_2923:Number = -500.0;
      
      private var var_2924:Number = 500.0;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.var_1128 = new Vector3d();
         this.var_418 = new Vector3d();
         this._direction = new Vector3d();
         this.var_1129 = new Vector3d();
         this.var_1698 = 1;
         this.var_1699 = 1;
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1700 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_418.assign(this.var_93);
         this.var_418.x *= this.var_420;
         this.var_418.y *= this.var_421;
         this.var_418.z *= this.var_419;
         return this.var_418;
      }
      ...
      {
         if(this.var_420 != param1 * this.var_1698)
         {
            this.var_420 = param1 * this.var_1698;
            ++this.var_153;
         }
      }
      ...
      {
         if(this.var_421 != param1 * this.var_1699)
         {
            this.var_421 = param1 * this.var_1699;
            ++this.var_153;
         }
      }
      ...
      {
         if(this.var_419 != param1 * this.var_1700)
         {
            this.var_419 = param1 * this.var_1700;
            ++this.var_153;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_93.x /= this.var_420;
         this.var_93.y /= this.var_421;
         this.var_93.z /= this.var_419;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         var _loc2_:Number = this.var_417.x;
         var _loc3_:Number = this.var_417.y;
         var _loc4_:Number = this.var_417.z;
         this.var_417.assign(param1);
         this._direction.assign(param1);
         if(this.var_417.x != _loc2_ || this.var_417.y != _loc3_ || this.var_417.z != _loc4_)
         {
            ++this.var_153;
         }
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1128.assign(this.var_165);
         }
         else
         {
      ...
      public function setDisplacement(param1:IVector3d, param2:IVector3d) : void
      {
         ...
         if(this.var_493 != null)
         {
            ...
            this.var_493.remove(_loc3_);
            _loc4_ = new Vector3d();
            _loc4_.assign(param2);
            this.var_493.add(_loc3_,_loc4_);
            ++this.var_153;
         }
      }
      ...
      private function getDisplacenent(param1:IVector3d) : IVector3d
      {
         ...
         if(this.var_493 != null)
         {
            ...
            return this.var_493.getValue(_loc2_);
         }
         return null;
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1129.assign(_loc22_);
         }
         else
         {
            this.var_1129.assign(_loc17_);
         }
         ++this.var_153;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_420;
         _loc2_.y *= this.var_421;
         _loc2_.z *= this.var_419;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1129);
         if(_loc3_ < this.var_2923 || _loc3_ > this.var_2924)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_421;
            _loc2_.z *= this.var_419;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1129);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(this.var_93.x * this.var_420,this.var_93.y * this.var_421,this.var_93.z * this.var_419);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_165;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_420,param2.y * this.var_421,param2.z * this.var_419);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_420,param3.y * this.var_421,param3.z * this.var_419);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_420,param4.y * this.var_421,param4.z * this.var_419);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1152;
         }
         else
         {
            this.scale = const_949;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_949;
      }
