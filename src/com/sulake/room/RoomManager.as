package com.sulake.room
{
   ...
   public class RoomManager extends Component implements IRoomManager, IRoomInstanceContainer
   {
      ...
      private var var_2986:IRoomContentLoader;
      
      private var var_694:IRoomObjectFactory = null;
      
      private var var_561:IRoomObjectVisualizationFactory = null;
      
      private var _state:int = 0;
      
      private var var_1315:XML = null;
      ...
      public function RoomManager(param1:IContext, param2:uint = 0)
      {
         ...
         this.var_693 = [];
         this.var_660 = [];
         events.addEventListener(RoomContentLoadedEvent.const_361,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_590,this.onContentLoaded);
         events.addEventListener(RoomContentLoadedEvent.const_871,this.onContentLoaded);
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_128.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_128.getWithIndex(_loc2_) as IRoomInstance;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      private function objectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_694 = param2 as IRoomObjectFactory;
      ...
      {
         var _loc1_:* = null;
         if(this.var_694 == null || this.var_561 == null)
         {
            return;
         }
         this._state = const_1618;
         if(this.var_1315 != null)
         {
            _loc1_ = this.var_1315;
            this.var_1315 = null;
      ...
      public function initialize(param1:XML, param2:IRoomManagerListener) : Boolean
      {
         ...
         while(_loc4_ < _loc3_.length)
         {
            ...
            if(this.var_693.indexOf(_loc5_) < 0)
            {
               this.var_59.loadObjectContent(_loc5_,events);
               this.var_693.push(_loc5_);
            }
            _loc4_++;
         }
         this._state = const_1259;
         return true;
      }
      ...
      {
         var _loc4_:* = null;
         var _loc2_:int = this.var_660.indexOf(param1);
         if(_loc2_ >= 0)
         {
            return;
         }
         this.var_660.push(param1);
         var _loc3_:int = this.var_128.length - 1;
         while(_loc3_ >= 0)
         {
            _loc4_ = this.var_128.getWithIndex(_loc3_) as RoomInstance;
            if(_loc4_ != null)
            {
      ...
      public function createRoom(param1:String, param2:XML) : IRoomInstance
      {
         ...
         this.var_128.add(String(param1),_loc3_);
         var _loc4_:int = this.var_660.length - 1;
         while(_loc4_ >= 0)
         {
            _loc5_ = this.var_660[_loc4_];
      ...
      {
         return this.var_128.getValue(param1) as IRoomInstance;
      }
      
      public function disposeRoom(param1:String) : Boolean
      {
         var _loc2_:IRoomInstance = this.var_128.remove(param1) as IRoomInstance;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            return true;
      ...
      public function createRoomObject(param1:String, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         var _loc17_:IRoomObjectGraphicVisualization = this.var_561.createRoomObjectVisualization(_loc10_);
         if(_loc17_ == null)
         {
            _loc5_.disposeObject(param2,param4);
            return null;
         ...
         var _loc18_:* = null;
         _loc18_ = this.var_561.getRoomObjectVisualizationData(_loc12_,_loc10_,_loc8_);
         ...
         var _loc19_:IRoomObjectEventHandler = this.var_694.createRoomObjectLogic(_loc11_);
      ...
      public function createRoomObjectManager() : IRoomObjectManager
      {
         if(this.var_694 != null)
         {
            return this.var_694.createRoomObjectManager();
         }
         return null;
      }
      ...
      private function processInitialContentLoad(param1:String) : void
      {
         ...
         if(this.var_59.getGraphicAssetCollection(param1) != null)
         {
            _loc2_ = this.var_693.indexOf(param1);
            if(_loc2_ >= 0)
            {
               this.var_693.splice(_loc2_,1);
            }
            if(this.var_693.length == 0)
            {
               this._state = const_698;
      ...
      private function onContentLoaded(param1:RoomContentLoadedEvent) : void
      {
         ...
         if(this.var_1064.indexOf(_loc2_) < 0)
         {
            this.var_1064.push(_loc2_);
         }
      }
      ...
      private function processLoadedContentTypes() : void
      {
         ...
         while(this.var_1064.length > 0)
         {
            _loc2_ = this.var_1064[0];
            this.var_1064.splice(0,1);
      ...
      private function updateObjectContents(param1:String) : void
      {
         ...
         if(this.var_59 == null || this.var_561 == null)
         {
            return;
         }
         ...
         var _loc7_:IRoomObjectVisualizationData = this.var_561.getRoomObjectVisualizationData(param1,_loc5_,_loc2_);
         var _loc8_:int = this.var_128.length - 1;
         while(_loc8_ >= 0)
         {
            _loc9_ = this.var_128.getWithIndex(_loc8_) as RoomInstance;
            _loc10_ = this.var_128.getKey(_loc8_);
            if(_loc9_ != null)
            {
               ...
               for each(_loc12_ in _loc11_)
               {
                  ...
                  while(_loc14_ >= 0)
                  {
                     ...
                     if(_loc15_ != null)
                     {
                        _loc16_ = this.var_561.createRoomObjectVisualization(_loc5_);
                        if(_loc16_ != null)
                        {
                           ...
                           else
                           {
                              ...
                              _loc17_ = this.var_694.createRoomObjectLogic(_loc6_);
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:int = this.var_128.length - 1;
         while(_loc2_ >= 0)
         {
            _loc3_ = this.var_128.getWithIndex(_loc2_) as RoomInstance;
            if(_loc3_ != null)
            {
               _loc3_.update();
            }
