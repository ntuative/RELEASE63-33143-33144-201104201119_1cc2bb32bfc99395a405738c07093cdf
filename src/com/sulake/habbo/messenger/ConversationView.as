package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1020:int = 100;
      
      private static const const_1394:int = 20;
       
      
      private var var_145:HabboMessenger;
      
      private var var_2507:IScrollbarWindow;
      
      private var var_1835:IContainerButtonWindow;
      
      private var var_63:IItemListWindow;
      
      private var var_511:Conversation;
      
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         this.var_145 = param1;
         this.var_1835 = this.initButton("follow_friend",this.onFollowButtonClick,param2);
         this.var_63 = IItemListWindow(param2.findChildByName("msg_list"));
         this.var_2507 = IScrollbarWindow(param2.findChildByName("scroller"));
         this.var_145.refreshButton(param2,"close",true,this.onCloseButtonClick,0);
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_1020 + const_1394)
         {
            this.refreshList();
            this.afterResize();
         }
      ...
      private function initButton(param1:String, param2:Function, param3:IWindowContainer) : IContainerButtonWindow
      {
         ...
         _loc5_.bitmap = this.var_145.getButtonImage(param1);
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1393;
         param1.invalidate();
      }
      ...
      public function refresh() : void
      {
         ...
         if(this.var_511 == null || _loc1_.id != this.var_511.id)
         {
            this.var_511 = _loc1_;
            this.refreshList();
            this.afterResize();
      ...
      {
         if(this.var_511.followingAllowed)
         {
            this.var_1835.enable();
         }
         else
         {
            this.var_1835.disable();
         }
      }
      ...
      private function refreshList() : void
      {
         ...
         this.var_63.autoArrangeItems = false;
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,this.var_511.messages.length - const_1020);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < this.var_511.messages.length)
         {
            this.refreshEntry(true,_loc1_,this.var_511.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         if(_loc4_ == null)
         {
            ...
            _loc4_ = ITextWindow(this.var_145.getXmlWindow("msg_entry"));
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_773 || param3.type == Message.const_846 ? param3.time + ": " : "";
      ...
      private function onMinimailButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _loc3_["recipientid"] = "" + this.var_511.id;
         _loc3_["random"] = "" + Math.round(Math.random() * 100000000);
         if(this.var_145.isEmbeddedMinimailEnabled())
         {
            if(false)
            {
         ...
         {
            this.var_145.openHabboWebPage("link.format.mail.compose",_loc3_,param1);
         }
      }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_145.send(new FollowFriendMessageComposer(this.var_511.id));
      }
      ...
      private function getChatBgColor(param1:int) : uint
      {
         ...
         if(param1 == Message.const_1155)
         {
            return 4294927974;
         }
         if(param1 == Message.const_776)
         {
            return 4293454056;
         }
         if(param1 == Message.const_669)
         {
            return 4293454056;
         }
