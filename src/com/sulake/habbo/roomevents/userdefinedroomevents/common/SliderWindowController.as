package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_1173:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_1173,param1);
         this.var_951 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_951);
         }
      ...
      {
         return int(this.var_1814 * (Number(param1 - this._minValue) / (this.var_1173 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1814 * (this.var_1173 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_952 || param1.type != WindowEvent.const_276)
         {
            return;
         }
         if(this.var_630 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_630) * this.var_630;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_630 != 0)
            {
               _loc3_ = this.var_951 + this.var_630;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_768 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_768.width,this.var_768.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_768,this.var_768.rect,new Point(0,0),null,null,true);
         }
         _loc1_ = this._sliderContainer.findChildByName("slider_movement_area") as IWindowContainer;
         if(_loc1_ != null)
         {
            _loc2_ = _loc1_.findChildByName("slider_button") as IBitmapWrapperWindow;
            if(_loc2_ != null && this.var_767 != null)
            {
               _loc2_.bitmap = new BitmapData(this.var_767.width,this.var_767.height,true,16777215);
               _loc2_.bitmap.copyPixels(this.var_767,this.var_767.rect,new Point(0,0),null,null,true);
               _loc2_.procedure = this.sliderProcedure;
               this.var_1814 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_768 = BitmapData(_loc2_.content);
         _loc2_ = BitmapDataAsset(param1.getAssetByName("slider_obj_png"));
         this.var_767 = BitmapData(_loc2_.content);
      }
   }
}
