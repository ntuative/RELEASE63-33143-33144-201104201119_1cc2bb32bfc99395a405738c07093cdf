package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1465:int = 2;
      ...
      private var var_1832:TriggerConfs;
      
      private var var_1831:ActionTypes;
      
      private var var_1833:ConditionTypes;
      
      private var var_265:Dictionary;
      
      private var var_38:Triggerable;
      
      private var var_774:RoomObjectHightLighter;
      ...
      {
         this.var_1832 = new TriggerConfs();
         this.var_1831 = new ActionTypes();
         this.var_1833 = new ConditionTypes();
         this.var_265 = new Dictionary();
         super();
         this.var_81 = param1;
         this.var_774 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         if(this.var_265[param1])
         {
            delete this.var_265[param1];
            this.var_774.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_38.furniLimit)
         {
            this.var_265[param1] = param2;
            this.var_774.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this._window = IFrameWindow(this.var_81.getXmlWindow("ude_main"));
         this.var_54 = IWindowContainer(this.find(this._window,"configure_container"));
         Util.setProcDirectly(this.find(this.var_54,"save_button"),this.onSave);
         Util.setProcDirectly(this.find(this.var_54,"cancel_save_button"),this.onWindowClose);
         Util.setProcDirectly(this.find(this.var_54,"helplink"),this.onHelp);
         Util.setProcDirectly(this.find(this.var_54,"apply_snapshot_txt"),this.onApplySnapshot);
         Util.setProcDirectly(this.find(this.var_54,"dec_stuff_sel_txt"),this.onDecStuffSelectionType);
         Util.setProcDirectly(this.find(this.var_54,"inc_stuff_sel_txt"),this.onIncStuffSelectionType);
         this.find(this.var_54,"dec_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_54,"inc_stuff_sel_txt").mouseThreshold = 0;
         this.find(this.var_54,"helplink").mouseThreshold = 0;
         this.find(this.var_54,"apply_snapshot_txt").mouseThreshold = 0;
         this.var_1187 = new SliderWindowController(this.var_81,IWindowContainer(this.find(this.var_54,"delay_slider_container")),this.var_81.assets,0,20,1);
      ...
      private function onDelaySliderChange(param1:Event) : void
      {
         ...
         if(param1.type == Event.CHANGE)
         {
            ...
            if(_loc2_)
            {
               ...
               this.var_81.localization.registerParameter("wiredfurni.params.delay","seconds",_loc5_);
            }
         }
      }
      ...
      private function setIcon(param1:String, param2:String, param3:String = "icon_bitmap") : void
      {
         ...
         this.var_81.refreshButton(_loc4_,param3,true,null,0,param2);
      }
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_774.hideAll(this.var_265);
         }
      }
      ...
      private function prepareStuffSelectionForUpdate() : void
      {
         ...
         if(this.var_38.stuffTypeSelectionEnabled)
         {
            ...
            if(_loc2_.requiresFurni == STUFF_SELECTION_OPTION_BY_ID_OR_BY_TYPE)
            {
               ...
               this.getFurniTypeMatchesText().caption = this.var_81.localization.getKey("wiredfurni.pickfurnis.furnitypematches");
         ...
         var _loc1_:IWindowContainer = IWindowContainer(this.var_54.findChildByName("select_furni_container"));
         _loc1_.height = Util.getLowestPoint(_loc1_);
      }
      
      private function refreshStuffTypeSelectionToggler() : void
      {
         this.getFurniTypeMatchesText().caption = this.var_81.localization.getKey("wiredfurni.pickfurnis.stuffselectiontype." + this.var_38.stuffTypeSelectionCode);
      }
      ...
      private function onSave(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_38 as TriggerDefinition != null)
         {
            this.var_81.send(new UpdateTriggerMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         else if(this.var_38 as ActionDefinition != null)
         {
            this.var_81.send(new UpdateActionMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.getActionDelay(),this.resolveStuffSelectionType()));
         }
         else if(this.var_38 as ConditionDefinition != null)
         {
            this.var_81.send(new UpdateConditionMessageComposer(this.var_38.id,this.resolveIntParams(),this.resolveStringParam(),this.getStuffIds(),this.resolveStuffSelectionType()));
         }
         this.close();
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = this.var_38.stuffTypeSelectionCode < 1 ? int(var_1465) : int(this.var_38.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_38.stuffTypeSelectionCode = (this.var_38.stuffTypeSelectionCode + 1) % (var_1465 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onApplySnapshot(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_81.send(new ApplySnapshotMessageComposer(this.var_38.id));
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1832);
         this.refreshConfigureElement(this.var_1831);
         this.refreshConfigureElement(this.var_1833);
      ...
      private function refreshConfigureElement(param1:ElementTypeHolder) : void
      {
         ...
         {
            this.find(this.var_54,param1.getKey() + "_icon_bitmap").visible = false;
            return;
         }
         ...
         this.find(this.var_54,"warning_container").visible = false;
         this.refreshConflictingTriggers();
         this.refreshConflictingActions();
         this.refreshActionInputs();
         Util.moveAllChildrenToColumn(this.var_54,3,5);
         this.var_54.height = Util.getLowestPoint(this.var_54) + 1;
      }
      
      private function getElementName(param1:int) : String
      {
         var _loc2_:IFurnitureData = this.var_81.sessionDataManager.getFloorItemData(param1);
         if(_loc2_ == null)
         {
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_54,"header_container"));
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.find(this.var_54,"action_inputs_container"));
         if(this.var_38 as ActionDefinition == null)
         {
      ...
      private function refreshConflictingTriggers() : void
      {
         ...
         this.var_81.localization.registerParameter("wiredfurni.conflictingtriggers.text","triggers",_loc2_);
         this.refreshWarning(this.var_81.localization.getKey("wiredfurni.conflictingtriggers.caption"),this.var_81.localization.getKey("wiredfurni.conflictingtriggers.text"));
      }
      ...
      private function refreshConflictingActions() : void
      {
         ...
         this.var_81.localization.registerParameter("wiredfurni.conflictingactions.text","actions",_loc2_);
         this.refreshWarning(this.var_81.localization.getKey("wiredfurni.conflictingactions.caption"),this.var_81.localization.getKey("wiredfurni.conflictingactions.text"));
      }
      
      private function refreshWarning(param1:String, param2:String) : void
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.find(this.var_54,"warning_container"));
         ...
         _loc3_.height = Util.getLowestPoint(_loc3_) + 4;
         this.find(this.var_54,"warning_container").visible = true;
      }
      
      private function refreshCustomInputs() : void
      {
         var _loc2_:* = null;
         var _loc1_:IWindowContainer = IWindowContainer(this.var_54.findChildByName("custom_inputs_container"));
      ...
      private function prepareCustomInput() : IWindowContainer
      {
         ...
         var _loc2_:Element = this.resolveType();
         var _loc3_:IWindowContainer = IWindowContainer(this.var_54.findChildByName("custom_inputs_container"));
         var _loc4_:String = _loc1_.getKey() + _loc2_.code;
         var _loc5_:IWindowContainer = IWindowContainer(_loc3_.getChildByName(_loc4_));
         if(_loc5_ == null)
         {
            _loc5_ = IWindowContainer(this.var_81.getXmlWindow("ude_" + _loc1_.getKey() + "_inputs_" + _loc2_.code));
            _loc5_.name = _loc4_;
            _loc3_.addChild(_loc5_);
            _loc2_.onInit(_loc5_,this.var_81);
         }
         return _loc5_;
      }
      ...
      private function refreshSelectFurni() : void
      {
         ...
         this.var_81.localization.registerParameter("wiredfurni.pickfurnis.caption","count","" + _loc3_);
         this.var_81.localization.registerParameter("wiredfurni.pickfurnis.caption","limit","" + _loc4_);
      }
      
      private function getFurniTypeMatchesCheckBox() : ICheckBoxWindow
      {
         return ICheckBoxWindow(this.var_54.findChildByName("furni_type_matches_checkbox"));
      }
      
      private function getDecStuffSelTxt() : IWindow
      {
         return this.var_54.findChildByName("dec_stuff_sel_txt");
      }
      
      private function getIncStuffSelTxt() : IWindow
      {
         return this.var_54.findChildByName("inc_stuff_sel_txt");
      }
      
      private function getFurniTypeMatchesText() : IWindow
      {
         return this.var_54.findChildByName("furni_type_matches_txt");
      }
   }
}
