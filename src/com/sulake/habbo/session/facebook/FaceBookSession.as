package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1030:String = "FlashExternalInterface.authenticateFacebook";
      
      private static const const_1425:String = "sendAccessTokenToServer";
      
      private static const const_1424:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1425,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1424,this.jsFaceBookLogOutCallback);
            Logger.log("-- -- ADDED JAVASCRIPT CALLBACK HOOKS!");
            ExternalInterface.call(const_1030);
            Logger.log("-- -- CALLED JAVASCRIPT METHOD " + const_1030);
         }
      }
