package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private const const_2105:int = 2500;
      ...
      private var var_1167:UserDataManager;
      ...
      {
         this.var_1447 = new Map();
         super();
         this._roomId = param1;
         this._roomCategory = param2;
         this._habboTracking = param3;
         this._password = param4;
         this.var_2439 = param5;
         this.var_1167 = new UserDataManager();
      }
      ...
      public function set connection(param1:IConnection) : void
      {
         ...
         {
            this.var_1167.connection = param1;
         }
      }
      ...
      {
         this._connection.send(new ChatMessageComposer(param1,this.var_1446));
         this.var_1447.add(this.var_1446,getTimer());
         ++this.var_1446;
      }
      ...
      {
         var _loc3_:int = 0;
         var _loc2_:Object = this.var_1447.remove(param1);
         if(_loc2_ != null)
         {
            _loc3_ = getTimer();
            if(_loc3_ - int(_loc2_) > this.const_2105)
            {
      ...
      {
         return this.var_1167 as IUserDataManager;
      }
