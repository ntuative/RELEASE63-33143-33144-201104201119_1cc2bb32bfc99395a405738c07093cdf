package com.sulake.habbo.sound.music
{
   ...
   public class JukeboxPlayListController implements IPlayListController
   {
      ...
      public function JukeboxPlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this.var_727 = [];
         this.var_727.push(new NowPlayingMessageEvent(this.onNowPlayingMessage));
         this.var_727.push(new JukeboxSongDisksMessageEvent(this.onJukeboxSongDisksMessage));
         this.var_727.push(new JukeboxPlayListFullMessageEvent(this.onJukeboxPlayListFullMessage));
      ...
      {
         this.var_70.stop(this.priority);
         this.var_444 = -1;
         this.var_1879 = -1;
         this.var_650 = false;
      }
      ...
      private function onNowPlayingMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_650 = _loc3_.currentSongId != -1;
         if(_loc3_.currentSongId >= 0)
         {
            this.var_70.playSong(_loc3_.currentSongId,HabboMusicPrioritiesEnum.const_127,_loc3_.syncCount / 1000,0,1,1);
         ...
         {
            this.var_70.addSongInfoRequest(_loc3_.nextSongId);
         }
         this.var_1879 = _loc3_.currentPosition;
         this._soundManager.events.dispatchEvent(new NowPlayingEvent(NowPlayingEvent.const_311,HabboMusicPrioritiesEnum.const_127,_loc3_.currentSongId,_loc3_.currentPosition));
      }
      ...
      private function onJukeboxSongDisksMessage(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.songDisks.length)
         {
            ...
            _loc7_ = this.var_70.getSongInfo(_loc5_) as SongDataEntry;
            if(_loc7_ == null)
            {
               _loc7_ = new SongDataEntry(_loc5_,-1,null,null,null);
               if(this.var_786.indexOf(_loc5_) < 0)
               {
                  this.var_786.push(_loc5_);
                  this.var_70.requestSongInfoWithoutSamples(_loc5_);
               }
            }
      ...
      private function onJukeboxPlayListFullMessage(param1:IMessageEvent) : void
      {
         ...
         this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.const_755));
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc2_ < this.length)
         {
            ...
            if(_loc4_.id == param1.id)
            {
               ...
               _loc6_ = this.var_70.getSongInfo(param1.id) as SongDataEntry;
               if(_loc6_ != null)
               {
         ...
         var _loc3_:int = this.var_786.indexOf(param1.id);
         if(_loc3_ >= 0)
         {
            this.var_786.splice(_loc3_,1);
         }
         if(this.var_786.length == 0)
         {
            this._events.dispatchEvent(new PlayListStatusEvent(PlayListStatusEvent.PLAY_LIST_UPDATED));
