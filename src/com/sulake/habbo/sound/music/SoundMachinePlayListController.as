package com.sulake.habbo.sound.music
{
   ...
   public class SoundMachinePlayListController implements IPlayListController
   {
      ...
      private var var_70:HabboMusicController;
      ...
      public function SoundMachinePlayListController(param1:HabboSoundManagerFlash10, param2:HabboMusicController, param3:IEventDispatcher, param4:IEventDispatcher, param5:IConnection)
      {
         ...
         this.var_70 = param2;
         this.var_727 = [];
         this.var_727.push(new PlayListMessageEvent(this.onPlayListMessage));
         this.var_727.push(new PlayListSongAddedMessageEvent(this.onPlayListSongAddedMessage));
         for each(_loc6_ in this.var_727)
         {
         ...
         this.var_81.addEventListener(RoomEngineSoundMachineEvent.const_931,this.onSoundMachinePlayEvent);
         this.var_81.addEventListener(RoomEngineSoundMachineEvent.const_924,this.onSoundMachineStopEvent);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            if(this.var_81)
            {
               this.var_81.removeEventListener(RoomEngineSoundMachineEvent.const_931,this.onSoundMachinePlayEvent);
               this.var_81.removeEventListener(RoomEngineSoundMachineEvent.const_924,this.onSoundMachineStopEvent);
               this.var_81 = null;
            }
            this._disposed = true;
         }
      ...
      public function checkSongPlayState(param1:int) : void
      {
         ...
         if(this.var_444 == param1)
         {
            ...
            if(_loc2_ != null)
            {
               this.var_70.addSongInfoRequest(_loc2_.id);
            }
         }
      }
      ...
      public function stopPlaying() : void
      {
         this.var_444 = -1;
         this.var_650 = false;
         this.var_70.stop(HabboMusicPrioritiesEnum.const_127);
      }
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         while(_loc3_ < this._playListEntries.length)
         {
            ...
            {
               _loc4_ = this.var_70.getSongInfo(param1.id) as SongDataEntry;
               if(_loc4_ != null)
               {
      ...
      private function playCurrentSongAndNotify(param1:int) : void
      {
         ...
         if(this.var_70.playSong(param1,HabboMusicPrioritiesEnum.const_127,_loc3_,0,0,0))
         {
