package com.sulake.habbo.room
{
   ...
   public class RoomMessageHandler
   {
      ...
      private var var_1621:Boolean = true;
      
      private var var_1351:int = -1.0E9;
      
      private var var_709:Object;
      
      public function RoomMessageHandler(param1:IRoomCreator)
      {
         this.var_709 = new Object();
         super();
         this.var_12 = param1;
      ...
      private function onRoomProperty(param1:IMessageEvent) : void
      {
         ...
         if(this.var_12 != null)
         {
            this.var_12.method_10(_loc4_,_loc5_,_loc6_,_loc7_,_loc8_);
         }
      }
      ...
      private function onFloorHeightMap(param1:IMessageEvent) : void
      {
         ...
         if(this.var_709.objectData)
         {
            this.addActiveObject(_loc4_,_loc5_,this.var_709.objectData);
            this.var_709.objectData = null;
         }
         else
         {
            this.var_709.floorReady = true;
         }
      }
      ...
      private function onObjectInject(param1:IMessageEvent) : void
      {
         ...
         var _loc5_:int = _loc3_.roomCategory;
         var _loc6_:ObjectMessageData = _loc3_.data;
         if(this.var_709.floorReady)
         {
            this.addActiveObject(_loc4_,_loc5_,_loc6_);
         }
         else
         {
            this.var_709.objectData = _loc6_;
         }
      }
      ...
      private function onUserUpdate(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:Number = _loc6_.getNumber(RoomVariableEnum.const_808);
         var _loc8_:int = 0;
      ...
      private function onSlideUpdate(param1:IMessageEvent) : void
      {
         ...
         if(param1 is SlideObjectBundleMessageEvent)
         {
            ...
            if(_loc2_.avatar != null)
            {
               ...
               {
                  case SlideObjectMessageData.const_1205:
                     _loc10_ = "mv";
                     break;
                  case SlideObjectMessageData.const_1061:
                     _loc10_ = "std";
               }
      ...
      private function onParkBusDoor(param1:IMessageEvent) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc7_.setNumber(RoomObjectVariableEnum.const_1274,_loc3_.status);
         }
      }
