package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_926:String = "RCL_LOADER_READY";
      
      private static const const_354:String = "RCL_PUBLICROOM_";
      
      private static const const_1800:int = 0;
      
      private static const const_962:int = 1;
      
      private static const name_4:int = 2;
      
      private static const const_437:String = "place_holder";
      
      private static const const_637:String = "wall_place_holder";
      
      private static const const_635:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_437;
      
      private static const const_636:String = "room";
      
      private static const TILE_CURSOR:String = "tile_cursor";
      
      private static const const_961:String = "selection_arrow";
      ...
      private var var_883:Map = null;
      
      private var var_406:Dictionary;
      
      private var var_882:Map = null;
      
      private var var_199:PublicRoomData = null;
      
      private var var_1350:Map = null;
      
      private var var_579:Map = null;
      
      private var var_479:Map = null;
      
      private var var_477:Map = null;
      ...
      {
         this.var_335 = new Dictionary();
         this._wallItems = new Dictionary();
         this.var_406 = new Dictionary();
         this.var_2143 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
      ...
      {
         if(this._state >= const_962)
         {
            return;
         }
         this._stateEvents = param1;
         this.var_2144 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2145 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_2146 = param2.getKey("public.room.dynamic.download.url","");
         this._publicRoomLoadNameTemplate = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_962;
         this.initFurnitureData();
      }
      ...
      private function initFurnitureData() : void
      {
         ...
         var _loc1_:Array = this.var_440.getFurniData(this);
         if(_loc1_ == null)
         {
            return;
         }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_478 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_478.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         {
            _loc2_ = this.var_407.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_407.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_406)
            {
               delete this.var_406[_loc1_];
            }
            this.var_406 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_708.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_405.add(_loc3_,_loc4_);
               if(this.var_335[_loc7_] == null)
               {
                  this.var_335[_loc7_] = 1;
               }
            }
            else if(_loc2_.type == "i")
            {
               ...
               this.var_580.add(_loc3_,_loc4_);
               if(this._wallItems[_loc7_] == null)
               {
                  this._wallItems[_loc7_] = 1;
               }
            }
            _loc8_ = this.var_579.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_579.remove(_loc7_);
               this.var_579.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2142)
         {
            ...
            {
               this._stateEvents.dispatchEvent(new Event(const_926));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_479 != null)
         {
            ...
            this.var_479.add(param1,param2);
         }
         if(this.var_477 != null)
         {
            this.var_477.remove(param2);
            this.var_477.add(param2,param1);
         }
      }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_479 != null)
         {
            _loc2_ = this.var_479.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_477 != null)
         {
            _loc2_ = this.var_477.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_199 != null && (this.var_199.type == param1 || this.var_199.hasWorldType(param1)))
         {
      ...
      {
         return [const_437,const_637,const_635,const_636,TILE_CURSOR,const_961];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_405.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_580.getValue(param1) as String;
      ...
      {
         return this.var_883.getValue(param1) as String;
      }
      
      public function getPetColor(param1:int, param2:int) : PetColorResult
      {
         var _loc3_:Map = this.var_882[param1];
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.var_580.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_708.getValue(param1) != null)
         {
      ...
      {
         if(this.var_199 != null && this.var_199.hasWorldType(const_354 + param1))
         {
            return this.var_199.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_247 || param1 == RoomObjectVisualizationEnum.const_71 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_27 || _loc2_ == RoomObjectCategoryEnum.const_26)
         {
            ...
            return int(this.var_579.getValue(param1));
         }
         return 0;
      }
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               while(_loc9_ < _loc7_.length)
               {
                  ...
                  _loc8_.push(this.var_2146 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         switch(param2)
         {
            case RoomObjectCategoryEnum.const_27:
               this.var_405[param1] = _loc4_;
               break;
            case RoomObjectCategoryEnum.const_26:
               this.var_580[param1] = _loc4_;
               break;
            default:
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_335[_loc4_] == null)
                     {
                        this.var_335[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_361,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1350.getValue(param1) != null)
         {
            this.var_199 = this.var_1350.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_835,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2143.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1719);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            ...
            else if(this.var_406[_loc5_] != null)
            {
               this.extractPetDataFromLoadedContent(_loc5_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_361,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_590,_loc5_);
         }
      ...
      private function extractPetDataFromLoadedContent(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc6_ = this.var_406[param1];
            this.var_882.add(_loc6_,_loc3_);
         }
      }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1350.add(param1,_loc4_);
         this.var_199 = _loc4_;
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_478.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_478.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_478.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_561.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_407.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_407.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_407[_loc2_] != null)
         {
            _loc3_ = this.var_407.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      private function extractPublicRoomFromXML(param1:String, param2:XML) : PublicRoomData
      {
         ...
         {
            _loc6_ = _loc3_[_loc5_];
            _loc7_ = const_354 + String(_loc6_.@name);
            _loc8_ = 32;
            _loc9_ = 1;
      ...
      {
         if(this.getObjectCategory(const_354 + param1) == RoomObjectCategoryEnum.const_79)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_199.getWorldHeightScale(const_354 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_199 != null)
         {
            return this.var_199.getWorldScale(const_354 + param1);
         }
         return 32;
      }
      ...
      {
         this.var_405.remove(param1);
         this.var_405.add(param1,param2);
      }
   }
}
