package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1321:String = "shore";
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc1_ in this.var_1114)
            {
      ...
      {
         if(this.var_2210 == param1 && this.var_2211 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1321)
            {
               this.var_1657 = _loc2_;
               this.var_2210 = param1;
               this.var_2211 = direction;
               return this.var_1657;
            }
            _loc2_--;
         }
      ...
      private function getInstanceMask(param1:int) : IGraphicAsset
      {
         ...
         if(_loc3_ != null)
         {
            if(this.var_1114.indexOf(_loc2_) < 0)
            {
               this.var_1114.push(_loc2_);
            }
         }
         return _loc3_;
      }
      ...
      private function updateBorderData() : void
      {
         ...
         var _loc3_:int = this.var_485 + 2;
         var _loc4_:int = this.var_591 + 2;
         var _loc5_:int = 0;
         ...
         this.var_1658 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_414.length)
         {
            if(this.var_414[_loc5_] == true)
            {
               this.var_1658 = true;
            }
            _loc5_++;
      ...
      private function updateTopBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc8_ < _loc3_ - 1)
         {
            if(_loc4_[_loc8_] == false)
            {
               ...
               this.var_590[param2] = ShoreMaskCreatorUtility.getBorderType(_loc6_,_loc7_);
            }
            param2++;
            _loc8_++;
         }
      ...
      private function updateRightBorder(param1:Array, param2:int) : int
      {
         ...
         while(_loc10_ < _loc4_ - 1)
         {
            ...
            if(_loc7_[_loc3_ - 1] == false)
            {
               ...
               this.var_590[param2] = ShoreMaskCreatorUtility.getBorderType(_loc5_,_loc6_);
            }
            param2++;
            _loc10_++;
         }
      ...
      {
         var _loc2_:* = null;
         if(this.var_485 == 0 || this.var_591 == 0)
         {
            ...
            this.var_485 = _loc2_.getNumber(RoomObjectVariableEnum.const_326);
            this.var_591 = _loc2_.getNumber(RoomObjectVariableEnum.const_386);
         }
         this.var_414 = [];
         this.var_590 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_485 * 2 + this.var_591 * 2)
         {
            this.var_414.push(false);
            this.var_590.push(ShoreMaskCreatorUtility.const_81);
            _loc1_++;
         }
      }
      ...
      {
         var _loc1_:int = this.var_485 + 2;
         var _loc2_:int = this.var_591 + 2;
         var _loc3_:* = [];
         var _loc4_:* = null;
         var _loc5_:int = 0;
         var _loc6_:int = 0;
      ...
      {
         if(this.var_73 == null || this.var_73.width < param1 || this.var_73.height < param2)
         {
            if(this.var_73 != null)
            {
               this.var_73.dispose();
            }
            this.var_73 = ShoreMaskCreatorUtility.createEmptyMask(param1,param2);
         }
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_73,getSize(param3),this.var_414,this.var_590,assetCollection);
      }
