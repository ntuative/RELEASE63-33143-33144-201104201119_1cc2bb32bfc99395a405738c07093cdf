package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystemEmitter extends FurnitureParticleSystemParticle
   {
      ...
      public static const const_1732:String = "cone";
      
      public static const const_1545:String = "plane";
      
      public static const const_1585:String = "sphere";
      ...
      private var var_2819:Number;
      
      private var _direction:Vector3D;
      
      private var var_1043:Number = 0.1;
      ...
      public function setup(param1:int, param2:int, param3:Number, param4:Vector3D, param5:Number, param6:Number, param7:String, param8:Number, param9:int, param10:int) : void
      {
         ...
         this.var_280 = param6;
         this.var_2816 = param7;
         this.var_2817 = param9;
         this._energy = param8;
      ...
      public function reset() : void
      {
         ...
         this.var_1044 = 0;
         this.var_990 = false;
         this.init(0,0,0,this._direction,this.var_2819,this.var_1043,this.var_2817,true);
      }
      ...
      public function configureParticle(param1:int, param2:Boolean, param3:Array, param4:Boolean) : void
      {
         ...
         _loc5_["fade"] = param4;
         this.var_1284.push(_loc5_);
      }
      
      override protected function ignite() : void
      {
         this.var_990 = true;
         if(this.var_1044 < this.var_1572)
         {
            if(this.age > 1)
            {
      ...
      private function releaseParticles(param1:FurnitureParticleSystemParticle, param2:Vector3D = null) : void
      {
         ...
         var _loc10_:int = 0;
         while(_loc10_ < this.var_2818)
         {
            switch(this.var_2816)
            {
               case const_1732:
            ...
            _loc4_.init(param1.x,param1.y,param1.z,_loc3_,this._energy,this.var_1043,_loc6_,_loc7_,_loc9_,_loc8_);
      ...
      {
         var _loc1_:int = Math.floor(Math.random() * this.var_1284.length);
         return this.var_1284[_loc1_];
      }
      ...
      override public function update() : void
      {
         ...
         if(!isAlive && this.var_1044 < this.var_1572)
         {
            if(this.age % this.var_2820 == 0)
            {
               this.releaseParticles(this,this.direction);
            }
         }
      ...
      public function verlet() : void
      {
         ...
         if(isAlive || this.var_1044 < this.var_1572)
         {
            ...
            this.y = (2 - this.var_280) * this.y - (1 - this.var_280) * this.lastY + this.var_2039 * this.var_1043 * this.var_1043;
         ...
         for each(_loc2_ in this.var_389)
         {
            ...
            _loc2_.y = (2 - this.var_280) * _loc2_.y - (1 - this.var_280) * _loc2_.lastY + this.var_2039 * this.var_1043 * this.var_1043;
