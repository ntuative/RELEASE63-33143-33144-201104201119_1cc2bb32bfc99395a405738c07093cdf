package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_1791:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2383:Number = NaN;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1433 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1433;
            this.var_1433 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
      ...
      protected function updateSprites(param1:int, param2:Boolean, param3:int) : void
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(this.var_640 != spriteCount)
         {
            createSprites(this.var_640);
         }
         if(param2)
         {
      ...
      private function updateSprite(param1:int, param2:int) : void
      {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               _loc4_.clickHandling = this.var_2236;
            }
            else
            {
      ...
      protected function getBlendMode(param1:int) : String
      {
         ...
         switch(param1)
         {
            case LayerData.const_421:
               break;
            case LayerData.const_1249:
               _loc2_ = "null";
               break;
            case LayerData.INK_DARKEN:
               _loc2_ = "null";
               break;
            case LayerData.const_1100:
               _loc2_ = "null";
         }
         return _loc2_;
      }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_475 != _loc3_.getUpdateID() || param1 != var_91 || param2 != this.var_2383)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(var_177 != _loc3_.getUpdateID())
         {
            this.var_2380 = _loc3_.getNumber(RoomObjectVariableEnum.const_197);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_292));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1159 = this.getAdClickUrl(_loc3_);
            if(this.var_1159 == null || this.var_1159.indexOf("http") != 0)
            {
               this.var_1159 = null;
            }
            this.var_2236 = this.var_1159 != null;
      ...
      {
         if(this.var_2381 != param2 || this.var_2384 != param1)
         {
            this.var_929 = [];
            this.var_930 = [];
            this.var_752 = [];
            ...
            this.var_2382 = this.getSize(param1);
      ...
      {
         this.var_640 = param1;
         this.var_1775 = this.var_640 - this.getAdditionalSpriteCount();
      }
      ...
      protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         var _loc5_:int = 0;
         var _loc6_:* = null;
         if(this._data == null || param2 >= FurnitureVisualizationData.const_600.length)
         {
            return "";
         }
         var _loc3_:String = this.var_929[param2];
         var _loc4_:Boolean = this.var_930[param2];
         if(_loc3_ == null || _loc3_.length == 0)
         {
            _loc5_ = this.var_2382;
            _loc3_ = this._type;
            _loc6_ = "";
            if(param2 != this.var_1775)
            {
               _loc6_ = FurnitureVisualizationData.const_600[param2];
            }
            else
            {
               _loc6_ = "sd";
            ...
            this.var_929[param2] = _loc3_;
            this.var_930[param2] = _loc4_;
         }
         if(_loc4_)
         {
      ...
      {
         if(this.var_747[param3] != null && !this.var_1776)
         {
            return this.var_747[param3];
         }
         if(this._data == null)
         {
            return LayerData.const_519;
         }
      ...
      {
         if(this.var_754[param2] != null)
         {
            return this.var_754[param2];
         }
         if(this._data == null)
         {
