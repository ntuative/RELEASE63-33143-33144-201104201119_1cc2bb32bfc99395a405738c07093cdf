package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePlanetSystemVisualization extends AnimatedFurnitureVisualization
   {
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         if(this.var_264 == null && spriteCount > 0)
         {
         ...
         {
            _loc3_ = 0;
            while(_loc3_ < this.var_264.length)
            {
               _loc2_ = this.var_264[_loc3_];
               _loc2_.update(this._offsetArray,this.var_2495,param1);
               _loc3_++;
            }
      ...
      private function readDefinition() : Boolean
      {
         ...
         var _loc3_:String = _loc2_.getString(RoomObjectVariableEnum.const_1248);
