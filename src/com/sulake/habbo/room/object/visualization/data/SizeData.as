package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_415:int = 1000;
      ...
      private var var_1534:int = 360;
      
      private var var_815:DirectionData = null;
      
      private var var_272:Map;
      
      private var _colors:Map;
      
      private var var_1246:DirectionData = null;
      ...
      public function SizeData(param1:int, param2:int)
      {
         ...
         this.var_815 = new DirectionData(param1);
      ...
      public function defineLayers(param1:XML) : Boolean
      {
         ...
         return this.defineDirection(this.var_815,_loc2_);
      }
      ...
      public function defineDirections(param1:XML) : Boolean
      {
         ...
         while(_loc5_ < _loc4_.length())
         {
            ...
            _loc3_.copyValues(this.var_815);
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         while(_loc4_ < param2.length())
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc6_,LayerData.const_1249);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc6_,LayerData.const_1100);
                  break;
               case "DARKEN":
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + this.var_1534 / 2) % 360 / this.var_1534;
         ...
         {
            _loc6_ = int(this.var_272.getKey(_loc5_)) * this.var_1534;
