package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization implements IPetImageListener
   {
      ...
      private var var_607:PetVisualizationData = null;
      ...
      private const const_1353:int = 3;
      ...
      {
         this.var_607 = param1 as PetVisualizationData;
         createSprites(this.const_1353);
         var _loc2_:BitmapData = (this.var_607.getAvatarRendererAsset("pet_experience_bubble_png") as BitmapDataAsset).content as BitmapData;
         this.var_342 = new ExperienceData(_loc2_.clone());
         return true;
      }
      ...
      private function updateModel(param1:IRoomObjectModel, param2:Number) : Boolean
      {
         ...
         {
            this.var_1711 = param1.getNumber(RoomObjectVariableEnum.const_432) > 0;
            this.var_1407 = param1.getString(RoomObjectVariableEnum.const_136);
            this.var_250 = param1.getString(RoomObjectVariableEnum.const_233);
            this._postureParameter = param1.getString(RoomObjectVariableEnum.const_880);
            this.var_1713 = param1.getNumber(RoomObjectVariableEnum.const_189);
            this.var_1380 = param1.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2221 = param1.getNumber(RoomObjectVariableEnum.const_845);
            this.validateActions();
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_191);
            if(this.var_654 != _loc3_)
            {
               this.var_654 = _loc3_;
      ...
      private function updateObject(param1:IRoomObject, param2:IRoomGeometry, param3:Boolean = false) : Boolean
      {
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param3 || var_475 != param1.getUpdateID() || this.var_1731 != param2.updateId)
         {
            ...
            if(_loc4_ != this.var_1707 || param3)
            {
               this.var_1707 = _loc4_;
               _loc4_ -= 112.5;
               _loc4_ = (_loc4_ + 360) % 360;
               this.var_60.setDirectionAngle(AvatarSetType.const_37,_loc4_);
            }
            if(_loc5_ != this.var_1710 || param3)
            {
               this.var_1710 = _loc5_;
               _loc5_ -= 112.5;
      ...
      private function getAvatarImage(param1:Number) : IAvatarImage
      {
         ...
         if(_loc3_ == null)
         {
            _loc3_ = this.var_607.getAvatar(this.var_654,param1,this);
            if(_loc3_ != null)
            {
      ...
      private function updateShadow(param1:Number) : void
      {
         ...
         this.var_608 = null;
         _loc2_ = getSprite(this.const_1843);
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(param1 < 48)
         {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc10_ || _loc7_ != var_91 || this.var_60 == null)
         {
            if(_loc7_ != var_91)
            {
               var_91 = _loc7_;
         ...
         var _loc12_:Boolean = this.var_948 || this.var_1251 > 0 || this.var_1980;
         this.var_342.alpha = 0;
         if(this.var_1380 > 0)
         {
            _loc13_ = param2 - this.var_1380;
            if(_loc13_ < AvatarAction.const_980)
            {
               this.var_342.alpha = int(Math.sin(_loc13_ / 0 * 0) * 255);
               this.var_342.setExperience(this.var_2221);
               this.var_1251 = this.const_2126;
            }
            else
            {
               this.var_1380 = 0;
            }
            _loc14_ = getSprite(this.const_1811);
            if(_loc14_ != null)
            {
               if(this.var_342.alpha > 0)
               {
                  _loc14_.asset = this.var_342.image;
                  _loc14_.offsetX = -20;
                  _loc14_.offsetY = -80;
                  _loc14_.alpha = this.var_342.alpha;
         ...
         if(_loc11_ || _loc12_)
         {
            ...
            _loc14_ = getSprite(this.const_993);
            if(_loc14_)
            {
               _loc19_ = this.var_60.getImage(AvatarSetType.const_37,false);
               if(_loc19_ != null)
               {
      ...
      private function updateActions(param1:IAvatarImage) : void
      {
         ...
         if(this.var_1407 != null && this.var_1407 != "")
         {
            param1.appendAction(AvatarAction.const_304,this.var_1407);
         }
         ...
         var _loc2_:int = param1.getSprites().length + this.const_1353;
