package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1327:String = "head";
      
      private static const const_642:int = 1;
      
      private static const const_980:int = 1000;
      
      private static const const_1329:String = "pet_experience_bubble_png";
      
      private static const const_1328:int = 0;
      
      private static const const_1326:int = 1;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1329) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_342 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateAnimation(param1:Number) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != this.var_2219)
            {
               this.var_2219 = _loc3_;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc3_.getUpdateID() != var_177)
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_233);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_136);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_233);
            if(!isNaN(_loc6_))
            {
               _loc10_ = this._animationData.getPostureCount(var_91);
               if(_loc10_ > 0)
               {
                  _loc4_ = this._animationData.getPostureForAnimation(var_91,_loc6_ % _loc10_);
                  _loc5_ = null;
               }
            }
            _loc7_ = _loc3_.getNumber(RoomObjectVariableEnum.const_136);
            if(!isNaN(_loc7_))
            {
               _loc11_ = this._animationData.getGestureCount(var_91);
               if(_loc11_ > 0)
               {
                  _loc5_ = this._animationData.getGestureForAnimation(var_91,_loc7_ % _loc11_);
               }
            }
            this.validateActions(_loc4_,_loc5_);
            this.var_1711 = _loc3_.getNumber(RoomObjectVariableEnum.const_432) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_189);
            if(!isNaN(_loc8_))
            {
               this.var_1665 = _loc8_;
            }
            else
            {
               this.var_1665 = direction;
            }
            this.var_1380 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2221 = _loc3_.getNumber(RoomObjectVariableEnum.const_845);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_797);
            if(_loc9_ != this.var_1664)
            {
               this.var_1664 = _loc9_;
               this.var_2220 = this.var_1664.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         {
            this.var_342.alpha = 0;
            if(this.var_1380 > 0)
            {
               _loc2_ = param1 - this.var_1380;
               if(_loc2_ < const_980)
               {
                  this.var_342.alpha = int(Math.sin(_loc2_ / const_980 * 0) * 255);
                  this.var_342.setExperience(this.var_2221);
               }
               else
               {
                  this.var_1380 = 0;
               ...
               if(_loc3_ != null)
               {
                  if(this.var_342.alpha > 0)
                  {
                     _loc3_.asset = this.var_342.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_342.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      private function validateActions(param1:String, param2:String) : void
      {
         ...
         {
            this.var_250 = param1;
            _loc3_ = this._animationData.getAnimationForPosture(var_91,param1);
            this.setAnimationForIndex(const_1328,_loc3_);
         }
         if(param2 != this.var_1407)
         {
            this.var_1407 = param2;
            _loc3_ = this._animationData.getAnimationForGesture(var_91,param2);
            this.setAnimationForIndex(const_1326,_loc3_);
         }
      }
      ...
      {
         return super.getAdditionalSpriteCount() + const_642;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2220);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_642)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_642))
            {
               if(param2 >= FurnitureVisualizationData.const_600.length)
               {
                  return null;
               }
               _loc5_ = FurnitureVisualizationData.const_600[param2];
               if(_loc4_ == 1)
               {
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1665);
         }
         return direction;
      }
      ...
      {
         if(this.var_901[param1] == null)
         {
            if(this._animationData.getTag(var_91,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1327)
            {
               this.var_901[param1] = true;
            }
            else
            {
               this.var_901[param1] = false;
            }
         }
         return this.var_901[param1];
      }
   }
}
