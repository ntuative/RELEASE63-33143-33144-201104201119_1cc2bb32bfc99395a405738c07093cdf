package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private static const const_656:Point = new Point(0,0);
      ...
      private var var_1005:IPlaneRasterizer = null;
      
      private var var_856:PlaneMaskManager = null;
      ...
      private var var_449:PlaneBitmapData = null;
      ...
      private var var_375:Boolean = false;
      
      private var var_73:BitmapData = null;
      
      private var var_235:BitmapData = null;
      ...
      private var var_808:Boolean = true;
      ...
      {
         return this._isVisible && this.var_808;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_202 != null)
         {
            ...
            {
               _loc2_ = this.var_202.getWithIndex(_loc1_) as PlaneBitmapData;
               if(_loc2_ != null)
               {
      ...
      public function copyBitmapData(param1:BitmapData) : BitmapData
      {
         if(this.visible)
         {
            if(this._bitmapData != null && param1 != null)
            {
               ...
               {
                  param1.copyPixels(this._bitmapData,this._bitmapData.rect,const_656);
                  return param1;
               }
            }
         }
      ...
      {
         var _loc3_:PlaneBitmapData = this.var_202.remove(param1) as PlaneBitmapData;
         if(_loc3_ != null)
         {
      ...
      private function resetTextureCache(param1:BitmapData = null) : void
      {
         ...
         if(this.var_202 != null)
         {
            ...
            {
               _loc3_ = this.var_202.getWithIndex(_loc2_) as PlaneBitmapData;
               if(_loc3_ != null)
               {
      ...
      private function getTextureIdentifier(param1:Number) : String
      {
         ...
         {
            return this.var_1005.getTextureIdentifier(param1,this.normal);
         }
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc3_:PlaneBitmapData = this.var_449;
         if(_loc3_ == null)
         {
            _loc4_ = this.getTextureIdentifier(param1.scale);
            _loc3_ = this.var_202.getValue(_loc4_) as PlaneBitmapData;
         }
         this.updateMaskChangeStatus();
         if(this.var_808 && (_loc3_ == null || _loc3_.timeStamp >= 0 && param2 > _loc3_.timeStamp || this.var_375))
         {
            return true;
         }
         return false;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         {
            _loc5_ = this.var_297.length * param1.scale;
            _loc6_ = this.var_298.length * param1.scale;
            ...
            if(this.var_1005 != null)
            {
               _loc3_ = this.var_1005.render(_loc8_,this._id,_loc5_,_loc6_,param1.scale,_loc7_,this.var_1935,this.var_2698,this.var_2695,this.var_2697,this.var_2694,param2);
               if(_loc3_ != null)
               {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         if(this.var_1731 != geometry.updateId)
         {
            geometryChanged = true;
         }
         if(!geometryChanged || !this.var_808)
         {
            if(!this.visible)
            {
               return false;
         ...
         if(geometryChanged)
         {
            ...
            i = 0;
            while(i < this.var_1522.length)
            {
               cosAngle = Vector3d.cosAngle(geometry.directionAxis,this.var_1522[i]);
               if(cosAngle > -0.001)
               {
                  if(this._isVisible)
                  {
            ...
            originPos = geometry.getScreenPosition(this.var_1143);
            originZ = originPos.z;
            relativeDepth = Math.max(this.var_154.z - originZ,this.var_116.z - originZ,this.var_86.z - originZ,this.var_115.z - originZ);
            if(this._type == TYPE_LANDSCAPE)
            {
               relativeDepth += 0.02;
            }
            this.var_2288 = relativeDepth;
            this._isVisible = true;
            this.var_1731 = geometry.updateId;
         }
         if(geometryChanged || this.needsNewTexture(geometry,timeSinceStartMs))
         {
            ...
            Randomizer.setSeed(this.var_2696);
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(this._type == const_129 || this._type == TYPE_LANDSCAPE)
         {
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(this._bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (this._type == const_129 || this._type == TYPE_LANDSCAPE))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      public function addBitmapMask(param1:String, param2:Number, param3:Number) : Boolean
      {
         ...
         if(this.var_1004)
         {
            ...
            {
               _loc4_ = this.var_270[_loc5_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         var _loc4_:* = null;
         if(this.var_270.length == this.var_1003.length)
         {
            while(_loc1_ < this.var_270.length)
            {
               _loc4_ = this.var_270[_loc1_] as RoomPlaneBitmapMask;
               if(_loc4_ != null)
               {
                  _loc6_ = false;
                  while(_loc2_ < this.var_1003.length)
                  {
                     _loc7_ = this.var_1003[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
         ...
         if(this.var_374.length > this.var_1523.length)
         {
            _loc3_ = false;
         }
         if(_loc3_)
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!this.var_1004 || this.var_270.length == 0 && this.var_374.length == 0 && !this.var_375 || this.var_856 == null)
         {
            return;
         }
         ...
         if(this.var_73 == null || this.var_73.width != _loc7_ || this.var_73.height != _loc8_)
         {
            if(this.var_73 != null)
            {
               this.var_73.dispose();
            ...
            this.var_73 = new BitmapData(_loc7_,_loc8_,true,16777215);
            this.var_375 = true;
         }
         if(this.var_375)
         {
            ...
            if(this.var_73 != null)
            {
               this.var_73.fillRect(this.var_73.rect,16777215);
            }
            this.resetTextureCache(param1);
            _loc9_ = param2.getCoordinatePosition(this.var_612);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < this.var_270.length)
            {
               _loc3_ = this.var_270[_loc5_] as RoomPlaneBitmapMask;
               if(_loc3_ != null)
               {
                  _loc10_ = this.var_73.width - this.var_73.width * _loc3_.leftSideLoc / this.var_297.length;
                  _loc11_ = this.var_73.height - this.var_73.height * _loc3_.rightSideLoc / this.var_298.length;
                  _loc12_ = _loc3_.type;
                  this.var_856.updateMask(this.var_73,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  this.var_1003.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < this.var_374.length)
            {
               ...
               if(_loc4_ != null)
               {
                  _loc10_ = this.var_73.width - this.var_73.width * _loc4_.leftSideLoc / this.var_297.length;
                  _loc11_ = this.var_73.height - this.var_73.height * _loc4_.rightSideLoc / this.var_298.length;
                  _loc13_ = this.var_73.width * _loc4_.leftSideLength / this.var_297.length;
                  _loc14_ = this.var_73.height * _loc4_.rightSideLength / this.var_298.length;
                  this.var_73.fillRect(new Rectangle(_loc10_ - _loc13_,_loc11_ - _loc14_,_loc13_,_loc14_),4278190080);
         ...
         this.combineTextureMask(param1,this.var_73);
      }
      ...
      private function combineTextureMask(param1:BitmapData, param2:BitmapData) : void
      {
         ...
         if(this.var_235 != null && (this.var_235.width != param1.width || this.var_235.height != param1.height))
         {
            this.var_235.dispose();
            this.var_235 = null;
         }
         if(this.var_235 == null)
         {
            this.var_235 = new BitmapData(param1.width,param1.height,true,4294967295);
         }
         this.var_235.copyChannel(param1,param1.rect,const_656,BitmapDataChannel.ALPHA,BitmapDataChannel.RED);
         this.var_235.draw(param2,null,null,BlendMode.DARKEN);
         param1.copyChannel(this.var_235,this.var_235.rect,const_656,BitmapDataChannel.RED,BitmapDataChannel.ALPHA);
      }
   }
}
