package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_851:IGraphicAssetCollection;
      ...
      private var var_903:Boolean = true;
      ...
      private var var_1384:LayoutRasterizerData = null;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != this.var_902)
         {
            ...
            this._adBgIndex = -1;
            this._adImgIndex = -1;
            this.var_1384 = this.var_47.getValue(this.var_902);
         }
      }
      ...
      public function initialize(param1:XML) : void
      {
         ...
         this.var_2231 = new Vector3d(-0.5,0.5,0);
         this.var_903 = false;
      }
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(this.var_2231);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc3_:LayoutRasterizerData = this.var_47.getValue(this.var_902);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              this.var_1669 = RoomObjectVariableEnum.const_1127;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              this.var_1669 = RoomObjectVariableEnum.const_1224;
                           }
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1116 + this._adBgIndex);
                              if(_loc5_ != null)
                              {
                        ...
                        if(_loc10_ == "billboard_img")
                        {
                           ...
                           if(param2 != null)
                           {
                              _loc5_ = param2.getSprite(this.var_1116 + this._adImgIndex);
                              if(_loc5_ != null)
                              {
                                 _loc5_.visible = false;
                                 _loc5_.alpha = 0;
      ...
      {
         var _loc1_:LayoutRasterizerData = this.var_47.getValue(this.var_902);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      {
         if(param2 == this.var_2229 && param3 == this.var_2230)
         {
            return;
         }
         ...
         if(param1 != null)
         {
            _loc4_ = param1.getSprite(this.var_1116 + this._adBgIndex);
            _loc5_ = param1.getSprite(this.var_1116 + this._adImgIndex);
         }
         ...
         {
            this.exchangeElementGraphics("billboard_img",this.var_1669);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_565;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = this.var_1384.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         var _loc9_:IGraphicAsset = this.var_851.getAsset(_loc8_.@asset);
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(this.var_415.indexOf(_loc10_) >= 0 && this.var_903)
            {
               param1 = this.var_415.indexOf(_loc10_);
               if(this.var_592[param1] != "")
               {
                  _loc9_ = this.var_851.getAsset(this.var_592[param1]);
                  if(_loc9_ != null && _loc9_.asset != null)
                  {
                     param2.asset = _loc9_.asset.content as BitmapData;
                  }
               ...
               this.var_415.splice(param1,1);
               this.var_592.splice(param1,1);
      ...
      {
         this.var_903 = true;
         var _loc3_:int = this.var_415.indexOf(param1);
         if(_loc3_ < 0)
         {
            this.var_415.push(param1);
            this.var_592.push(param2);
            this.var_593.push(-1);
         }
         else
         {
            this.var_592[_loc3_] = param2;
         }
      }
