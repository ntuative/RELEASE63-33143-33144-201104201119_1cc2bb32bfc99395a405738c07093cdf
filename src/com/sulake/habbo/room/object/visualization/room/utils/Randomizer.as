package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1921:int = 1;
      
      public static const const_1904:int = 16777216;
      ...
      private var var_2071:int = 16777216;
      
      private var var_2955:int = 69069;
      
      private var var_2954:int = 5;
      ...
      {
         var _loc1_:int = this.var_2955 * this.var_2070 + this.var_2954;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_2071;
         this.var_2070 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_2071 * param2);
      }
   }
}
