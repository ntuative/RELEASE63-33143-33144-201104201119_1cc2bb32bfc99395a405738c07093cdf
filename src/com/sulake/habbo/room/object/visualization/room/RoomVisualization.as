package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1551:int = 16777215;
      
      public static const const_1549:int = 13421772;
      
      private static const const_1034:int = 16777215;
      
      private static const const_1035:int = 13421772;
      
      private static const const_1036:int = 10066329;
      
      private static const const_1033:int = 10066329;
      
      public static const const_1743:int = 16777215;
      
      public static const const_1642:int = 13421772;
      
      public static const const_1541:int = 10066329;
      ...
      private var var_822:Rectangle = null;
      
      private var var_536:RoomPlaneBitmapMaskParser = null;
      
      private var var_1588:String = null;
      
      private var _floorType:String = null;
      
      private var var_1590:String = null;
      
      private var var_2742:String = null;
      
      private var var_1254:uint = 16777215;
      
      private var var_2741:int = 255;
      
      private var var_2743:int = 255;
      
      private var var_2740:int = 255;
      
      private var var_1989:Boolean = true;
      
      private var var_1988:int = 0;
      
      private var var_1659:int = -1000;
      
      private const const_2127:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_536 = new RoomPlaneBitmapMaskParser();
         this.var_317["null"] = false;
         this.var_317["null"] = true;
         this.var_317["null"] = true;
         this.var_317["null"] = true;
      }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_822 = super.boundingRectangle;
         }
         return new Rectangle(this.var_822.x,this.var_822.y,this.var_822.width,this.var_822.height);
      }
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_129 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1178);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1237);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_178)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_129,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_308)
            {
               ...
               if(_loc14_.y > 0)
               {
                  _loc13_.color = const_1743;
               }
               else if(_loc14_.y == 0)
               {
                  _loc13_.color = const_1642;
               }
               else
               {
                  _loc13_.color = const_1541;
               }
               if(this._data != null)
               {
            ...
            else if(_loc12_ == RoomPlaneData.const_1589)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_129,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_308)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this.var_1659 + this.const_2127 && !_loc6_ && !_loc8_)
         {
            return;
         }
            ...
            while(_loc10_ < this.var_379.length)
            {
               ...
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_1989)
                  {
                     ...
                     _loc15_ = uint((_loc14_ & 255) * this.var_2740 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2743 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2741 / 255);
         ...
         var_177 = _loc7_.getUpdateID();
         this.var_1659 = _loc9_;
      }
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1731)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1418 || _loc3_.y != this.var_2291 || _loc3_.z != this.var_2290 || param1.scale != this.var_2292))
            {
               this.var_1418 = _loc3_.x;
               this.var_2291 = _loc3_.y;
               this.var_2290 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         var _loc2_:Boolean = false;
         if(var_177 != param1.getUpdateID())
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1240);
            if(_loc3_ != this.var_2742)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2742 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_766));
            if(_loc4_ != this.var_1254)
            {
               this.var_1254 = _loc4_;
               this.var_2740 = this.var_1254 & 255;
               this.var_2743 = this.var_1254 >> 8 & 255;
               this.var_2741 = this.var_1254 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1214));
            if(_loc5_ != this.var_1989)
            {
               this.var_1989 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_177 != param1.getUpdateID())
         {
            ...
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_324);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_951));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_897));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_928));
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < this.var_138.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_129 && param2 != null)
               {
                  _loc5_.id = param2;
               }
      ...
      {
         if(param1 != this.var_317["null"] || param2 != this.var_317["null"] || param3 != this.var_317["null"])
         {
            this.var_317["null"] = param1;
            this.var_317["null"] = param2;
            this.var_317["null"] = param3;
            this.var_379 = [];
            this.var_666 = [];
         }
      }
         ...
         while(_loc9_ < _loc6_.length)
         {
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_317[_loc12_.type]))
                  {
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1988;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_536.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_536.maskCount)
         {
            _loc10_ = this.var_536.getMaskType(_loc8_);
            _loc11_ = this.var_536.getMaskLocation(_loc8_);
            _loc12_ = this.var_536.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_138.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_129 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_129 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_255)
                              {
