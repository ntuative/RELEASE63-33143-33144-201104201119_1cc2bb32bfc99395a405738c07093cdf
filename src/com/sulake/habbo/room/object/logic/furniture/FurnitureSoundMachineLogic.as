package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureSoundMachineLogic extends FurnitureMultiStateLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectFurnitureActionEvent.const_608,RoomObjectFurnitureActionEvent.const_584,RoomObjectFurnitureActionEvent.const_489,RoomObjectFurnitureActionEvent.const_552];
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != this.var_2649)
         {
            this.var_2649 = _loc3_;
            if(_loc3_ == 1)
            {
      ...
      private function requestStopPlaying() : void
      {
         ...
         var _loc1_:RoomObjectFurnitureActionEvent = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_584,object.getId(),object.getType());
         eventDispatcher.dispatchEvent(_loc1_);
      }
