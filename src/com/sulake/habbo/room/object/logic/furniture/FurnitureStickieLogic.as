package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureStickieLogic extends FurnitureLogic
   {
      ...
      {
         var _loc1_:Array = [RoomObjectWidgetRequestEvent.const_154,RoomObjectFurnitureActionEvent.const_627];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(object != null)
         {
            object.getModelController().setString(RoomObjectVariableEnum.const_1082,"");
         }
      }
         ...
         switch(param1.type)
         {
            case MouseEvent.DOUBLE_CLICK:
               if(eventDispatcher != null)
               {
                  ...
                  _loc5_ = new RoomObjectFurnitureActionEvent(RoomObjectFurnitureActionEvent.const_627,_loc3_,_loc4_);
                  if(_loc5_ != null)
                  {
