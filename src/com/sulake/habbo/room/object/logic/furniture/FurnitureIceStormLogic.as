package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureIceStormLogic extends FurnitureMultiStateLogic
   {
      ...
      private var var_2835:Number = 0.0;
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         else
         {
            ...
            this.var_2835 = param1.extra;
            this.var_1289 = lastUpdateTime + _loc3_;
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_1289 > 0 && param1 >= this.var_1289)
         {
            this.var_1289 = 0;
            _loc2_ = new RoomObjectDataUpdateMessage(this.var_1668,String(this.var_1668),this.var_2835);
