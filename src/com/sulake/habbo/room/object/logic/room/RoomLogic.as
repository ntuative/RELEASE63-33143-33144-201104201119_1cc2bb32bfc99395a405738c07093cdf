package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1886:int = 255;
      
      private var var_1490:uint = 16777215;
      
      private var var_1887:int = 255;
      
      private var var_1217:uint = 16777215;
      
      private var var_1884:int = 255;
      
      private var var_1216:int = 0;
      
      private var var_1885:int = 1500;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_502,RoomObjectMouseEvent.const_137];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1178,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_766,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_951,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_897,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_928,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1216)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1886;
            if(_loc2_ - this.var_1216 >= this.var_1885)
            {
               _loc3_ = this.var_1217;
               _loc4_ = this.var_1884;
               this.var_1216 = 0;
            }
            else
            {
               _loc7_ = this.var_1490 >> 16 & 255;
               _loc8_ = this.var_1490 >> 8 & 255;
               _loc9_ = this.var_1490 & 255;
               _loc10_ = this.var_1217 >> 16 & 255;
               _loc11_ = this.var_1217 >> 8 & 255;
               _loc12_ = this.var_1217 & 255;
               _loc13_ = (_loc2_ - this.var_1216) / this.var_1885;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1887 + (this.var_1884 - this.var_1887) * _loc13_;
               this._color = _loc3_;
               this.var_1886 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_766,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_942:
               param2.setString(RoomObjectVariableEnum.const_309,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_686:
               param2.setString(RoomObjectVariableEnum.const_333,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_814:
               param2.setString(RoomObjectVariableEnum.const_324,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_452:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_255)
               {
                  _loc5_ = "null";
               }
               this.var_536.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_877:
               _loc4_ = this.var_536.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_536.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1240,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1263:
               param2.setNumber(RoomObjectVariableEnum.const_951,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1265:
               param2.setNumber(RoomObjectVariableEnum.const_897,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_928,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1214,int(param1.bgOnly));
         this.var_1490 = this._color;
         this.var_1887 = this.var_1886;
         this.var_1217 = _loc3_;
         this.var_1884 = _loc4_;
         this.var_1216 = getTimer();
         this.var_1885 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_539,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1577,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1737,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1536,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_539,_loc5_ + 1);
            var _loc22_:String = "";
            var _loc23_:int = 0;
            var _loc24_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_178 || _loc12_ == RoomPlaneData.const_308)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
