package com.sulake.habbo.room.messages
{
   ...
   public class RoomObjectRoomMaskUpdateMessage extends RoomObjectUpdateMessage
   {
      ...
      public static const const_877:String = "RORMUM_ADD_MASK";
      
      public static const const_1633:String = "door";
      ...
      private var var_2708:Vector3d = null;
      
      private var var_2705:String = "window";
      ...
      public function RoomObjectRoomMaskUpdateMessage(param1:String, param2:String, param3:String = null, param4:IVector3d = null, param5:String = "window")
      {
         ...
         if(param4 != null)
         {
            this.var_2708 = new Vector3d(param4.x,param4.y,param4.z);
         }
