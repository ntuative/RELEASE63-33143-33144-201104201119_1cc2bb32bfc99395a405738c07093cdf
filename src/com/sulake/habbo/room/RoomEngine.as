package com.sulake.habbo.room
{
   ...
   public class RoomEngine extends Component implements IRoomEngine, IRoomManagerListener, IRoomCreator, IRoomEngineServices, IUpdateReceiver
   {
      ...
      private static const const_659:String = "temporary_room";
      
      private static const const_359:int = -1;
      
      private static const const_658:String = "room";
      
      private static const const_1039:int = -2;
      
      private static const const_1458:String = "tile_cursor";
      
      private static const const_1040:int = -3;
      
      private static const const_1459:String = "selection_arrow";
      
      private static const OVERLAY_SPRITE:String = "overlay";
      
      private static const const_358:String = "object_icon_sprite";
      
      private static const const_446:int = 15;
      ...
      private var var_1020:IRoomRendererFactory = null;
      
      private var var_831:IRoomObjectFactory = null;
      
      private var var_561:IRoomObjectVisualizationFactory = null;
      
      private var var_312:IAdManager = null;
      
      private var var_440:ISessionDataManager = null;
      
      private var var_158:IHabboConfigurationManager;
      
      private var var_68:RoomObjectEventHandler = null;
      
      private var var_1022:RoomMessageHandler = null;
      
      private var var_13:RoomContentLoader = null;
      
      private var var_2766:Boolean = false;
      
      private var var_832:NumberBank;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_831.release(new IIDRoomObjectFactory());
            this.var_831 = null;
         }
         if(this.var_561 != null)
         {
            this.var_561.release(new IIDRoomObjectVisualizationFactory());
            this.var_561 = null;
         }
         ...
         {
            this.var_1020.release(new IIDRoomRendererFactory());
            this.var_1020 = null;
         }
         ...
         if(this.var_318 != null)
         {
            ...
            {
               _loc2_ = this.var_318.getWithIndex(_loc1_) as RoomInstanceData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      private function getRoomInstanceData(param1:int, param2:int) : RoomInstanceData
      {
         ...
         var _loc4_:RoomInstanceData = this.var_318.getValue(_loc3_) as RoomInstanceData;
         if(_loc4_ == null)
         {
            _loc4_ = new RoomInstanceData(param1,param2);
            this.var_318.add(_loc3_,_loc4_);
         }
         return _loc4_;
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            _loc2_ = this._roomManager.getRoom(this.getRoomIdentifier(this.var_97,this.var_98));
      ...
      {
         this.var_1260 = false;
         if(this.var_539 && this.var_539.length > 0)
         {
      ...
      private function addBtnMouseCursorOwner(param1:int, param2:int) : void
      {
         ...
         var _loc3_:int = this.var_539.indexOf(param2);
         if(_loc3_ == -1)
         {
      ...
      private function createRoomFurniture() : void
      {
         ...
         do
         {
            for each(_loc4_ in _loc8_)
            {
               ...
               while(!this.var_1021 && (_loc6_ = _loc4_.getWallItemData()) != null)
               {
      ...
      private function updateRoomCameras(param1:uint) : void
      {
         ...
         var _loc10_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_318.length)
         {
            _loc3_ = this.var_318.getWithIndex(_loc2_) as RoomInstanceData;
            _loc4_ = null;
            _loc5_ = 0;
            _loc6_ = 0;
            if(_loc3_ != null)
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc10_ != null)
               {
                  if(_loc5_ != this.var_97 || _loc6_ != this.var_98 || !this.var_1262)
                  {
         ...
         if(_loc8_ != null && _loc9_ != null && _loc10_ != null)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               if(_loc9_.screenWd != _loc13_ || _loc9_.screenHt != _loc14_ || _loc9_.scale != _loc8_.scale || _loc9_.geometryUpdateId != _loc8_.updateId || !Vector3d.isEqual(param4,_loc9_.targetObjectLoc) || _loc9_.isMoving)
               {
                  ...
                  _loc16_ = _loc10_.getNumber(RoomVariableEnum.const_878) - 0.5;
                  _loc17_ = _loc10_.getNumber(RoomVariableEnum.const_712) - 0.5;
                  _loc18_ = _loc10_.getNumber(RoomVariableEnum.const_680) + 0.5;
                  _loc19_ = _loc10_.getNumber(RoomVariableEnum.const_905) + 0.5;
      ...
      private function onObjectFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_831 = param2 as IRoomObjectFactory;
      ...
      private function onVisualizationFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_561 = param2 as IRoomObjectVisualizationFactory;
         if(this.var_13 != null)
         {
            this.var_13.visualizationFactory = this.var_561;
         }
         this.initializeRoomManager();
      }
      ...
      private function onRoomManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._roomManager != null)
         {
            ...
            this._roomManager.addObjectUpdateCategory(RoomObjectCategoryEnum.const_318);
      ...
      private function onRendererFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1020 = param2 as IRoomRendererFactory;
         this.initializeRoomManager();
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_1022 != null)
            {
               this.var_1022.connection = param1;
            }
         }
      }
      ...
      private function onHabboConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_13 != null)
         {
            events.addEventListener(RoomContentLoader.const_926,this.onContentLoaderReady);
            this.var_13.initialize(events,this.var_158);
         }
         this.var_2765 = this.var_158.getKey("room.dragging.always_center","0") == "1";
         this.initializeRoomManager();
      }
      
      private function onContentLoaderReady(param1:Event) : void
      {
         if(param1 != null && param1.type == RoomContentLoader.const_926)
         {
            this.var_2766 = true;
            this.initializeRoomManager();
         }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_312.events.addEventListener(AdEvent.const_533,this.showRoomAd);
         this.var_312.events.addEventListener(AdEvent.const_811,this.onRoomAdImageLoaded);
         this.var_312.events.addEventListener(AdEvent.const_854,this.onRoomAdImageLoaded);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_13.sessionDataManager = this.var_440;
      }
      ...
      private function initializeObjectEvents() : void
      {
         if(this.var_831 != null)
         {
            this.var_831.addObjectEventListener(this.roomObjectEventHandler);
         }
      }
      
      private function initializeRoomManager() : void
      {
         if(this.var_831 == null || this.var_561 == null || this._roomManager == null || this.var_1020 == null || this._communication == null || this.var_158 == null || !this.var_2766)
         {
            return;
         }
      ...
      public function roomManagerInitialized(param1:Boolean = true) : void
      {
         ...
         {
            this.var_538 = true;
            events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_781,0,0));
            _loc2_ = 0;
      ...
      public function setIsPlayingGame(param1:int, param2:int, param3:Boolean) : void
      {
         ...
         {
            _loc5_ = !!param3 ? 1 : 0;
            _loc4_.setNumber(RoomVariableEnum.const_1071,_loc5_);
            if(_loc5_ == 0)
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_566,param1,param2));
            }
            else
            {
               events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_538,param1,param2));
            }
         }
      }
      ...
      public function getIsPlayingGame(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            _loc4_ = _loc3_.getNumber(RoomVariableEnum.const_1071);
            if(_loc4_ > 0)
            {
               return true;
            }
      ...
      public function initializeRoom(param1:int, param2:int, param3:XML) : void
      {
         ...
         events.dispatchEvent(new RoomEngineEvent(RoomEngineEvent.const_321,param1,param2));
      }
      ...
      private function createRoom(param1:String, param2:XML, param3:String, param4:String, param5:String, param6:String) : IRoomInstance
      {
         ...
         if(this.isPublicRoomWorldType(param6))
         {
            ...
            _loc9_ = _loc7_.createRoomObject(const_359,_loc11_,_loc8_) as IRoomObjectController;
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_1189,param6,true);
            _loc7_.setNumber(RoomVariableEnum.const_758,1,true);
            _loc12_ = parseInt(this.var_158.getKey("ads.billboard.displayDelayMillis","1000"));
            _loc9_.getModelController().setNumber(RoomVariableEnum.const_1286,_loc12_,true);
            if(this.var_13 != null)
            {
         ...
         {
            _loc9_ = _loc7_.createRoomObject(const_359,const_658,_loc8_) as IRoomObjectController;
            _loc7_.setNumber(RoomVariableEnum.const_758,0,true);
         }
         _loc7_.setNumber(RoomVariableEnum.const_808,_loc10_,true);
         if(param2 != null)
         {
            _loc13_ = 0;
            if(param2.dimensions.length() == 1)
            {
               ...
               _loc7_.setNumber(RoomVariableEnum.const_878,_loc15_);
               _loc7_.setNumber(RoomVariableEnum.const_680,_loc16_);
               _loc7_.setNumber(RoomVariableEnum.const_712,_loc17_);
               _loc7_.setNumber(RoomVariableEnum.const_905,_loc18_);
               _loc13_ += _loc15_ * 423 + _loc16_ * 671 + _loc17_ * 913 + _loc18_ * 7509;
               if(_loc9_ != null && _loc9_.getModelController() != null)
               {
                  _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1237,_loc13_,true);
               }
            }
         }
         if(_loc9_ != null && _loc9_.getEventHandler() != null)
         {
            ...
            if(param3 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_942,param3);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_309,param3);
            }
            if(param4 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_686,param4);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_333,param4);
            }
            if(param5 != null)
            {
               _loc19_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_814,param5);
               _loc9_.getEventHandler().processUpdateMessage(_loc19_);
               _loc7_.setString(RoomObjectVariableEnum.const_324,param5);
            }
            if(param2 != null)
            {
               if(param2.doors.door.length() > 0)
               {
                  ...
                  while(_loc23_ < _loc20_.length())
                  {
                     ...
                     if(XMLValidator.checkRequiredAttributes(_loc24_,_loc21_))
                     {
                        ...
                        _loc22_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_452,_loc30_,_loc29_,_loc31_,RoomObjectRoomMaskUpdateMessage.const_255);
                        _loc9_.getEventHandler().processUpdateMessage(_loc22_);
                        if(_loc28_ == 90 || _loc28_ == 180)
                        {
                           if(_loc28_ == 90)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_902,_loc25_ - 0.5,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_890,_loc26_,true);
                           }
                           if(_loc28_ == 180)
                           {
                              _loc7_.setNumber(RoomObjectVariableEnum.const_902,_loc25_,true);
                              _loc7_.setNumber(RoomObjectVariableEnum.const_890,_loc26_ - 0.5,true);
                           }
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1192,_loc27_,true);
                           _loc7_.setNumber(RoomObjectVariableEnum.const_1057,_loc28_,true);
                        }
                     }
                     _loc23_++;
                  }
         ...
         _loc7_.createRoomObject(const_1039,const_1458,RoomObjectCategoryEnum.const_318);
         if(this.var_158.getKey("avatar.widget.enabled","0") == "0")
         {
            _loc7_.createRoomObject(const_1040,const_1459,RoomObjectCategoryEnum.const_318);
         }
         return _loc7_;
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_359,RoomObjectCategoryEnum.const_79);
      }
      
      public function method_10(param1:int, param2:int, param3:String = null, param4:String = null, param5:String = null) : Boolean
      {
         var _loc9_:* = null;
         var _loc10_:* = null;
         ...
         if(_loc6_ == null)
         {
            ...
            _loc10_ = this.var_384.getValue(_loc9_);
            if(_loc10_ == null)
            {
               _loc10_ = new RoomData(param1,param2,null);
               this.var_384.add(_loc9_,_loc10_);
            }
            if(param3 != null)
            {
         ...
         if(param3 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_942,param3);
         ...
         if(param4 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_686,param4);
            _loc6_.getEventHandler().processUpdateMessage(_loc8_);
         }
         if(param5 != null)
         {
            ...
            _loc8_ = new RoomObjectRoomUpdateMessage(RoomObjectRoomUpdateMessage.const_814,param5);
            _loc6_.getEventHandler().processUpdateMessage(_loc8_);
         }
         return true;
      }
      ...
      public function updateObjectRoomColor(param1:int, param2:int, param3:uint, param4:int, param5:Boolean) : Boolean
      {
         ...
         var _loc7_:* = null;
         _loc7_ = new RoomObjectRoomColorUpdateMessage(RoomObjectRoomColorUpdateMessage.const_1692,param3,param4,param5);
      ...
      public function updateObjectRoomVisibilities(param1:int, param2:int, param3:Boolean, param4:Boolean = true) : Boolean
      {
         ...
         var _loc6_:* = null;
         _loc6_ = new RoomObjectRoomPlaneVisibilityUpdateMessage(RoomObjectRoomPlaneVisibilityUpdateMessage.const_1265,param3);
      ...
      public function disposeRoom(param1:int, param2:int) : void
      {
         ...
         var _loc4_:RoomInstanceData = this.var_318.remove(_loc3_);
         if(_loc4_ != null)
         {
            _loc4_.dispose();
         }
      ...
      public function createRoomCanvas(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : DisplayObject
      {
         ...
         if(_loc9_ == null)
         {
            _loc9_ = this.var_1020.createRenderer();
         }
         if(_loc9_ == null)
         {
            return null;
         }
         _loc9_.roomObjectVariableAccurateZ = RoomObjectVariableEnum.const_1067;
         ...
         if(_loc10_.geometry != null)
         {
            ...
            _loc10_.geometry.z_scale = _loc8_.getNumber(RoomVariableEnum.const_808);
         }
         if(_loc10_.geometry != null)
         {
            _loc13_ = _loc8_.getNumber(RoomObjectVariableEnum.const_902);
            _loc14_ = _loc8_.getNumber(RoomObjectVariableEnum.const_890);
            _loc15_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1192);
            _loc16_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1057);
      ...
      private function handleRoomDragging(param1:IRoomRenderingCanvas, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean) : Boolean
      {
         var _loc10_:* = null;
         var _loc11_:* = null;
         var _loc8_:int = param2 - this.var_1551;
         var _loc9_:int = param3 - this.var_1550;
         if(param4 == MouseEvent.MOUSE_DOWN)
         {
            if(!param5 && !param6 && !param7)
            {
               this.var_1262 = true;
               this.var_833 = false;
               this.var_2767 = this.var_1551;
               this.var_2768 = this.var_1550;
            }
         }
         ...
         else if(param4 == MouseEvent.MOUSE_MOVE)
         {
            if(this.var_1262)
            {
               if(!this.var_833)
               {
                  _loc8_ = param2 - this.var_2767;
                  _loc9_ = param3 - this.var_2768;
                  if(_loc8_ <= -const_446 || _loc8_ >= const_446 || _loc9_ <= -const_446 || _loc9_ >= const_446)
                  {
                     this.var_833 = true;
                  }
                  _loc8_ = 0;
      ...
      public function handleRoomCanvasMouseEvent(param1:int, param2:int, param3:int, param4:String, param5:Boolean, param6:Boolean, param7:Boolean, param8:Boolean) : void
      {
         ...
         if(_loc9_ != null)
         {
            ...
            _loc11_ = this.getOverlayIconSprite(_loc10_,const_358);
            if(_loc11_ != null)
            {
            ...
            if(!this.handleRoomDragging(_loc9_,param2,param3,param4,param5,param6,param7))
            {
               if(!_loc9_.handleMouseEvent(param2,param3,param4,param5,param6,param7,param8))
               {
                  ...
                  if(param4 == MouseEvent.CLICK)
                  {
                     if(events != null)
                     {
                        events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_458,this.var_97,this.var_98,-1,RoomObjectCategoryEnum.const_163));
                     }
                     _loc13_ = "null";
                  }
                  else if(param4 == MouseEvent.MOUSE_MOVE)
                  ...
                  if(this.var_68 != null)
                  {
                     _loc14_ = new RoomObjectMouseEvent(_loc13_,null,const_359,const_658);
                     this.var_68.handleRoomObjectEvent(_loc14_,this.var_97,this.var_98);
                  }
               }
            }
      ...
      public function setObjectMoverIconSprite(param1:int, param2:int, param3:Boolean, param4:String = null) : void
      {
         ...
         var _loc6_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_98,this.var_1549);
         if(_loc6_ != null)
         {
            _loc9_ = this.getOverlaySprite(_loc6_);
            this.removeOverlayIconSprite(_loc9_,const_358);
            _loc10_ = this.addOverlayIconSprite(_loc9_,const_358,_loc5_.data);
            if(_loc10_ != null)
            {
               _loc10_.x = this.var_1551 - _loc5_.data.width / 2;
               _loc10_.y = this.var_1550 - _loc5_.data.height / 2;
            }
         }
      }
      ...
      public function setObjectMoverIconSpriteVisible(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc2_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_98,this.var_1549);
         if(_loc2_ != null)
         {
            _loc3_ = this.getOverlaySprite(_loc2_);
            _loc4_ = this.getOverlayIconSprite(_loc3_,const_358);
            if(_loc4_ != null)
            {
      ...
      {
         var _loc2_:* = null;
         var _loc1_:IRoomRenderingCanvas = this.getRoomCanvas(this.var_97,this.var_98,this.var_1549);
         if(_loc1_ != null)
         {
            _loc2_ = this.getOverlaySprite(_loc1_);
            this.removeOverlayIconSprite(_loc2_,const_358);
         }
      }
      ...
      public function modifyRoomObject(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_68 != null)
         {
            return this.var_68.modifyRoomObject(this.var_97,this.var_98,param1,param2,param3);
         }
         return false;
      }
      ...
      public function modifyRoomObjectDataWithMap(param1:int, param2:int, param3:String, param4:Map) : Boolean
      {
         if(this.var_68 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_27)
            {
               return this.var_68.modifyRoomObjectData(this.var_97,this.var_98,param1,param2,param3,param4);
            }
         }
         return false;
      }
      ...
      public function modifyRoomObjectData(param1:int, param2:int, param3:String) : Boolean
      {
         if(this.var_68 != null)
         {
            ...
            {
               return this.var_68.modifyWallItemData(this.var_97,this.var_98,param1,param3);
            }
         }
         return false;
      }
      ...
      public function deleteRoomObject(param1:int, param2:int) : Boolean
      {
         if(this.var_68 != null)
         {
            if(param2 == RoomObjectCategoryEnum.const_26)
            {
               return this.var_68.deleteWallItem(this.var_97,this.var_98,param1);
            }
         }
         return false;
      }
      ...
      public function initializeRoomObjectInsert(param1:int, param2:int, param3:int, param4:String = null) : Boolean
      {
         ...
         if(_loc5_ == null || _loc5_.getNumber(RoomVariableEnum.const_758) != 0)
         {
            return false;
         }
         if(this.var_68 != null)
         {
            return this.var_68.initializeRoomObjectInsert(this.var_97,this.var_98,param1,param2,param3,param4);
         }
         return false;
      }
      ...
      public function cancelRoomObjectInsert() : void
      {
         if(this.var_68 != null)
         {
            this.var_68.cancelRoomObjectInsert(this.var_97,this.var_98);
         }
      }
      ...
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1040,RoomObjectCategoryEnum.const_318);
      }
      
      public function getTileCursor(param1:int, param2:int) : IRoomObjectController
      {
         return this.getObject(this.getRoomIdentifier(param1,param2),const_1039,RoomObjectCategoryEnum.const_318);
      }
      ...
      private function addObjectFurnitureFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_197,_loc7_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_331,param4.typeId,true);
            _loc9_.getModelController().setString(RoomObjectVariableEnum.const_416,_loc8_,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_945,1,true);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1218,param4.expiryTime);
            _loc9_.getModelController().setNumber(RoomObjectVariableEnum.const_1107,getTimer());
         }
      ...
      {
         var _loc5_:int = 0;
         return this.method_3(this.getRoomIdentifier(param1,param2),param3,param4,_loc5_);
      }
      ...
      private function addObjectWallItemFromData(param1:int, param2:int, param3:int, param4:FurnitureData) : Boolean
      {
         ...
         {
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_197,_loc6_,false);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_331,param4.typeId,true);
            _loc8_.getModelController().setString(RoomObjectVariableEnum.const_416,_loc7_,true);
            _loc8_.getModelController().setNumber(RoomObjectVariableEnum.const_1067,1,true);
         }
      ...
      public function updateObjectRoomWindow(param1:int, param2:int, param3:int, param4:Boolean = true) : void
      {
         ...
         if(_loc7_ != null)
         {
            ...
            {
               if(_loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1117) > 0)
               {
                  _loc9_ = _loc7_.getModel().getString(RoomObjectVariableEnum.const_1075);
                  _loc10_ = _loc7_.getLocation();
                  if(param4)
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_452,_loc5_,_loc9_,_loc10_);
                  }
                  else
                  {
                     _loc6_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_877,_loc5_);
                  }
               }
            }
         }
      ...
      public function updateObjectUser(param1:int, param2:int, param3:int, param4:IVector3d, param5:IVector3d, param6:IVector3d = null, param7:Number = NaN) : Boolean
      {
         ...
         if(isNaN(param7))
         {
            param7 = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_189);
         }
      ...
      private function method_3(param1:String, param2:int, param3:String, param4:int) : IRoomObjectController
      {
      ...
      private function disposeObject(param1:String, param2:int, param3:int) : void
      {
         ...
         if(_loc4_.disposeObject(param2,param3))
         {
            if(events != null)
            {
               events.dispatchEvent(new RoomEngineObjectEvent(RoomEngineObjectEvent.const_957,this.var_97,this.var_98,param2,param3));
            }
         }
      }
      ...
      private function roomObjectEventHandler(param1:RoomObjectEvent) : void
      {
         if(this.var_68 != null)
         {
            this.var_68.handleRoomObjectEvent(param1,this.var_97,this.var_98);
         }
      }
            ...
            if(_loc14_ != null && _loc14_.getModel() != null)
            {
               ...
               switch(param4)
               {
                  ...
                  case RoomObjectCategoryEnum.const_26:
                     _loc10_ = String(_loc14_.getModel().getNumber(RoomObjectVariableEnum.const_197));
                     _loc11_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_299);
                     break;
                  case RoomObjectCategoryEnum.const_34:
                     _loc10_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_191);
               }
            }
         }
      ...
      private function initializeRoomForGettingImage(param1:IRoomObjectController, param2:String) : void
      {
         ...
         if(param2 != null)
         {
            ...
            if(_loc3_.length >= 3)
            {
               ...
               _loc8_.addPlane(RoomPlaneData.const_210,new Vector3d(0,0,0),new Vector3d(10,0,0),new Vector3d(0,10,0));
               _loc8_.addPlane(RoomPlaneData.const_178,new Vector3d(0,0,0),new Vector3d(0,10,0),new Vector3d(0,0,10));
               _loc8_.addPlane(RoomPlaneData.const_178,new Vector3d(10,0,0),new Vector3d(-10,0,0),new Vector3d(0,0,10));
               ...
               param1.getModelController().setString(RoomObjectVariableEnum.const_324,_loc6_);
               if(_loc7_ != null)
               {
                  _loc10_ = null;
                  _loc11_ = "undefined_1";
                  _loc10_ = new RoomObjectRoomMaskUpdateMessage(RoomObjectRoomMaskUpdateMessage.const_452,_loc11_,_loc7_,new Vector3d(2,0,1.75));
      ...
      public function getGenericRoomObjectImage(param1:String, param2:String, param3:IVector3d, param4:int, param5:IGetImageListener, param6:uint = 0, param7:String = null, param8:int = -1, param9:int = -1) : ImageResult
      {
         ...
         _loc10_.id = -1;
         if(!this.var_538 || param1 == null)
         {
            return _loc10_;
         }
         var _loc11_:IRoomInstance = this._roomManager.getRoom(const_659);
         if(_loc11_ == null)
         {
            _loc11_ = this._roomManager.createRoom(const_659,null);
            if(_loc11_ == null)
            {
               return _loc10_;
            }
         }
         var _loc12_:int = this.var_832.reserveNumber();
         ...
         switch(_loc13_)
         {
            case RoomObjectCategoryEnum.const_27:
            case RoomObjectCategoryEnum.const_26:
               _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_197,int(param2));
               _loc14_.getModelController().setString(RoomObjectVariableEnum.const_299,param7);
               break;
            case RoomObjectCategoryEnum.const_34:
               if(param1 == "user" || param1 == "bot" || param1 == "pet")
               {
                  _loc14_.getModelController().setString(RoomObjectVariableEnum.const_191,param2);
               }
               else
               {
                  _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_797,int(param2));
               }
               break;
         ...
         if(param8 > -1)
         {
            _loc18_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_88);
         ...
         {
            this.var_1261.add(String(_loc12_),param5);
            _loc14_.getModelController().setNumber(RoomObjectVariableEnum.const_1156,param4,true);
         }
         else
         {
            _loc11_.disposeObject(_loc12_,_loc13_);
            this.var_832.freeNumber(_loc12_ - 1);
            _loc10_.id = 0;
         }
         _loc16_.dispose();
         return _loc10_;
      ...
      {
         return this.getRoomObjectBoundingRectangle(this.var_97,this.var_98,const_359,RoomObjectCategoryEnum.const_79,param1);
      }
      ...
      public function contentLoaded(param1:String, param2:Boolean = false) : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:Number = NaN;
         var _loc3_:IRoomInstance = this._roomManager.getRoom(const_659);
         if(_loc3_ == null)
         {
            return;
         }
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(_loc9_ != null && _loc9_.getModel() != null && _loc9_.getType() == param1)
            {
               ...
               if(_loc12_ != null)
               {
                  _loc14_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1156);
               ...
               this.var_832.freeNumber(_loc10_ - 1);
               _loc13_ = this.var_1261.remove(String(_loc10_)) as IGetImageListener;
      ...
      public function objectInitialized(param1:String, param2:int, param3:int) : void
      {
         ...
         {
            _loc7_ = _loc6_.getModel().getString(RoomObjectVariableEnum.const_88);
            if(_loc7_ != null)
            {
      ...
      private function showRoomAd(param1:AdEvent) : void
      {
         ...
         if(this.var_13 != null)
         {
            ...
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_384,param1.image,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1127,param1.adWarningL,true);
            this.var_13.addGraphicAsset(this.var_13.getPublicRoomContentType(_loc2_),RoomObjectVariableEnum.const_1224,param1.adWarningR,true);
            ...
            _loc4_ = null;
            _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1116,RoomObjectVariableEnum.const_384,param1.clickUrl);
      ...
      public function requestRoomAdImage(param1:int, param2:int, param3:String, param4:String) : void
      {
         ...
         {
            this.var_312.loadRoomAdImage(param1,param2,param3,param4);
         }
      }
      ...
      private function onRoomAdImageLoaded(param1:AdEvent) : void
      {
         ...
         switch(param1.type)
         {
            case AdEvent.const_811:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1221,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
               break;
            case AdEvent.const_854:
               _loc4_ = new RoomObjectRoomAdUpdateMessage(RoomObjectRoomAdUpdateMessage.const_1228,param1.imageUrl,param1.clickUrl,param1.objectId,param1.image);
         }
         if(_loc4_ != null)
         {
            _loc3_.getEventHandler().processUpdateMessage(_loc4_);
