package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_285:Boolean = false;
      
      private static const const_639:String = "FriendBar";
      
      private static const const_638:String = "user_interaction";
      
      private static const const_1301:String = "visit_btn_click";
      
      private static const const_1302:String = "chat_btn_click";
      
      private static const const_1298:String = "find_friends_btn_click";
      
      private static const const_963:String = "Toolbar";
      
      private static const const_964:String = "open";
      
      private static const const_965:String = "close";
      
      private static const const_1300:String = "FRIENDLIST";
      
      private static const const_1299:String = "MESSENGER";
       
      
      private var var_84:IHabboCommunicationManager;
      
      private var var_336:IHabboFriendList;
      
      private var var_408:IHabboMessenger;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_336)
            {
               this.var_336.release(new IIDHabboFriendList());
               this.var_336 = null;
            }
            if(this.var_408)
            {
               this.var_408.release(new IIDHabboMessenger());
               this.var_408 = null;
            }
            this.var_132 = null;
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_84)
         {
            ...
            this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_639,const_638,const_1301));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_408)
         {
            this.var_408.startConversation(param1);
            events.dispatchEvent(new NewMessageEvent(false));
            if(this.var_84)
            {
               this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_639,const_638,const_1302));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_84)
         {
            ...
            this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_639,const_638,const_1298));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         if(this.var_336)
         {
            if(!this.var_336.disposed)
            {
               if(!this.var_336.isOpen())
               {
                  if(this._friendRequests.length > 0)
                  {
                     this.var_336.openFriendRequests();
                  }
                  else
                  {
                     this.var_336.openFriendList();
                  }
               }
               else
               {
               ...
               if(this.var_84)
               {
                  this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_963,const_1300,!!this.var_336.isOpen() ? const_964 : const_965));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_408)
         {
            if(!this.var_408.disposed)
            {
               this.var_408.toggleMessenger();
               if(this.var_84)
               {
                  this.var_84.getHabboMainConnection(null).send(new ConversionPointMessageComposer(const_963,const_1299,!!this.var_408.isOpen() ? const_964 : const_965));
               }
            }
         }
      }
      ...
      private function onFriendListUpdate(param1:IMessageEvent) : void
      {
         ...
         for each(_loc4_ in _loc6_)
         {
            ...
            else if(_loc4_.online || const_285)
            {
         ...
         {
            this.var_132 = !!const_285 ? this.sortByNameAndOnlineStatus(this.var_132) : this.sortByName(this.var_132);
         }
