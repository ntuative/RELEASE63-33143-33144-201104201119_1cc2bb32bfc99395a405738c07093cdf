package com.sulake.habbo.friendbar.view.utils
{
   ...
   public class FriendListIcon extends Icon
   {
      ...
      private static const const_989:int = 500;
      ...
      override public function notify(param1:Boolean) : void
      {
         super.notify(param1);
         this.enable(param1);
         toggleTimer(param1 || var_870,!!var_870 ? int(const_990) : int(const_989));
         if(!var_871 && !var_870)
         {
      ...
      {
         super.hover(param1);
         toggleTimer(param1 || var_871,!!var_870 ? int(const_990) : int(const_989));
         if(!var_871 && !var_870)
         {
            image = this._assets.getAssetByName("icon_friendlist_png") as BitmapDataAsset;
         }
