package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1518:IDesktopWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_1228:Function;
      
      private var var_1226:Function;
      
      private var var_803:IAssetLibrary;
      
      private var var_1227:uint = 0;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         this.var_803 = param2;
         this._events = param3;
         this.var_1518 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_803.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_803.getAssetByName(_loc2_.assetName);
      ...
      private function hotelViewLoadedCallbackHandler(param1:AssetLoaderEvent) : void
      {
         ...
         else if(param1.type == AssetLoaderEvent.const_29)
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_517));
            }
            _loc4_ = BitmapDataAsset(_loc3_).content as BitmapData;
            if(this.var_1226 != null)
            {
               this.var_1226(_loc4_);
               this.var_1226 = null;
            }
         }
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_803.loadAssetFromFile("hotel_view_banner_" + this.var_1227,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
         ...
         else
         {
            if(this._events != null)
            {
               this._events.dispatchEvent(new Event(HabboHotelViewEvent.const_933));
            }
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1518.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1518.removeChild(this._window);
         }
      }
   }
}
