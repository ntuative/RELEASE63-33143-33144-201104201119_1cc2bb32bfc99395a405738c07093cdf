package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2787:PseudoRandom;
      ...
      private var var_238:HabboHotelView;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_679 = param1;
            this.var_57.initConnection(HabboConnectionType.const_236);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_16.events.addEventListener(RoomSessionEvent.const_92,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_238 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_238.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this.var_158.getKey("use.sso.ticket") == "1";
         this.var_679 = this.var_158.getKey("sso.ticket",null);
         this.var_2025 = this.var_158.getKey("flash.client.url","");
         this.var_2788 = this.var_158.getKey("external.variables.txt","");
         if(this.var_238 == null)
         {
            this.var_238 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_575,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_57.mode = HabboConnectionType.const_1278;
            }
         }
         this.var_57.initConnection(HabboConnectionType.const_236);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_939);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2787 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_57.mode)
         {
            case HabboConnectionType.const_97:
               ...
               this.var_1564 = _loc4_;
               this.var_238.loadBannerImage(_loc7_ + "?token=" + this.var_1564,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1278:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1509:
               this.var_1031 = this.generateRandomHexString(30);
               this.var_546 = new DiffieHellman(new BigInteger(this.var_158.getKey("connection.development.prime"),16),new BigInteger(this.var_158.getKey("connection.development.generator"),16));
               this.var_546.init(this.var_1031);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2787);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         this.var_1565 = true;
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_249);
         connection.send(new VersionCheckMessageComposer(401,this.var_2025,this.var_2788));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1815,"/");
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_258);
      }
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         if(_loc2_.length > 0)
         {
            _loc2_ = this.setReasonProperty(_loc2_,param1.method_11);
            _loc2_ = this.setOriginProperty(_loc2_);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1564);
