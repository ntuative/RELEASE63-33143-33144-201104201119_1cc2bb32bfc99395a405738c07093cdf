package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      private var var_992:IPartColor;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_1041.width,this.var_1041.height,true,0);
            _loc5_ = this.var_1041.clone();
            _loc5_.colorTransform(_loc5_.rect,this.var_992.colorTransform);
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_993.width,this.var_993.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_993,this.var_993.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
