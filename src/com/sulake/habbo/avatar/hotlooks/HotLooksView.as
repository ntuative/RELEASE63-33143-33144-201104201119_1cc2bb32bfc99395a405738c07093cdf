package com.sulake.habbo.avatar.hotlooks
{
   ...
   public class HotLooksView implements IAvatarEditorCategoryView
   {
      ...
      private var var_69:HotLooksModel;
      
      private var var_665:IItemGridWindow;
      ...
      public function init() : void
      {
         ...
         this.var_665 = this._window.findChildByName("hotlooks") as IItemGridWindow;
      ...
      {
         while(this.var_665.numGridItems > 0)
         {
            this.var_665.removeGridItemAt(0);
         }
         this._window.dispose();
         this._window = null;
         this.var_69 = null;
      ...
      public function update() : void
      {
         ...
         var _loc2_:* = null;
         this.var_665.removeGridItems();
         for each(_loc2_ in this.var_69.hotLooks)
         {
            _loc1_ = _loc2_.view.window;
            this.var_665.addGridItem(_loc1_);
      ...
      private function hotLooksEventProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         ...
         {
            _loc3_ = this.var_665.getGridItemIndex(param2.parent);
            this.var_69.selectHotLook(_loc3_);
         }
      }
