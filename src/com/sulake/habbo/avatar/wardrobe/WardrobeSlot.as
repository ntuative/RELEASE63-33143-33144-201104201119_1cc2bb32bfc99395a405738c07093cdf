package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeSlot implements IOutfit, IAvatarImageListener
   {
      ...
      private function createView() : void
      {
         ...
         this.var_371 = this._view.findChildByName("image") as IBitmapWrapperWindow;
      }
      ...
      public function updateView() : void
      {
         ...
         if(this.var_654 && this.var_1511)
         {
            _loc5_ = this._controller.avatarRenderManager.createAvatarImage(this.figure,AvatarScaleType.const_93,this.var_991,this);
            if(_loc5_)
            {
               _loc5_.setDirection(AvatarSetType.const_37,parseInt(FigureData.const_956));
         ...
         if(this.var_371)
         {
            ...
            _loc7_ = (this.var_371.width - _loc1_.width) / 2;
            _loc8_ = (this.var_371.height - _loc1_.height) / 2;
            this.var_371.bitmap.draw(_loc1_,new Matrix(1,0,0,1,_loc7_,_loc8_));
         }
         if(_loc2_)
         {
            _loc1_.dispose();
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            case "set_button":
               this.var_654 = this._controller.figureData.getFigureString();
               this.var_991 = this._controller.gender;
               this._controller.handler.saveWardrobeOutfit(this.var_1915,this);
               this.updateView();
               break;
            case "get_button":
               if(this.var_654)
               {
                  this._controller.loadAvatarInEditor(this.var_654,this.var_991,this._controller.clubMemberLevel);
               }
         }
      }
