package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_2703:uint;
      
      private var var_2701:uint;
      ...
      private var var_1779:Number = 1.0;
      
      private var var_1780:Number = 1.0;
      
      private var var_1781:Number = 1.0;
      
      private var _alphaMultiplier:Number = 1.0;
      
      private var var_1239:Map;
      ...
      {
         super();
         this.var_1939 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2703 = parseInt(_loc2_,16);
         this.var_2701 = parseInt(_loc3_,16);
         ...
         this.var_771 = new ColorTransform(this.var_1779,this.var_1780,this.var_1781,this._alphaMultiplier);
         this.var_1239 = this.generatePaletteMapForGrayscale(this.var_2701,this.var_2703);
      }
      ...
      {
         return this.var_1239.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1239.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1239.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1239.getValue("alphas") as Array;
      }
