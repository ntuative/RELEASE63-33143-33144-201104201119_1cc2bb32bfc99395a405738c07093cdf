package com.sulake.habbo.avatar.animation
{
   ...
   public class AnimationManager implements IAnimationManager
   {
      ...
      {
         var _loc4_:Animation = this.var_327[param1] as Animation;
         if(_loc4_ != null)
         {
