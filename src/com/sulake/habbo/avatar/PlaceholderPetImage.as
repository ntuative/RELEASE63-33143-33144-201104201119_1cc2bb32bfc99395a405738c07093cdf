package com.sulake.habbo.avatar
{
   ...
   public class PlaceholderPetImage extends PetImage
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_642)
         {
            for each(_loc1_ in this.var_642)
            {
            }
      ...
      override public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc2_:BitmapData = this.getPlaceHolderImage(var_90,_scale);
         if(!_loc2_)
         {
            return null;
         }
      ...
      override public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc3_:BitmapData = this.getPlaceHolderImage(var_90,_scale);
      ...
      private function getPlaceHolderImage(param1:int, param2:String) : BitmapData
      {
         ...
         _loc3_ += "_png";
         _loc6_;
         var _loc4_:BitmapData = this.var_642.getValue(_loc3_);
         if(!_loc4_)
         {
            ...
            _loc6_;
            this.var_642.add(_loc3_,_loc4_.clone());
            _loc4_ = this.var_642.getValue(_loc3_);
         }
         return _loc4_;
      }
