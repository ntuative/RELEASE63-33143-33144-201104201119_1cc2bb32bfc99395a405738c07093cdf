package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private static const const_1463:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1462:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_725:ISessionDataManager;
      
      private var _view:AvatarEditorView;
      
      private var var_1265:AvatarEditorHandler;
      ...
      private var var_1024:IFigureData;
      
      private var var_672:Dictionary;
      
      private var var_991:String = "M";
      
      private var var_1264:int = 0;
      
      private var var_2007:Boolean;
      
      private var var_1553:IHabboAvatarEditorDataSaver = null;
      
      private var var_2006:Boolean = false;
      
      private const const_1461:int = 2;
      ...
      override public function dispose() : void
      {
         ...
         {
            for each(_loc2_ in this.var_542)
            {
               _loc2_.dispose();
               _loc2_ = null;
            }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         if(!this.var_198)
         {
            ...
            this.var_672["null"] = new FigureData(this);
            this.var_672["null"] = new FigureData(this);
            _loc2_ = this.var_672["null"];
            _loc3_ = this.var_672["null"];
            _loc2_.loadAvatarData(const_1463,FigureData.const_83);
            _loc3_.loadAvatarData(const_1462,FigureData.FEMALE);
            this.var_103 = new Map();
            this.var_542 = new Map();
            this.var_103.add(AvatarEditorFigureCategory.const_922,new BodyModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_50,new HeadModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_240,new TorsoModel(this));
            this.var_103.add(AvatarEditorFigureCategory.const_899,new LegsModel(this));
            ...
            this.var_542.add(AvatarEditorSideCategory.const_110,new WardrobeModel(this));
            this.var_542.add(AvatarEditorSideCategory.const_611,new ClubPromoModel(this));
            this.var_198 = true;
         }
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         var _loc4_:FigureData = this.var_672[param2];
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return this.var_1024.getSetType(param1);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return this.var_1024.getPalette(param1);
      }
      ...
      public function openEditor(param1:IWindowContainer = null, param2:IHabboAvatarEditorDataSaver = null, param3:Array = null, param4:Boolean = false, param5:Boolean = true) : Boolean
      {
         ...
         else
         {
            if(this.var_275 == null)
            {
               this.var_275 = this._windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_69,HabboWindowStyle.const_30,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               this.var_275.addChild(this._view.window);
               if(param5)
               {
                  this.var_275.center();
               }
            ...
            this.var_275.visible = !this.var_275.visible;
         }
         this._view.show();
         ...
         {
            this.toggleAvatarEditorPage(AvatarEditorFigureCategory.const_922);
         }
      ...
      {
         var _loc2_:ISideContentModel = this.var_542.getValue(param1) as ISideContentModel;
         if(_loc2_ != null)
         {
            return _loc2_.getWindowContainer();
         }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_725 = param2 as ISessionDataManager;
      }
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (this.var_541 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,this.onAvatarRendererReady);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         this.var_1024 = this.var_541.getFigureData(AvatarType.const_118);
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1265 = new AvatarEditorHandler(this,this._communication);
      }
      ...
      {
         return this.var_672[this.var_991];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         if(this.var_1553 != null)
         {
            ...
            this.var_1553.saveFigure(_loc1_,_loc2_);
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_2007;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_1264 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < this.const_1461)
                  {
                     _loc18_ = new AvatarEditorGridColorItem(AvatarEditorView.var_1607.clone() as IWindowContainer,param1,_loc13_);
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_541.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_541.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            ...
            if(_loc15_)
            {
               ...
               if(_loc21_)
               {
                  ...
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1324.clone() as IWindowContainer,param1,null,null,false);
            ...
            {
               _loc23_ = false;
               if(_loc6_.gender == FigureData.const_1531)
               {
                  _loc23_ = true;
               }
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_1264 >= _loc6_.clubLevel))
               {
                  _loc7_ = new AvatarEditorGridPartItem(AvatarEditorView.var_1324.clone() as IWindowContainer,param1,_loc6_,_loc11_,_loc16_);
                  _loc3_.push(_loc7_);
               }
            }
         }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_1264 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_542.getValue(AvatarEditorSideCategory.const_110);
      }
