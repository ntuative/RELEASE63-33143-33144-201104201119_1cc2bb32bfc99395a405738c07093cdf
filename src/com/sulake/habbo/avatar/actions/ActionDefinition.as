package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      private var var_1869:Dictionary;
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_1869 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2587 = parseInt(param1.@precedence);
         this.var_2591 = String(param1.@activepartset);
         this.var_2588 = String(param1.@assetpartdefinition);
         this.var_2585 = String(param1.@lay);
         this.var_836 = String(param1.@geometrytype);
         this.var_2514 = Boolean(parseInt(param1.@main));
         this.var_2590 = Boolean(parseInt(param1.@var_636));
         this.var_2586 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "default")
            {
               this.var_2589 = _loc6_;
            }
            else
            {
               this.var_1869[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_141[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1869[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2589;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_141[param1];
         if(_loc2_ != null)
         {
