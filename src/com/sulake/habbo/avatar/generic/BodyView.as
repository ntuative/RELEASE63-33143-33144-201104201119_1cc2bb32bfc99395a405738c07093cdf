   ...
   public class BodyView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.FACE,_windowManager,_assetLibrary);
         }
         else
         {
      ...
      public function updateGenderTab() : void
      {
         ...
         switch(var_69.controller.gender)
         {
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case this.const_665:
                  var_69.controller.gender = FigureData.const_83;
                  param1.stopPropagation();
                  break;
               case this.const_664:
                  var_69.controller.gender = FigureData.FEMALE;
                  param1.stopPropagation();
            }
         }
