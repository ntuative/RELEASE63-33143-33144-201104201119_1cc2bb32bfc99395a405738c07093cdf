package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1377:String = AvatarSetType.const_37;
      ...
      protected var var_276:AvatarImageCache;
      
      protected var var_654:AvatarFigureContainer;
      
      protected var var_572:IAvatarDataContainer;
      
      protected var var_331:Array;
      
      protected var var_49:BitmapData;
      
      private var var_947:IActiveActionData;
      ...
      private var var_2831:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.var_654 = param3;
         this.var_276 = new AvatarImageCache(this._structure,this,this._assets,this._scale);
         this.setDirection(const_1377,const_1379);
         this.var_331 = new Array();
         this.var_947 = new ActiveActionData(AvatarAction.const_383);
         this.var_947.definition = this._structure.getActionDefinition(const_1378);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_654,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_1812;
         if(param2 < AvatarDirectionAngle.const_1275)
         {
            param2 = AvatarDirectionAngle.const_327 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_327)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_50 || param1 == AvatarSetType.const_37)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_687,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_282.length == 1 && this.var_90 == this.var_1665)
         {
            return this.var_90 + this.var_551 + this.var_687 % 4;
         }
         if(this.var_282.length == 2)
         {
            for each(_loc1_ in this.var_282)
            {
               ...
               {
                  return this.var_90 + this.var_551 + 0;
               }
               if(_loc1_.actionType == "fx" && (_loc1_.actionParameter == "38" || _loc1_.actionParameter == "39"))
               {
                  _loc2_ = this.var_687 % 11;
                  return this.var_90 + "_" + this.var_1665 + this.var_551 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2829 || param2 != this.var_2830 || param1 != this.var_2831)
         {
            this.var_2829 = param3;
            this.var_2830 = param2;
            this.var_2831 = param1;
            this.var_2045 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1343 || this.var_49 == null || (this.var_49.width != _loc5_.width || this.var_49.height != _loc5_.height))
         {
            if(this.var_49 != null && !this.var_1343)
            {
               this.var_49.dispose();
            }
         ...
         var _loc6_:Array = this.getBodyParts(param1,this.var_287.definition.geometryType,this.var_90);
         this.var_49.lock();
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_687);
         ...
         {
            if(this.var_572.paletteIsGrayscale)
            {
               ...
               this.var_49 = _loc13_;
               this.var_49.paletteMap(this.var_49,this.var_49.rect,new Point(0,0),this.var_572.reds,[],[]);
            }
            else
            {
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc5_:Array = this._structure.getBodyParts(param1,this.var_287.definition.geometryType,this.var_90);
         var _loc11_:Rectangle = new Rectangle();
         var _loc12_:int = _loc5_.length - 1;
         while(_loc12_ >= 0)
         {
            _loc7_ = _loc5_[_loc12_];
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_687);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_331.length)
         {
            _loc3_ = this.var_331[_loc4_];
         ...
         this.var_331.push(new ActiveActionData(param1,param2,this.var_687));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_287 = this.var_947;
         this.var_287.definition = this.var_947.definition;
         this.resetBodyPartCache(this.var_947);
         return true;
      }
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_551 = "";
         this.var_282 = this._structure.sortActions(this.var_331);
         if(this.var_282 == null)
         {
         ...
         {
            this.var_785 = this._structure.getCanvasOffsets(this.var_282,this._scale,this.var_90);
            for each(_loc4_ in this.var_282)
            {
               this.var_551 += _loc4_.actionType + _loc4_.actionParameter;
               if(_loc4_.actionType == AvatarAction.const_338)
               {
            ...
            if(this.var_1577 != this.var_551)
            {
               _loc1_ = true;
               this.var_1577 = this.var_551;
            }
         }
         this.var_1448 = true;
         return _loc1_;
      ...
      private function setActionsToParts() : void
      {
         ...
         for each(_loc1_ in this.var_282)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               {
                  this.var_948 = _loc1_.definition.isAnimated(_loc1_.actionParameter);
                  _loc2_ = this._structure.getAnimation(_loc1_.definition.state + "." + _loc1_.actionParameter);
                  if(_loc2_ != null)
                  {
                     ...
                     {
                        this.var_1812 = _loc2_.directionData.offset;
                     }
                     if(_loc2_.hasAvatarData())
                     {
                        this.var_572 = _loc2_.avatarData;
                     }
                  }
               }
               if(_loc1_.actionType == AvatarAction.const_303 || _loc1_.actionType == AvatarAction.WAVE || _loc1_.actionType == AvatarAction.const_428)
               {
                  this.var_948 = true;
               }
            }
