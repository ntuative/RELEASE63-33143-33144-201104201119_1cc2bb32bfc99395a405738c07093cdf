package com.sulake.habbo.avatar.structure.figure
{
   ...
   public class SetType implements ISetType
   {
      ...
      public function SetType(param1:XML)
      {
         ...
         this.var_2493 = parseInt(param1.@paletteid);
         this.var_638 = new Dictionary();
         this.var_638["F"] = new Dictionary();
         this.var_638["M"] = new Dictionary();
         this.var_638["F"][0] = Boolean(parseInt(param1.@mand_f_0));
         this.var_638["F"][1] = Boolean(parseInt(param1.@mand_f_1));
         this.var_638["M"][0] = Boolean(parseInt(param1.@mand_m_0));
         this.var_638["M"][1] = Boolean(parseInt(param1.@mand_m_1));
      ...
      public function cleanUp(param1:XML) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         for each(_loc2_ in param1["HabboCatalogCom_layout_bg"])
         {
      ...
      {
         return this.var_638[param1.toUpperCase()][Math.min(param2,1)];
      }
