package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1158:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2518:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         try
         {
            this.var_1838 = new XML(loaderStruct.assetLoader.content as String);
         }
         catch(e:Error)
         {
         ...
         this.var_2518.appendXML(this.var_1838);
         dispatchEvent(new Event(AvatarStructureDownload.const_1158));
      }
   }
}
