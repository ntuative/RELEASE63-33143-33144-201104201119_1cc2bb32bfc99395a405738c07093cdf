package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1324:IWindowContainer;
      
      public static var var_1607:IWindowContainer;
      
      public static var var_2083:int = 6710886;
      ...
      private var var_353:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_498:IFrameWindow;
      ...
      private var var_2368:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_1155 = [];
         this.var_1429 = [AvatarEditorFigureCategory.const_922,AvatarEditorFigureCategory.const_50,AvatarEditorFigureCategory.const_240,AvatarEditorFigureCategory.const_899,AvatarEditorFigureCategory.HOTLOOKS,AvatarEditorFigureCategory.const_110];
         super();
         ...
         if(var_1324 == null)
         {
            ...
            var_1324 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1607 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1607 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_427 = new Timer(1000);
         this.var_427.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1429;
         }
         for each(_loc6_ in param4)
         {
            this.var_1155.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_427.stop();
            this.var_427.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_427 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1429);
         }
         if(param1.length != this.var_1155.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_1155.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_2369 = this.canChangeOutfit();
            this.var_427.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_353 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_353.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_353.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_1155.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_353.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_353.numSelectables)
               {
                  this.var_353.getSelectableAt(_loc6_).x = this.var_353.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
         }
         this.var_353.setSelected(this.var_353.getSelectableAt(0));
         this.attachImages();
         this.update();
      }
      ...
      private function attachImages() : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:* = null;
         var _loc1_:Array = this.var_1429;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe",HabboClubLevelEnum.const_45) && (this.var_1768 == AvatarEditorSideCategory.const_110 || this.var_2368))
         {
         ...
         this.setViewToCategory(this.var_355);
      }
      ...
      {
         if(this.var_1768 == AvatarEditorSideCategory.const_110)
         {
            this.var_2368 = false;
            this.setSideContent(AvatarEditorSideCategory.const_719);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_719:
               break;
            case AvatarEditorSideCategory.const_611:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_611);
               break;
            case AvatarEditorSideCategory.const_110:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_110);
         }
         _loc2_.removeChildAt(0);
         _loc2_.invalidate();
         if(_loc3_)
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         this.var_355 = param1;
         this.var_353.setSelected(this.var_353.getSelectableByName(param1));
      }
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "save":
                  ...
                  this.var_2160 = new Date().valueOf();
                  this.var_2369 = false;
                  this.var_427.start();
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_498)
         {
            ...
            this.var_498 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_498.procedure = this.stripClubDialogEventProc;
            this.var_498.center();
         }
         else
         {
            this.var_498.visible = true;
            this.var_498.center();
         }
      }
      ...
      private function canChangeOutfit() : Boolean
      {
         ...
         return _loc1_ - this.var_2160 > 5000;
      }
   }
}
