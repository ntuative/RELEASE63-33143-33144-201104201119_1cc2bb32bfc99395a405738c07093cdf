   ...
   public class LegsView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.TROUSERS,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.const_267,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.const_268,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_69 && var_148 == "")
         {
            var_69.switchCategory(FigureData.TROUSERS);
         }
      }
