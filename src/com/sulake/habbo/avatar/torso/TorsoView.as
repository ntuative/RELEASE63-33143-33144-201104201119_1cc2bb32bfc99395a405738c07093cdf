   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_41)
         {
            ...
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.const_263,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.const_196,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_41["null"] = new AvatarEditorGridView(var_69,FigureData.const_242,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_69 && var_148 == "")
         {
            var_69.switchCategory(FigureData.const_196);
         }
      }
      ...
      public function switchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            case FigureData.const_196:
               var_50 = "tab_shirt";
               break;
            case FigureData.const_263:
               var_50 = "tab_jacket";
               break;
      ...
      private function windowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               case "tab_jacket":
                  this.switchCategory(FigureData.const_263);
                  break;
               case "tab_shirt":
                  this.switchCategory(FigureData.const_196);
                  break;
