package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, IUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_447:uint = 3;
      
      private static const const_1483:uint = 1;
      ...
      private var var_1582:IEventDispatcher;
      
      private var var_1290:Boolean = false;
      
      private var var_2050:ProfilerOutput;
      
      private var var_1583:ProfilerAgentTask;
      
      private var var_1584:ProfilerAgentTask;
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_218 = new Array(const_447);
         ...
         this.var_275 = this.var_218[const_1483];
         unlock();
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(_loc3_ != null)
         {
            if(!this.var_2050)
            {
               this.var_2050 = new ProfilerOutput(context,this,this._windowRenderer);
            }
            this.var_2050.profiler = _loc3_;
            this.var_1583 = new ProfilerAgentTask("Update","Event processing");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1583);
            this.var_1584 = new ProfilerAgentTask("Redraw","Window rasterizer");
            _loc3_.getProfilerAgentForReceiver(this).addSubTask(this.var_1584);
            this.var_1290 = true;
         }
      }
      ...
      {
         return this.var_275.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      {
         return this.var_275.getWindowParser().windowToXMLString(param1);
      }
      
      public function getLayoutByTypeAndStyle(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = this.var_283[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? this.var_283[0][param1] as XML : _loc4_;
      }
      ...
      {
         return this.var_218[param1].getDesktopWindow().getChildAt(this.var_275.getDesktopWindow().numChildren - 1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(WindowContext.var_396.length > 0)
         {
            this.var_1582.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_447 - 1;
            while(_loc2_ >= 0)
            {
         ...
         this.var_1582.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_447)
         {
         ...
         if(WindowContext.var_396.length > 0)
         {
            WindowContext.var_396.flush();
         }
         MouseCursorControl.change();
         this.var_1582.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            ...
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1496,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1542,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1707,new Date().getTime().toString());
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1676,param2.name + ": " + param2.toString());
            }
         }
      }
      ...
      private function performTestCases() : void
      {
         ...
         _loc1_.begin(this);
         _loc1_.test({
            "type":WindowType.const_531,
            "style":WindowStyle.const_167,
            "caption":"Testing",
            "count":800,
            "properties":[_loc2_]
         });
