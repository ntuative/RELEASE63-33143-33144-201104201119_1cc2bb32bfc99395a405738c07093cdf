package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201104201114));
         this._toolbar = param5;
         this.var_117 = new Map();
         this.var_117.add(HabboHelpViewEnum.const_1782,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_214,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_455,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_350,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_230,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_423,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_676,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_254,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_117.add(HabboHelpViewEnum.const_1094,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_117.add(HabboHelpViewEnum.const_1187,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_117.add(HabboHelpViewEnum.const_675,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_117.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_117.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_500.length == 0 || param1 != this.var_355)
            {
               this.var_500.push(this.var_355);
            }
         }
         this.var_355 = param1;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_254:
               this.showUI(HabboHelpViewEnum.const_254);
               break;
            case CallForHelpResultEnum.const_1175:
               this.showUI(HabboHelpViewEnum.const_1187);
               break;
            case CallForHelpResultEnum.const_1199:
               this.showUI(HabboHelpViewEnum.const_1094);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_117.getValue(HabboHelpViewEnum.const_214) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_508));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = this.var_117.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_117.getValue(this.var_355);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2395 = this._window.width - _loc3_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2393;
         this._window.width = _loc1_.width + this.var_2395;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_500.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_355 == HabboHelpViewEnum.const_214)
         {
            return;
         }
         if(this.var_621.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_621.push(_loc3_.content as BitmapData);
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_621[1],this.var_621[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_621[0],this.var_621[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_355 == HabboHelpViewEnum.const_214 || this.var_500.length == 0)
         {
            return;
         }
         if(this.var_356 == null)
