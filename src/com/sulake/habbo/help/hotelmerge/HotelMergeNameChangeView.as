package com.sulake.habbo.help.hotelmerge
{
   ...
   public class HotelMergeNameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_818)
         {
            this.var_818 = this.createWindow("hotel_merge_name_selection_xml") as IWindowContainer;
            if(!this.var_818)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_819)
         {
            this.var_819 = this.createWindow("hotel_merge_name_confirmation_xml") as IWindowContainer;
            if(!this.var_819)
            {
               return;
            }
