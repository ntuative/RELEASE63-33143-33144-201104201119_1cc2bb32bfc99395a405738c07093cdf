package com.sulake.habbo.help.cfh.data
{
   ...
   public class UserRegistry
   {
      ...
      private static const const_1405:int = 80;
      ...
      {
         var _loc4_:* = null;
         if(this.var_526.getValue(param1) != null)
         {
            this.var_526.remove(param1);
         }
         if(param3)
         {
         ...
         this.var_526.add(param1,_loc4_);
         this.purgeUserIndex();
      }
      ...
      {
         var _loc1_:int = 0;
         while(this.var_526.length > const_1405)
         {
            _loc1_ = this.var_526.getKey(0);
            this.var_526.remove(_loc1_);
         }
      }
      ...
      private function addRoomNameForMissing() : void
      {
         ...
         {
            _loc1_ = this.var_526.getValue(this.var_1501.shift());
            if(_loc1_ != null)
            {
