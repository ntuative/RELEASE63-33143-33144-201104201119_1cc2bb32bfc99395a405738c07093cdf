package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private static var var_1535:uint = 13232628;
      
      private static var var_1965:uint = 11129827;
      ...
      private var var_1248:NameSuggestionListRenderer;
      ...
      private function showView(param1:IWindowContainer) : void
      {
         ...
         if(this._window)
         {
            this._window.content.width = this.var_46.width;
            this._window.content.height = this.var_46.height;
         }
      }
      ...
      public function showMainView() : void
      {
         if(!this._window)
         {
            ...
            this.var_1967 = this._window.content.getChildAt(0) as IWindowContainer;
         }
      ...
      private function showSelectionView() : void
      {
         if(!this.var_818)
         {
            this.var_818 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_818)
            {
               return;
            }
            this._window.content.addChild(this.var_818);
         }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_819)
         {
            this.var_819 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_819)
            {
               return;
            }
            this._window.content.addChild(this.var_819);
         }
         this._window.caption = this._controller.localization.getKey("tutorial.name_change.title.confirm");
         var _loc1_:ITextWindow = this.var_819.findChildByName("final_name") as ITextWindow;
         if(_loc1_)
         {
            _loc1_.text = this.var_533;
         }
         this.showView(this.var_819);
      }
      ...
      public function setNameAvailableView() : void
      {
         ...
         this._controller.localization.registerParameter("help.tutorial.name.available","name",this.var_533);
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_869:
         ...
         if(param1 == ChangeUserNameResultMessageEvent.var_1069 || param1 == ChangeUserNameResultMessageEvent.var_1066)
         {
            _loc5_.visible = false;
            return;
         }
         _loc5_.visible = true;
         this.var_1248 = new NameSuggestionListRenderer(this._controller);
         var _loc6_:int = this.var_1248.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1535;
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(!this.var_1536)
         {
            if(param1.type == WindowEvent.const_101)
            {
         ...
         switch(param2.name)
         {
            ...
            case "keep_name_button":
               this.var_533 = this._controller.myName;
               this.showConfirmationView();
               break;
            ...
            case "confirm_name_button":
               this._controller.changeName(this.var_533);
               break;
