package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialClothesChangeView implements ITutorialUIView
   {
      ...
      public function TutorialClothesChangeView(param1:IItemListWindow, param2:TutorialUI)
      {
         ...
         this.var_36.help.toolbar.events.addEventListener(HabboToolbarShowMenuEvent.const_59,this.onShowMenuEvent);
      ...
      {
         return TutorialUI.const_372;
      }
      
      public function dispose() : void
      {
         this.setToolbarIconHighlight(false);
         this.var_36.help.toolbar.events.removeEventListener(HabboToolbarShowMenuEvent.const_59,this.onShowMenuEvent);
      }
      ...
      private function onShowMenuEvent(param1:HabboToolbarShowMenuEvent) : void
      {
         if(param1.menuId == HabboToolbarIconEnum.MEMENU && param1.type == HabboToolbarShowMenuEvent.const_59)
         {
            ...
            this.var_36.help.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_586));
         }
      }
      ...
      public function setToolbarIconHighlight(param1:Boolean) : void
      {
         ...
         this.var_36.help.toolbar.events.dispatchEvent(_loc2_);
      }
      ...
      private function showToolbarIconHighlightArrow() : void
      {
         ...
         this.var_728 = this.var_36.buildXmlWindow("tutorial_arrow") as IWindowContainer;
         var _loc1_:IBitmapWrapperWindow = this.var_728.findChildByName("arrow") as IBitmapWrapperWindow;
         if(_loc1_ != null)
         {
            _loc2_ = BitmapDataAsset(this.var_36.assets.getAssetByName("tutorial_highlight_blue_arrow"));
            _loc1_.bitmap = (_loc2_.content as BitmapData).clone();
         }
         this.var_36.help.toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_59,HabboToolbarIconEnum.MEMENU_ARROW,this.var_728));
      }
