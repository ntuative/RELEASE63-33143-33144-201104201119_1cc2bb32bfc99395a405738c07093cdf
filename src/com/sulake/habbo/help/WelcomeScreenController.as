package com.sulake.habbo.help
{
   ...
   public class WelcomeScreenController implements IUpdateReceiver
   {
      ...
      private var var_203:Point;
      
      private var var_821:Timer;
      ...
      {
         return this._notifications[this.var_1538];
      }
      ...
      public function dispose() : void
      {
         if(this.var_143)
         {
            ...
            this.var_143.toolbar.events.removeEventListener(HabboToolbarEvent.const_745,this.onToolbarResized);
            this.var_143 = null;
         }
         ...
         {
            this.var_821.stop();
            this.var_821.removeEventListener(TimerEvent.TIMER,this.onReminderTimer);
            this.var_821 = null;
         }
      ...
      public function showWelcomeScreen(param1:Boolean) : void
      {
         ...
         this.var_143.toolbar.events.addEventListener(HabboToolbarEvent.const_745,this.onToolbarResized);
         var _loc4_:int = parseInt(this._config.getKey("welcome.screen.delay","5000"));
         this.var_821 = new Timer(_loc4_);
         this.var_821.addEventListener(TimerEvent.TIMER,this.onReminderTimer);
         this.var_821.start();
      }
      ...
      public function onReminderTimer(param1:TimerEvent) : void
      {
         ...
         this.var_203.y = this.var_143.toolbar.getIconLocation(this.current.targetIconId) - this._window.height / 2;
         this._window.y = this.var_203.y;
      ...
      private function initializeWindow() : void
      {
         ...
         _loc4_.content.setParamFlag(WindowParam.const_344,false);
         _loc4_.height -= 20;
      ...
      {
         var _loc2_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_100,this.current.targetIconId);
      ...
      private function closeWindow() : void
      {
         ...
         if(this.var_1538 < this._notifications.length - 1)
         {
            ++this.var_1538;
         }
         else
      ...
      public function update(param1:uint) : void
      {
         ...
         var _loc2_:Number = Point.distance(this._window.rectangle.topLeft,this.var_203);
         if(_loc2_ > 5)
         {
            _loc3_ = Point.interpolate(this._window.rectangle.topLeft,this.var_203,0.5);
            this._window.x = _loc3_.x;
            this._window.y = _loc3_.y;
         }
         else
         {
            this._window.x = this.var_203.x;
            this._window.y = this.var_203.y;
            this.var_143.removeUpdateReceiver(this);
         }
      }
