package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private const const_2088:int = 10;
      ...
      private const const_1809:uint = 4.293848814E9;
      
      private const const_1810:uint = 4.294967295E9;
      
      private const const_2089:uint = 4.291613146E9;
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1747 = _loc1_.stuffTypes;
            this.var_740 = _loc1_.boxTypes;
            this.var_741 = _loc1_.ribbonTypes;
            this.var_1145 = this.var_1747[0];
            this.var_350 = this.var_740[0];
            this.var_351 = this.var_741[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_351 < 0)
         {
            this.var_351 = this.var_741.length - 1;
         }
         if(this.var_351 > this.var_741.length - 1)
         {
            this.var_351 = 0;
         }
         if(this.var_350 < 0)
         {
            this.var_350 = this.var_740.length - 1;
         }
         if(this.var_350 > this.var_740.length - 1)
         {
            this.var_350 = 0;
         }
         var _loc1_:int = this.var_740[this.var_350] * 1000 + this.var_741[this.var_351];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_94.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1145,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1422 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1747;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_77);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1145);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_740[this.var_350]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_741[this.var_351]);
         this._catalog.purchaseProductAsGift(this.var_1423,this.var_94,this.var_1421,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this.var_1423,this.var_94.offerId,this.var_1421);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_101:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(this.var_2314 == _loc3_.text)
               {
                  return;
               }
               ...
               for each(_loc7_ in this.var_227)
               {
                  ...
                  if(_loc5_.length >= this.const_2088)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2314 = _loc3_.text;
               break;
            case WindowMouseEvent.const_42:
               ...
               break;
            case WindowKeyboardEvent.const_339:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_349 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_349 + 1);
                     break;
      ...
      {
         if(this.var_254 == null || !this.var_254.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_254.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_349) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_254 == null)
         {
            this.var_254 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_613 == null)
         {
            this.var_613 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_613.procedure = this.suggestionsEventHandler;
         }
         if(this.var_254 == null || this.var_613 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_254.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_613.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_349) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_349);
         }
         this.var_349 = param1;
         if(this.var_349 < 0)
         {
            this.var_349 = _loc2_.numListItems - 1;
         }
         if(this.var_349 >= _loc2_.numListItems)
         {
            this.var_349 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_349) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_2089;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1809) : uint(this.const_1810);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_254.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1145;
               }
            }
            _loc4_++;
         }
