package com.sulake.habbo.catalog.recycler
{
   ...
   public class PrizeViewer implements IGetImageListener
   {
      ...
      {
         var _loc8_:* = null;
         this.var_293 = param2.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         switch(param3)
         {
      ...
      {
         var _loc3_:* = null;
         if(this.var_293 != null && !this.var_293.disposed)
         {
            if(param1 == null)
            {
            ...
            this.var_293.bitmap = new BitmapData(this.var_293.width,this.var_293.height,true,16777215);
            this.var_293.bitmap.fillRect(this.var_293.bitmap.rect,16777215);
            _loc3_ = new Point((this.var_293.width - param1.width) / 2,(this.var_293.height - param1.height) / 2);
            this.var_293.bitmap.copyPixels(param1,param1.rect,_loc3_,null,null,true);
         }
