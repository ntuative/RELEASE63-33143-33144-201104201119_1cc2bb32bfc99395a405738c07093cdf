package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_983:int = 0;
      ...
      {
         return this.var_601 != const_983;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1683 != RecyclerStatusMessageEvent.const_1216;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_601 == const_438;
      }
      ...
      {
         this.var_601 = const_984;
         this.var_114 = new Array(const_213);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1683)
         {
            case RecyclerStatusMessageEvent.const_1570:
               this.var_601 = const_438;
               ...
               this.updateRecyclerButton();
               break;
            case RecyclerStatusMessageEvent.const_1216:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1786:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1270:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1704:
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         if(this.var_114.length > 0)
         {
            oldObjectData = this.var_114[0];
            newSlotId = 0;
            while(oldObjectData != null && newSlotId < const_213)
            {
               oldObjectData = this.var_114[newSlotId];
         ...
         this.var_114[slotId] = new FurniSlotItem(itemId,category,typeId,xxxExtra);
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(this.var_114[param1] == null)
         {
            return;
         }
         if(!this._catalog.returnInventoryFurniFromRecycler(this.var_114[param1].id))
         {
            return;
         }
         this.var_114[param1] = null;
         this.updateRecyclerSlots();
         this.updateRecyclerButton();
      }
      ...
      public function executeRecycler() : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_114.length)
         {
            _loc3_ = this.var_114[_loc2_];
            if(_loc3_ == null)
            {
               return;
            }
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_114.length < const_213)
         {
            return false;
         }
         var _loc1_:int = 0;
