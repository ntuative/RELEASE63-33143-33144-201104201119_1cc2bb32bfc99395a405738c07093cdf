package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class NewPetsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1396:int = 18;
      ...
      private var var_208:Array = null;
      ...
      override public function init() : Boolean
      {
         ...
         _loc1_.addEventListener(WindowEvent.const_101,this.onTextWindowEvent);
         ...
         this.var_523 = this.getPetTypeIndexFromProduct(_loc2_.localizationId);
         if(this.var_523 < 8)
         {
            return false;
         }
         this.var_2447 = _loc2_.localizationId;
         this.updateAvailableBreeds(_loc2_.localizationId);
         if(this.var_208 != null && this.var_208.length > 0)
         {
            this.var_364 = this.var_208[0];
         }
         else
         {
            this.var_364 = -1;
         }
         this._offers.add(this.var_523,_loc2_);
      ...
      private function initializeBreedSelection() : void
      {
         ...
         if(this.var_208 != null)
         {
            _loc1_ = [];
            _loc2_ = 0;
            while(_loc2_ < const_1396 && _loc2_ < this.var_208.length)
            {
               _loc3_ = (page.viewer.catalog as HabboCatalog).roomEngine.getPetColor(this.var_523,this.var_208[_loc2_]);
               if(_loc3_ != null)
               {
      ...
      private function selectedBreed(param1:int) : void
      {
         if(this.var_208 != null && this.var_208.length > 0)
         {
            if(param1 < 0 || param1 > this.var_208.length)
            {
               param1 = 0;
            }
            this.var_364 = this.var_208[param1];
            this.updateImage();
         }
      }
      ...
      private function getPetLocalization() : String
      {
         ...
         if(page != null && false)
         {
            ...
            {
               return _loc1_.localization.getKey(this.getRaceLocalizationKey(this.var_523,this.var_364),this.getRaceLocalizationKey(this.var_523,this.var_364));
            }
         }
         return this.getRaceLocalizationKey(this.var_523,this.var_364);
      }
      ...
      private function updateImage() : void
      {
         ...
         if(_loc1_ == null || this.var_364 < 0)
         {
            return;
         }
         var _loc2_:int = this.var_523;
         var _loc3_:int = this.var_364;
      ...
      private function getPurchaseParameters() : String
      {
         ...
         var p:String = this._name + String.fromCharCode(10) + this.var_364 + String.fromCharCode(10) + this.addZeroPadding(color.toString(16).toUpperCase(),6);
         return p;
      }
