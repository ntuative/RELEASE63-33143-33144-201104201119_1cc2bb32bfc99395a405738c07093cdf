package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesNewCatalogWidget extends ItemGridCatalogWidget implements IDisposable, ICatalogWidget, IItemGrid
   {
      ...
      private var var_448:ISelectorWindow;
      ...
      public function SpacesNewCatalogWidget(param1:IWindowContainer)
      {
         ...
         super(param1);
         this.var_448 = _window.findChildByName("groups") as ISelectorWindow;
         if(this.var_448)
         {
            _loc2_ = 0;
            while(_loc2_ < this.var_448.numSelectables)
            {
               _loc3_ = this.var_448.getSelectableAt(_loc2_);
      ...
      override public function init() : Boolean
      {
         ...
         this.switchCategory(this.var_103[this.var_502]);
      ...
      {
         var _loc2_:int = this.var_760[this.var_502];
         var _loc3_:Offer = this.var_207[this.var_502][_loc2_];
      ...
      {
         var _loc2_:* = null;
         if(param1 > -1 && param1 < var_574.numGridItems)
         {
            _loc2_ = this.var_207[this.var_502][param1];
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         this.var_760[this.var_502] = (this.var_207[this.var_502] as Array).indexOf(_loc2_);
         this.updateRoomPreview();
      }
      
      private function updateRoomPreview() : void
      {
         var _loc1_:int = this.var_760[0];
         var _loc2_:int = this.var_760[1];
         var _loc3_:int = this.var_760[2];
      ...
      private function createOfferGroups() : Boolean
      {
         ...
         {
            if(!(_loc1_.pricingModel == Offer.const_365 || _loc1_.pricingModel == Offer.const_399))
            {
               continue;
            }
            ...
            if(!(_loc2_.productType == ProductTypeEnum.const_65 || _loc2_.productType == ProductTypeEnum.const_77))
            {
               continue;
            }
      ...
      private function onSelectGroup(param1:WindowEvent) : void
      {
         ...
         if(_loc2_)
         {
            _loc3_ = this.var_448.getSelectableIndex(_loc2_);
      ...
      private function switchCategory(param1:String) : void
      {
         ...
         if(_loc2_ > -1)
         {
            ...
            if(var_574)
            {
               var_574.destroyGridItems();
            }
            page.replaceOffers(this.var_207[this.var_502],false);
            resetTimer();
            populateItemGrid();
            ...
            _loc3_ = this.var_760[this.var_502];
