package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_1588:String = "default";
      ...
      private var var_1590:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               switch(_loc4_.furnitureData.name)
               {
                  case "floor":
                     ...
                     {
                        this.var_1056.push(String(_loc9_.@id));
                        this.var_1587.push(_loc2_);
                     }
                     break;
                  case "wallpaper":
                  ...
                  case "landscape":
                     for each(_loc11_ in this.var_184.landscapes.pattern)
                     {
                        ...
                        {
                           this.var_1054.push(_loc7_);
                           _loc8_ = true;
                        }
                     }
                     if(_loc8_)
                     {
                        this.var_1586.push(_loc2_);
                     }
                     else
                     {
            ...
            events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1588,this.var_1590,64));
            return true;
         }
         return false;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1589[this.var_466];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1588);
               }
               break;
            ...
            case "ctlg_floor_color_next":
               ...
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1587[this.var_464];
               if(_loc3_ != null)
               {
            ...
            case "ctlg_buy_landscape":
               _loc3_ = this.var_1586[this.var_465];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1590);
               }
               break;
            default:
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = null;
         var _loc2_:String = this._activeWallpaperPatterns[this.var_466];
         for each(_loc1_ in this.var_184.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(this.var_467 >= 0)
               {
                  _loc9_ = _loc1_.children()[this.var_467];
                  if(_loc9_ != null)
                  {
                     this.var_1588 = _loc9_.@id;
                  }
               }
            }
         }
         ...
         var _loc5_:String = this.var_1056[this.var_464];
         for each(_loc1_ in this.var_184.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[this.var_554];
               if(_loc11_ != null)
               {
         ...
         _loc6_ = this.var_1587[this.var_464];
         if(_loc6_ != null)
         {
         ...
         var _loc7_:String = this.var_1054[this.var_465];
         for each(_loc1_ in this.var_184.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
               _loc13_ = _loc1_.children()[this.var_553];
               if(_loc13_ != null)
               {
                  this.var_1590 = _loc13_.@id;
               }
            }
         }
         _loc8_ = this.var_1586[this.var_465];
         if(_loc8_ != null)
         {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_224:
               ...
               if(this.var_466 < 0)
               {
                  this.var_466 = this._activeWallpaperPatterns.length - 1;
               }
               if(this.var_466 == this._activeWallpaperPatterns.length)
               {
                  this.var_466 = 0;
               }
               this.var_467 = 0;
               this.var_1055 = 0;
               _loc5_ = this._activeWallpaperPatterns[this.var_466];
               for each(_loc8_ in this.var_184.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     this.var_1055 = _loc8_.children().length();
                  }
               }
            ...
            case const_225:
               ...
               if(this.var_464 < 0)
               {
                  this.var_464 = this.var_1056.length - 1;
               }
               if(this.var_464 >= this.var_1056.length)
               {
                  this.var_464 = 0;
               }
               this.var_554 = 0;
               this.var_1053 = 0;
               _loc6_ = this.var_1056[this.var_464];
               for each(_loc9_ in this.var_184.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     this.var_1053 = _loc9_.children().length();
                  }
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_465 < 0)
               {
                  this.var_465 = this.var_1054.length - 1;
               }
               if(this.var_465 >= this.var_1054.length)
               {
                  this.var_465 = 0;
               }
               this.var_553 = 0;
               this.var_1057 = 0;
               _loc7_ = this.var_1054[this.var_465];
               for each(_loc10_ in this.var_184.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
                     this.var_1057 = _loc10_.children().length();
                  }
               }
