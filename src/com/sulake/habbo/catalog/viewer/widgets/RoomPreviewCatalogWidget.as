package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RoomPreviewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IDragAndDropDoneReceiver
   {
      ...
      private var var_358:BitmapData = null;
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25 && this.var_625 != null && this.var_625 == param2)
         {
            if(this.var_94)
            {
               (page.viewer.catalog as HabboCatalog).requestSelectedItemToMover(this,this.var_94);
               this.var_625 = null;
            }
         }
      ...
      private function onUpdateRoomPreview(param1:CatalogWidgetUpdateRoomPreviewEvent) : void
      {
         ...
         {
            this.var_1801 = _loc3_.id;
            this.var_1800 = _loc4_.id;
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(this.var_358 != null && this._imageStoreWindow != null)
         {
            this.setRoomImage(this.var_358,this._imageStoreWindow);
         }
      }
   }
}
