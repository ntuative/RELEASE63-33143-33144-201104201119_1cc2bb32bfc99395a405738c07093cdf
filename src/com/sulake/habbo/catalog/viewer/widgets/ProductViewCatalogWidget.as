package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1353:IScrollbarWindow;
      
      protected var var_1942:XML;
      
      private var var_2159:Array;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_885 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1089 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_85 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1623 = new Point(this.var_85.x,this.var_85.y);
         this.var_481 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1353 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1624 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_885.text = _loc4_;
         this.var_1089.text = _loc5_;
         this.var_885.height = this.var_885.textHeight + 5;
         this.var_1089.y = this.var_885.y + this.var_885.height;
         this.var_1089.height = Math.max(130,this.var_1089.textHeight + 5);
         ...
         else
         {
            ...
            {
               case Offer.const_573:
                  _loc6_ = this.var_1624.clone();
                  if(this.var_481 != null)
                  {
                     this.var_481.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_481,this.var_1353,this.var_1942);
                     ...
                     case ProductTypeEnum.const_185:
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_304,AvatarAction.const_559);
                              _loc16_.appendAction(AvatarAction.const_338,_loc8_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2159)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2159 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_85 != null && true)
         {
            ...
            this.var_85.x = this.var_1623.x;
            this.var_85.y = this.var_1623.y;
            if(param3 != null)
            {
