package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function showPreview(param1:Offer, param2:Rectangle) : void
      {
         ...
         if(!this.var_230)
         {
            this.var_230 = this.createWindow("club_gift_preview") as IWindowContainer;
         }
         if(!this.var_230)
         {
            return;
         }
         var _loc5_:IBitmapWrapperWindow = this.var_230.findChildByName("image") as IBitmapWrapperWindow;
         if(!_loc5_)
         {
            return;
         }
         ...
         this.var_230.setGlobalPosition(_loc6_.subtract(new Point(this.var_230.width / 2,this.var_230.height / 2)));
