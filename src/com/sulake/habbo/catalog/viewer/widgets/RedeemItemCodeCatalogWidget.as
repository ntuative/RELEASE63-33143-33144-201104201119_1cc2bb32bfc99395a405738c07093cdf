package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_911:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_910.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_910 = null;
         }
         if(this.var_911 != null)
         {
            this.var_911.removeEventListener(WindowKeyboardEvent.const_179,this.windowKeyEventProcessor);
            this.var_911 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_910 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_910 != null)
         {
            this.var_910.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_911 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_911 != null)
         {
            this.var_911.addEventListener(WindowKeyboardEvent.const_179,this.windowKeyEventProcessor);
         }
         return true;
      }
