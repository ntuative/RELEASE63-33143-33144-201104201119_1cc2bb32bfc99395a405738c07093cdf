package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1055:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_271:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1055).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1055).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         if(this._view)
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_90,MouseCursorType.const_1174);
         }
      }
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_42)
         {
            ...
            this.var_271.select(this);
            this.var_625 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_625 != null && this.var_625 == param2)
         {
            _loc3_ = this.var_271.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_625 = null;
            }
