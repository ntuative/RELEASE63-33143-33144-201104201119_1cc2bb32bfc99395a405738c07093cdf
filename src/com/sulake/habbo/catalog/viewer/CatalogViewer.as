package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogViewer implements ICatalogViewer
   {
      ...
      private var var_1990:HabboCatalog;
      ...
      public function showCatalogPage(param1:int, param2:String, param3:IPageLocalization, param4:Array, param5:int) : void
      {
         ...
         {
            if(this.var_380.pageId == param1)
            {
               if(param5 > -1)
               {
                  this.var_380.selectOffer(param5);
               }
               return;
            }
            this._container.removeChild(this.var_380.window);
            this.var_380.dispose();
         }
         var _loc6_:ICatalogPage = new CatalogPage(this,param1,param2,param3,param4,this.var_1990);
         this.var_380 = _loc6_;
      ...
      {
         return this.var_380.dispatchWidgetEvent(param1);
      }
      ...
      public function getCurrentLayoutCode() : String
      {
         ...
         return this.var_380.layoutCode;
      }
   }
}
