package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1799:String = "ctlg_";
      ...
      private var var_547:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1273:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_547 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1274);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1274);
      }
      ...
      {
         var _loc2_:String = const_1799 + param1;
         ...
         this.var_1334 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1334) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1686:
               if(this.var_1273 == null)
               {
                  this.var_1273 = new ItemGridCatalogWidget(param1);
                  this.var_39.push(this.var_1273);
               }
               break;
            case CatalogWidgetEnum.const_1757:
               this.var_39.push(new ItemGroupCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1525:
               this.var_39.push(new ProductViewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1741:
            ...
            case CatalogWidgetEnum.const_1557:
               this.var_39.push(new PurchaseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1612:
               this.var_39.push(new PurseCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1661:
               this.var_39.push(new ColourGridCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1607:
               this.var_39.push(new TraxPreviewCatalogWidget(param1,this._catalog.soundManager));
               break;
            case CatalogWidgetEnum.const_1727:
            ...
            case CatalogWidgetEnum.const_1599:
               ...
               break;
            case CatalogWidgetEnum.const_1636:
               this.var_39.push(new SpacesNewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1518:
               this.var_39.push(new RoomPreviewCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1705:
            ...
            case CatalogWidgetEnum.const_1708:
               ...
               break;
            case CatalogWidgetEnum.const_1701:
               this.var_39.push(new NewPetsCatalogWidget(param1));
               break;
            case CatalogWidgetEnum.const_1694:
            ...
            case CatalogWidgetEnum.const_1777:
               ...
               break;
            case CatalogWidgetEnum.const_1598:
               this.var_39.push(new BotCatalogWidget(param1));
               break;
            ...
            case CatalogWidgetEnum.const_1654:
               ...
               break;
            case CatalogWidgetEnum.const_1655:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_547.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_547 != null)
         {
            return this.var_547.dispatchEvent(param1);
         }
         return false;
      }
