package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener
   {
      ...
      private static const const_655:uint = 1;
      ...
      private var var_367:ICatalogNavigator;
      ...
      private var var_309:ChargeConfirmationDialog;
      ...
      private var var_2634:Boolean = true;
      
      private var var_2633:Boolean = true;
      
      private var var_1897:Boolean = false;
      
      private var var_2632:GiftWrappingConfiguration;
      
      private var var_1221:ClubGiftController;
      
      private var var_525:ClubBuyController;
      
      private var var_792:Map;
      
      private var var_1220:Boolean = false;
      
      private var var_987:IPurchasableOffer;
      
      private var var_1498:IDragAndDropDoneReceiver;
      
      private var var_87:PlacedObjectPurchaseData;
      
      private const const_971:Point = new Point(100,20);
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_16 != null)
         {
            ...
            this.var_16.events.removeEventListener(RoomSessionEvent.const_92,this.onRoomSessionEvent);
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         if(param1.priceInCredits > 0 && param1.priceInCredits > this.var_109.credits)
         {
            this.showNotEnoughCreditsAlert();
            return;
         }
         if(param1.priceInActivityPoints > 0 && param1.priceInActivityPoints > this.var_109.getActivityPointsForType(param1.activityPointType))
         {
         ...
         {
            this.var_525.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      public function openCatalogPageById(param1:int, param2:int) : void
      {
         ...
         {
            this.toggleCatalog(true);
            this.var_367.openPageById(param1,param2);
         }
         else
         {
            this.toggleCatalog();
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_184.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_184.getKey("link.format.credits","/credits");
      ...
      {
         return this.var_440.getProductData(param1);
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = this.var_440.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_65)
         {
            _loc3_ = this.var_440.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Array = this.var_792.getValue(param1);
         if(_loc2_ != null)
         {
            return _loc2_.slice();
         }
      ...
      private function updatePurse() : void
      {
         ...
         this._localization.registerParameter("catalog.purse.creditbalance","balance",String(this.var_109.credits));
         this._localization.registerParameter("catalog.purse.pixelbalance","balance",String(this.var_109.getActivityPointsForType(Purse.const_212)));
         var _loc1_:int = 0;
         if(!this.var_109.hasClubLeft)
         {
         ...
         else
         {
            ...
            this._localization.registerParameter(_loc2_,"days",String(this.var_109.clubDays));
            this._localization.registerParameter(_loc2_,"months",String(this.var_109.clubPeriods));
         }
      ...
      {
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(!this.var_729)
         {
            if(!this.var_440.loadProductData(this))
            {
               return;
            }
            this.init();
         ...
         if(this.mainWindowVisible())
         {
            ...
            if(this.var_95 != null && this.getCurrentLayoutCode() == "recycler")
            {
               this.var_95.activate();
            }
         }
         else
         {
         ...
         this.setupInventoryForRecycler(this.var_95.active && this.mainWindowVisible());
      }
      ...
      private function createCatalogNavigator() : void
      {
         ...
         this.var_367 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function createMainWindow() : void
      {
         ...
         this._mainContainer = this._windowManager.buildFromXML(_loc1_.content as XML,const_655) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_971;
         this.hideMainWindow();
         ...
         _loc3_.setParamFlag(WindowParam.const_274,false);
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_86:
               this.var_1897 = param1.session.isPrivateRoom;
               this.var_1112 = param1.session;
               if(this.var_95 != null)
               {
                  this.var_95.setRoomSessionActive(true);
               }
               break;
            case RoomSessionEvent.const_92:
               ...
               if(this.var_95 != null)
               {
                  this.var_95.setRoomSessionActive(false);
               }
         }
      }
      ...
      {
         this.var_95 = new RecyclerLogic(this,this._windowManager);
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1221 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_525 == null)
         {
            this.var_525 = new ClubBuyController(this);
         }
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_367.buildCatalogIndex(_loc2_);
         if(this.var_793 && this.var_793 != "")
         {
            this.var_367.openPage(this.var_793);
            this.var_793 = "";
            this.var_986 = -1;
         }
         else if(this.var_986 > -1)
         {
            this.var_367.openPageById(this.var_986,this.var_1898);
            this.var_986 = -1;
            this.var_1898 = -1;
            this.var_793 = "";
         }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.var_109.credits = _loc3_.balance;
         this.updatePurse();
         if(!this.var_2634 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1185);
         }
         this.var_2634 = false;
         if(this.var_309 != null)
         {
            this.var_309.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_75,this.var_109.credits));
      }
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.var_109.activityPoints[_loc2_.type] = _loc2_.amount;
         this.updatePurse();
         if(!this.var_2633 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1251);
         }
         this.var_2633 = false;
         if(this.var_309 != null)
         {
         ...
         if(_loc2_.type == Purse.const_212)
         {
      ...
      private function onActivityPoints(param1:IMessageEvent) : void
      {
         ...
         this.var_109.activityPoints = _loc2_.points;
         this.updatePurse();
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_109.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         this.var_109.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         this.var_109.method_1 = _loc2_.method_1;
         this.var_109.pastClubDays = _loc2_.pastClubDays;
         this.var_109.pastVipDays = _loc2_.pastVipDays;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1221.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onRecyclerStatus(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_95 == null)
         {
            return;
         }
         this.var_95.setSystemStatus(_loc2_.recyclerStatus,_loc2_.recyclerTimeoutSeconds);
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         this.var_95.setFinished(_loc2_.recyclerFinishedStatus,_loc2_.prizeId);
      }
      ...
      private function onRecyclerPrizes(param1:IMessageEvent) : void
      {
         ...
         this.var_95.storePrizeTable(_loc2_.prizeLevels);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2632 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_309 == null)
         {
            this.var_309 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_309.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         this.var_792.remove(_loc2_.productCode);
         var _loc3_:Array = _loc2_.sellableBreeds;
         if(_loc3_ != null)
         {
            this.var_792.add(_loc2_.productCode,_loc3_.slice());
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "true" == this.var_184.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_184.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_164)
         {
            _loc3_ = this.var_184.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_184.keyExists("catalog.drag_and_drop") || this.var_184.getKey("catalog.drag_and_drop") != "true")
         {
            return false;
         }
         if(!this.var_1112 || !this.var_1112.isRoomOwner)
         {
            return false;
         }
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         if(this.var_1220 && param1.type == RoomEngineObjectEvent.const_171)
         {
            this.resetPlacedOfferData();
            ...
            if(_loc5_)
            {
               _loc5_.getModelController().setNumber(RoomObjectVariableEnum.const_292,0.5);
            }
         }
      }
      ...
      public function resetPlacedOfferData() : void
      {
         if(this.var_87 != null)
         {
            if(this.var_87.category == RoomObjectCategoryEnum.const_27)
            {
      ...
      private function onItemAddedToInventory(param1:HabboInventoryItemAddedEvent) : void
      {
         ...
         if(this.var_87 && this.var_87.productClassId == param1.classId)
         {
            if(this.var_87.roomCategory == this._roomEngine.activeRoomCategory && this.var_87.roomId == this._roomEngine.activeRoomId)
            {
               ...
               if(param1.category == FurniCategory.const_315 || param1.category == FurniCategory.const_290 || param1.category == FurniCategory.const_322)
               {
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_184.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_655);
            if(_loc1_ != null)
            {
