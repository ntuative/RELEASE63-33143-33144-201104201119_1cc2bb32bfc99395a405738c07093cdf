package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1011:uint = 11;
      ...
      private var var_39:IRoomWidgetFactory;
      ...
      private var var_1175:IHabboWindowManager;
      ...
      private var var_258:PerformanceTracker = null;
      
      private var var_430:FramerateTracker = null;
      
      private var var_259:LatencyTracker = null;
      
      private var var_631:LagWarningLogger = null;
      
      private var var_632:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_258 = new PerformanceTracker();
         this.var_430 = new FramerateTracker();
         this.var_259 = new LatencyTracker();
         this.var_631 = new LagWarningLogger();
         this.var_632 = new ToolbarClickTracker(this);
         this.var_1453 = new Array(const_1011);
         var _loc4_:int = 0;
         while(_loc4_ < const_1011)
         {
            this.var_1453[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1755,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1567,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1728,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_693,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1059,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1175)
            {
               this.var_1175.release(new IIDHabboWindowManager());
               this.var_1175 = null;
            }
            if(this.var_312)
            {
            ...
            if(this.var_39)
            {
               this.var_39.release(new IIDHabboRoomWidget());
               this.var_39 = null;
            }
            if(this._navigator)
            {
            ...
            if(this.var_210)
            {
               if(!this.var_210.disposed)
               {
                  ...
                  Component(this.var_210).events.removeEventListener(HabboFriendListTrackingEvent.const_430,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomObjectRoomAdEvent.const_192,this.onRoomAdClick);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_321,this.onRoomAction);
            ...
            {
               this.var_303.stop();
               this.var_303.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
               this.var_303 = null;
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this.var_184)
         {
            if(this.var_259 != null)
            {
               this.var_259.configuration = this.var_184;
            }
            if(this.var_258 != null)
            {
               this.var_258.configuration = this.var_184;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1645);
            if(this.var_184)
            {
               if(this.var_631 != null)
               {
                  this.var_631.configure(this.var_184);
               }
               if(this.var_430 != null)
               {
                  this.var_430.configure(this.var_184);
               }
               if(this.var_632 != null)
               {
                  this.var_632.configure(this.var_184);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_939,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_249,this.onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_258,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_933,this.onHotelViewEvent);
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_258 != null)
            {
               this.var_258.connection = param1;
            }
            if(this.var_259 != null)
            {
               this.var_259.communication = this._communication;
               this.var_259.connection = param1;
            }
            if(this.var_631 != null)
            {
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_933)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1558);
         }
         else if(param1.type == HabboHotelViewEvent.const_517)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1614);
         }
         else if(param1.type == HabboHotelViewEvent.const_66)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1613);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1564);
               break;
            case HabboCommunicationEvent.const_939:
               this.trackLoginStep(HabboLoginTrackingStep.const_1774,String(this._communication.port));
               break;
            case HabboCommunicationEvent.const_249:
               this.trackLoginStep(HabboLoginTrackingStep.const_249);
               break;
            ...
            case HabboCommunicationEvent.const_203:
               ...
               break;
            case HabboCommunicationEvent.const_258:
               this.setErrorContextFlag(3,0);
               this.trackLoginStep(HabboLoginTrackingStep.const_258);
               if(this.var_259 != null)
               {
                  this.var_259.init();
               }
      ...
      {
         this.var_1175 = IHabboWindowManager(param2);
         if(this.var_1175)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_184)
            {
               if(this.var_184.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1453)
                  {
                  ...
                  if(this.var_258 != null)
                  {
                     _loc4_["null"] = this.var_258.flashVersion;
                     _loc4_["null"] = this.var_258.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1137);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1137,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_210).events.addEventListener(HabboFriendListTrackingEvent.const_430,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_430:
      ...
      {
         this.var_39 = param2 as IRoomWidgetFactory;
         Component(this.var_39).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_CLOSE,this.onWidgetTrackingEvent);
         Component(this.var_39).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DEFAULT,this.onWidgetTrackingEvent);
         Component(this.var_39).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_DANCE,this.onWidgetTrackingEvent);
         Component(this.var_39).events.addEventListener(HabboMeMenuTrackingEvent.HABBO_MEMENU_TRACKING_EVENT_EFFECTS,this.onWidgetTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2467)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1733);
            this.var_2467 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1059,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_693,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_192,this.onRoomAdClick);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_321,this.onRoomAction);
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_312.events.addEventListener(AdEvent.const_533,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_321)
         {
            if(this.var_1817 < 1)
            {
               if(!this.var_303)
               {
                  this.var_303 = new Timer(60000,1);
                  this.var_303.addEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
                  this.var_303.start();
               }
            }
         }
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_430)
               {
                  ...
                  this._connection.send(new ConversionPointMessageComposer("Performance","fps",String(this.var_430.frameRate),_loc2_));
                  ++this.var_1817;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_632)
         {
            this.var_632.track(param1.iconName);
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_504 > -1 && _loc2_ < this.var_504)
         {
            ++this.var_1815;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1815);
         }
         if(this.var_504 > -1 && _loc2_ - this.var_504 > 15000)
         {
            ++this.var_1816;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1816);
         }
         this.var_504 = _loc2_;
         if(this.var_258 != null)
         {
            this.var_258.update(param1,this.var_504);
         }
         if(this.var_259 != null)
         {
            this.var_259.update(param1,this.var_504);
         }
         if(this.var_430 != null)
         {
            this.var_430.trackUpdate(param1,this,this.var_504);
         }
         if(this.var_631 != null)
         {
            this.var_631.update(this.var_504);
         }
      }
   }
}
