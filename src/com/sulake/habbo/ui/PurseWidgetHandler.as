package com.sulake.habbo.ui
{
   ...
   public class PurseWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            this._container.catalog.events.removeEventListener(PurseEvent.const_75,this.purseEventHandler);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         ...
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_75,this.purseEventHandler);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetGetPurseData.const_762);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetGetPurseData.const_762:
               _loc2_ = this._container.catalog.getPurse();
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_75,_loc2_.credits));
               this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_106,_loc2_.getActivityPointsForType(Purse.const_212)));
               break;
            case RoomWidgetOpenCatalogMessage.const_364:
               ...
               if(this._container.catalog != null)
               {
                  ...
                  {
                     case RoomWidgetOpenCatalogMessage.const_1104:
                        this._container.catalog.openCatalogPage(CatalogPageName.const_1623);
                        break;
                     case RoomWidgetOpenCatalogMessage.const_1070:
      ...
      private function purseEventHandler(param1:PurseEvent) : void
      {
         ...
         switch(param1.type)
         {
            case PurseEvent.const_75:
               _loc2_ = new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_75,param1.balance);
               break;
