package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      private static const const_1355:String = "poster";
      ...
      {
         return RoomWidgetEnum.const_604;
      }
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_737,RoomWidgetPresentOpenMessage.const_177];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_737:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = _loc5_.getNumber(RoomObjectVariableEnum.const_331);
                     _loc8_ = _loc5_.getString(RoomObjectVariableEnum.const_299);
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_177:
               _loc4_ = param1 as RoomWidgetPresentOpenMessage;
               if(_loc4_.objectId != this.var_369)
               {
                  return null;
               }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_65:
                           if(_loc3_ != null && _loc3_.name == const_225)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_456,0,this._container.localization.getKey("inventory.furni.item.floor.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == TYPE_LANDSCAPE)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_460,0,this._container.localization.getKey("inventory.furni.item.landscape.name"),false,null);
                           }
                           else if(_loc3_ != null && _loc3_.name == const_224)
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_545,0,this._container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                              if(_loc3_ != null && _loc3_.name == const_1355)
                              {
                                 break;
                              }
                        ...
                        case ProductTypeEnum.const_332:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_549,0,this._container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
