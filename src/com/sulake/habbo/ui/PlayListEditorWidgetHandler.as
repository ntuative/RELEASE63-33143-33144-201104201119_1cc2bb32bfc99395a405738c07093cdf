package com.sulake.habbo.ui
{
   ...
   public class PlayListEditorWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_1533:IMessageEvent;
      
      private var var_1959:IMessageEvent;
      
      private var var_1958:IMessageEvent;
      ...
      {
         this.var_1533 = new FurniListUpdateEvent(this.onFurniListUpdated);
         this.var_1959 = new FurniListRemoveEvent(this.onFurniListUpdated);
         this.var_1958 = new FurniListInsertEvent(this.onFurniListUpdated);
         this._connection = param1;
         this._connection.addMessageEvent(this.var_1533);
         this._connection.addMessageEvent(this.var_1959);
         this._connection.addMessageEvent(this.var_1958);
      }
      ...
      public function dispose() : void
      {
         ...
         this._connection.removeMessageEvent(this.var_1533);
         this._connection.removeMessageEvent(this.var_1959);
         this._connection.removeMessageEvent(this.var_1958);
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_807,RoomWidgetPlayListModificationMessage.const_817,RoomWidgetPlayListModificationMessage.const_681,RoomWidgetPlayListPlayStateMessage.const_761,RoomWidgetPlayListUserActionMessage.const_683];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_807:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc7_)
                  {
                     _loc8_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_855,_loc2_.id);
                     this._container.events.dispatchEvent(_loc8_);
                  }
               }
               break;
            case RoomWidgetPlayListModificationMessage.const_817:
               ...
               break;
            case RoomWidgetPlayListModificationMessage.const_681:
               ...
               break;
            case RoomWidgetPlayListPlayStateMessage.const_761:
               ...
               break;
            case RoomWidgetPlayListUserActionMessage.const_683:
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineSoundMachineEvent.const_279:
               ...
               _loc3_ = new RoomWidgetPlayListEditorEvent(RoomWidgetPlayListEditorEvent.const_940,_loc2_.objectId);
