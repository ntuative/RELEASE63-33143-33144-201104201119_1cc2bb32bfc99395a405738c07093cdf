package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private static const const_1417:int = 1000;
      ...
      private var var_1236:IRoomWidgetFactory = null;
      
      private var var_440:ISessionDataManager = null;
      
      private var var_16:IRoomSessionManager = null;
      
      private var var_541:IAvatarRenderManager = null;
      ...
      private var var_1197:IHabboHelp = null;
      ...
      private var var_234:IToolTipWindow;
      
      private var var_2693:uint = 16777215;
      ...
      private var var_1934:Rectangle;
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         {
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_361,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_590,this.onRoomContentLoaded);
            this._roomEngine.events.addEventListener(RoomContentLoadedEvent.const_871,this.onRoomContentLoaded);
         }
      }
      ...
      public function set toolbar(param1:IHabboToolbar) : void
      {
         ...
         this._toolbar.events.addEventListener(HabboToolbarEvent.const_457,this.onToolbarRepositionEvent);
      ...
      public function set layout(param1:XML) : void
      {
         ...
         {
            this.var_213.toolbarSize = this._toolbar.size;
            this.var_213.toolbarOrientation = this._toolbar.orientation;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < this.var_805.length)
            {
               _loc6_ = this.var_805.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc6_ != null)
               {
                  _loc6_.dispose();
               }
         ...
         if(this._roomEngine != null && this._roomEngine.events != null)
         {
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_361,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_590,this.onRoomContentLoaded);
            this._roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_871,this.onRoomContentLoaded);
         }
         ...
         {
            this._toolbar.events.removeEventListener(HabboToolbarEvent.const_457,this.onToolbarRepositionEvent);
         ...
         {
            this.var_505.reset();
            this.var_505.removeEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
            this.var_505 = null;
         }
         this.var_1934 = null;
      }
      ...
      public function init() : void
      {
         if(this._roomEngine != null && this.var_33 != null)
         {
            this.var_804 = this._roomEngine.loadRoomResources(this.var_33.roomResources);
         ...
         if(this.var_312 != null && this.var_33.state == RoomSessionEvent.const_257)
         {
            this.var_1933 = !this.var_312.showInterstitial();
         }
      ...
      {
         if(this.var_804 == null || this.var_804.length == 0)
         {
            return;
         }
         var _loc2_:int = this.var_804.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            this.var_804.splice(_loc2_,1);
         }
         if(this.var_804.length == 0)
         {
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = this.var_1236.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         this.var_213.addWidgetWindow(param1,_loc2_.mainWindow);
         ...
         if(_loc4_ != null)
         {
            ...
            if(!this.var_805.add(param1,_loc4_))
            {
               _loc4_.dispose();
            }
            _loc7_ = null;
            ...
            if(_loc8_ != null)
            {
               ...
               {
                  _loc7_ = this.var_807.getValue(_loc10_);
                  if(_loc7_ == null)
                  {
                     _loc7_ = [];
                     this.var_807.add(_loc10_,_loc7_);
                  }
                  else
                  {
            ...
            if(_loc9_ != null)
            {
               ...
               {
                  _loc7_ = this.var_806.getValue(_loc11_);
                  if(_loc7_ == null)
                  {
                     _loc7_ = [];
                     this.var_806.add(_loc11_,_loc7_);
                  }
                  _loc7_.push(_loc4_);
               }
            }
         ...
         {
            param1 = "null";
            _loc12_ = new RoomWidgetRoomViewUpdateEvent(param1,this.var_213.roomViewRect);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         var _loc2_:Array = this.var_807.getValue(param1.type);
         if(_loc2_ != null)
         {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         var _loc2_:Array = this.var_806.getValue(param1.type);
         if(_loc2_ != null)
         {
            for each(_loc3_ in _loc2_)
            {
      ...
      private function isFurnitureSelectionDisabled(param1:RoomEngineObjectEvent) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(_loc4_.getNumber(RoomObjectVariableEnum.const_1176) == 1)
               {
                  _loc2_ = true;
                  if(this.var_440.isAnyRoomController)
                  {
                     _loc2_ = false;
                  }
               }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_837:
               if(!this.isFurnitureSelectionDisabled(param1))
               {
                  _loc4_ = new RoomWidgetRoomObjectUpdateEvent(RoomWidgetRoomObjectUpdateEvent.const_264,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               }
               if(this.var_1006 != null && _loc3_ == RoomObjectCategoryEnum.const_34)
               {
                  _loc7_ = this.var_33.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_202)
                  {
                     this.var_1006.userSelected(_loc7_.webID,_loc7_.name);
                  }
               }
               break;
            ...
            case RoomEngineObjectEvent.const_458:
               ...
               break;
            case RoomEngineObjectEvent.const_851:
               if(!this.var_33.isRoomController && !this.var_440.isAnyRoomController)
               {
                  return;
               }
            ...
            case RoomEngineObjectEvent.ROOM_OBJECT_WIDGET_REQUEST_CREDITFURNI:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_861,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
            ...
            case RoomEngineObjectEvent.const_134:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_1097,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               this.processWidgetMessage(_loc5_);
               break;
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         if(_loc7_ != null)
         {
            _loc13_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_878);
            _loc14_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_680);
            _loc15_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_712);
            _loc16_ = this._roomEngine.getRoomNumberValue(this.var_33.roomId,this.var_33.roomCategory,RoomVariableEnum.const_905);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(this.var_2693);
      ...
      public function canvasMouseHandler(param1:WindowEvent) : void
      {
         ...
         if(_loc3_ == MouseEvent.MOUSE_MOVE && this.var_234 != null)
         {
            _loc8_ = new Point(_loc2_.stageX,_loc2_.stageY);
            _loc8_.offset(-this.var_234.width / 2,15);
            this.var_234.setGlobalPosition(_loc8_);
         }
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         this.var_1934 = _loc2_.rectangle;
         this._roomEngine.modifyRoomCanvas(this.var_33.roomId,this.var_33.roomCategory,this.var_311[0],_loc2_.width,_loc2_.height);
         if(this.var_505 == null)
         {
            this.var_505 = new Timer(const_1417,1);
            this.var_505.addEventListener(TimerEvent.TIMER,this.onResizeTimerEvent);
         }
         else
         {
            this.var_505.reset();
      ...
      private function onResizeTimerEvent(param1:TimerEvent) : void
      {
         ...
         this.events.dispatchEvent(new RoomWidgetRoomViewUpdateEvent(_loc2_,this.var_1934));
      }
      ...
      private function trackZoomTime(param1:Boolean) : void
      {
         ...
         {
            _loc2_ = getTimer();
            _loc3_ = Math.round((_loc2_ - this.var_1932) / 1000);
      ...
      {
         if(this.var_16 != null && this.var_33 != null && this.var_1933 && this._loadingComplete)
         {
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_416);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_580:
               ...
               this.var_234 = this._windowManager.createWindow("room_ad_tooltip",_loc3_,WindowType.const_433,WindowStyle.const_1102,WindowParam.const_99) as IToolTipWindow;
               this.var_234.setParamFlag(WindowParam.const_31,false);
