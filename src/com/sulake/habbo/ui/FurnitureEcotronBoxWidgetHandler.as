package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_805,RoomWidgetEcotronBoxOpenMessage.const_728,RoomWidgetEcotronBoxOpenedMessage.const_1495];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_805:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_728:
