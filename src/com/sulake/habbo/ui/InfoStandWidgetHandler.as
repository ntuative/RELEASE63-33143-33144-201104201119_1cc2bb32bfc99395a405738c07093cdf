   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         if(this.var_70 != null)
         {
            ...
            this.var_70.events.addEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
         }
      }
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_175,this.onUserTags);
               this._container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_158,this.onBadgeImage);
            }
         ...
         if(this._container.sessionDataManager != null)
         {
            this._container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_175,this.onUserTags);
            this._container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_158,this.onBadgeImage);
         }
         if(this._container.roomSessionManager != null)
         {
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_619.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_619.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_70 != null)
         {
            ...
            this.var_70.events.removeEventListener(SongInfoReceivedEvent.const_94,this.onSongInfoReceivedEvent);
            this.var_70 = null;
         }
         this.var_1081 = true;
         this.container = null;
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_334);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_425);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_269);
         _loc1_.push(RoomWidgetFurniActionMessage.const_715);
         _loc1_.push(RoomWidgetFurniActionMessage.const_860);
         _loc1_.push(RoomWidgetFurniActionMessage.const_858);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_843);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_740);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_682);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1498);
         _loc1_.push(RoomWidgetPetCommandMessage.const_607);
         _loc1_.push(RoomWidgetPetCommandMessage.const_834);
         _loc1_.push(RoomWidgetUserActionMessage.const_597);
         _loc1_.push(RoomWidgetUserActionMessage.const_400);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_602)
            {
               _loc3_ = this._container.roomSession.userDataManager.getUserDataByIndex(_loc2_);
            }
            else if(param1.type == RoomWidgetUserActionMessage.const_400 || param1.type == RoomWidgetUserActionMessage.const_597 || param1.type == RoomWidgetUserActionMessage.const_622)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_334:
            ...
            case RoomWidgetUserActionMessage.const_583:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_699,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_589:
               ...
               break;
            case RoomWidgetUserActionMessage.const_425:
            ...
            case RoomWidgetFurniActionMessage.const_858:
               ...
               break;
            case RoomWidgetUserActionMessage.const_400:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_843:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_740:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_682:
            ...
            case RoomWidgetPetCommandMessage.const_834:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_607:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_345);
               _loc6_.id = param1.id;
               ...
               if(_loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_414) != null)
               {
                  _loc6_.extraParam = _loc8_.getString(RoomWidgetInfostandExtraParamEnum.const_414);
               }
               ...
               {
                  _loc25_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_331);
               ...
               _loc11_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1218);
               _loc12_ = _loc9_.getModel().getNumber(RoomObjectVariableEnum.const_1107);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc29_ = "";
                  _loc30_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_874)
                  {
                     _loc31_ = this.var_70.getRoomItemPlaylist();
                     if(_loc31_ != null)
                     {
                  ...
                  else if(_loc6_.extraParam.indexOf(RoomWidgetInfostandExtraParamEnum.const_402) == 0)
                  {
                     _loc32_ = _loc6_.extraParam.substr(RoomWidgetInfostandExtraParamEnum.const_402.length);
                     _loc27_ = parseInt(_loc32_);
                     _loc30_ = "null";
                  }
                  if(_loc27_ != -1)
                  {
                     _loc33_ = this.var_70.getSongInfo(_loc27_);
                     if(_loc33_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_34:
               ...
               if(_loc13_.type == RoomObjectTypeEnum.const_216)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc13_.webID);
                  return null;
               }
               if(_loc13_.type == RoomObjectTypeEnum.const_202)
               {
                  _loc14_ = "null";
               ...
               if(_loc18_ != null)
               {
                  _loc15_.carryItem = _loc18_.getModel().getNumber(RoomObjectVariableEnum.const_578);
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_125)
               {
                  _loc15_.realName = this._container.sessionDataManager.realName;
               }
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.const_112)
               {
                  ...
                  if(!_loc35_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_912;
                  }
                  if(!_loc36_)
                  {
                     _loc15_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_705;
                  }
               ...
               if(_loc14_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc16_.push(RoomWidgetUserInfoUpdateEvent.const_1563);
               }
               else
               {
      ...
      {
         return [RoomSessionUserBadgesEvent.const_155];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionUserBadgesEvent.const_155:
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_619.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_619.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_70 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_70.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_70 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_413,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
