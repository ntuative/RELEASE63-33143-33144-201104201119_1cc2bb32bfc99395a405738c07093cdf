package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler, IPetImageListener, IAvatarImageListener, IGetImageListener
   {
      ...
      private var var_1630:Map = null;
      
      private var var_1093:Array;
      
      private var _connection:IConnection = null;
      
      private var var_1094:Number = 0.0;
      
      private var var_715:Point = null;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_410 != null)
         {
            ...
            {
               _loc2_ = this.var_410.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_291 != null)
         {
            ...
            {
               _loc2_ = this.var_291.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
         ...
         for each(_loc3_ in this.var_1093)
         {
            if(_loc3_ != null)
            {
               _loc3_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_595,RoomWidgetChatSelectAvatarMessage.const_838];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_595:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":chooser":
                              if(this._container.sessionDataManager.hasUserRight("fuse_habbo_chooser",HabboClubLevelEnum.const_45) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1089))
                              {
                              ...
                              return null;
                           case ":furni":
                              if(this._container.sessionDataManager.hasUserRight("fuse_furni_chooser",HabboClubLevelEnum.const_45) || this._container.sessionDataManager.hasSecurity(SecurityLevelEnum.const_1089))
                              {
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_838:
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           {
                              _loc13_ = this.var_291.getValue(this.getPetFigureString(_loc16_)) as BitmapData;
                           }
                           else
                           {
                              _loc13_ = this.var_410.getValue(_loc16_) as BitmapData;
                           }
                           _loc12_ = uint(this.var_581.getValue(_loc16_));
                           if(_loc13_ == null)
                           {
                              if(this._container.avatarRenderManager != null)
                              {
                                    ...
                                    default:
                                       ...
                                       if(_loc17_ != null)
                                       {
                                          ...
                                          if(_loc18_ != null)
                                          {
                                             ...
                                             this.var_581.add(_loc16_,_loc12_);
                                          }
                                       }
                                 }
                                 if(_loc13_ != null)
                                 {
                                    if(_loc10_.type == RoomObjectTypeEnum.const_216)
                                    {
                                       this.var_291.add(this.getPetFigureString(_loc16_),_loc13_);
                                    }
                                    else
                                    {
                                       this.var_410.add(_loc16_,_loc13_);
                                    }
                                 }
                              }
                           }
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(this.var_1094 > 0)
            {
               _loc5_ = Number(_loc4_.scale / this.var_1094);
            }
            if(this.var_715 == null)
            {
               ...
               this.var_483.y = 0;
               this.var_483.z = 0;
               this.var_715 = _loc4_.getScreenPoint(this.var_483);
               this.var_1094 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            this.var_483.x = 0;
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc8_.x != this.var_715.x || _loc8_.y != this.var_715.y)
               {
                  _loc10_ = PointMath.sub(_loc8_,PointMath.mul(this.var_715,_loc5_));
      ...
      public function petImageReady(param1:String) : void
      {
         ...
         if(this.var_291)
         {
            _loc2_ = this.var_291.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         if(this.var_410)
         {
            _loc2_ = this.var_410.remove(param1) as BitmapData;
            if(_loc2_ != null)
            {
               this.var_1093.push(_loc2_);
            }
      ...
      private function getPetImage(param1:String) : BitmapData
      {
         ...
         if(_loc3_ < 8)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               if(_loc6_ != null)
               {
                  ...
                  if(_loc7_ != 0)
                  {
                     this.var_581.add(param1,_loc7_);
                  }
               }
            }
         }
         else
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc9_.id > 0)
               {
                  this.var_1630.add(_loc9_.id,param1);
               }
            }
         }
         return _loc2_;
      ...
      {
         var _loc3_:String = this.var_1630.remove(param1);
         if(_loc3_ != null)
         {
            this.petImageReady(_loc3_);
            if(this.var_291)
            {
               this.var_291.add(_loc3_,param2);
            }
         }
      }
   }
