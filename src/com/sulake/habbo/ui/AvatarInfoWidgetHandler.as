package com.sulake.habbo.ui
{
   ...
   public class AvatarInfoWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_770);
      ...
      {
         return [RoomSessionUserDataUpdateEvent.const_116];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_770:
               this.dispatchOwnAvatarInfo();
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case RoomSessionUserDataUpdateEvent.const_116:
