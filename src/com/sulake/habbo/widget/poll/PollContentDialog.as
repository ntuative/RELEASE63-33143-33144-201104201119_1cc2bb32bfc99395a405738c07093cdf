package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++this.var_1240;
         if(this.var_1240 < this.var_1007.length)
         {
            _loc1_ = this.var_1007[this.var_1240] as Dictionary;
            if(!_loc1_)
            {
      ...
      private function method_9() : Array
      {
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!this.var_450)
         {
            ...
            this.var_450 = this._widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            this.var_450.center();
            this.var_450.procedure = this.cancelConfirmEventProc;
         }
      }
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = this.var_1007[this.var_1240] as Dictionary;
