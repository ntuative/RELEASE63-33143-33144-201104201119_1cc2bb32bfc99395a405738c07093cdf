package com.sulake.habbo.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      private var var_1509:int = 30000;
      ...
      public function VoteWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         {
            this.var_1509 = int(this._config.getKey("vote.time.limit","30000"));
         }
      }
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_160.reset();
            this.var_160.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_160 = null;
         }
         this._config = null;
         super.dispose();
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         {
            this.var_160 = new Timer(1000);
            this.var_160.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
      ...
      private function updateTimerView() : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc6_ = Math.max((this.var_1509 - _loc1_) / 1000,0);
      ...
      {
         var _loc2_:int = getTimer() - this.var_1911;
         if(_loc2_ > this.var_1509)
         {
            this.vote();
            return;
         }
