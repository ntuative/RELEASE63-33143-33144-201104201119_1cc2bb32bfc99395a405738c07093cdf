package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_484:Sprite = null;
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_484.removeEventListener(MouseEvent.CLICK,this.clickHandler);
            this.var_484 = null;
         }
         if(this.var_49 != null)
         {
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         if(this.var_484 == null)
         {
            this.var_484 = new Sprite();
            this.var_484.addChild(new Bitmap(this.var_49));
            this.var_484.addEventListener(MouseEvent.CLICK,this.clickHandler);
         }
         else
         {
            _loc5_ = this.var_484.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = this.var_49;
            }
         }
         _loc2_.setDisplayObject(this.var_484);
