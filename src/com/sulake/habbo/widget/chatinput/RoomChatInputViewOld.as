package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputViewOld
   {
      ...
      private static const const_1388:int = 11;
      
      private static const const_652:int = 18;
      
      private static const const_1017:int = 16;
      
      private static const const_1389:int = 20;
      ...
      private var var_325:Number = 600;
      ...
      public function RoomChatInputViewOld(param1:RoomChatInputWidgetOld, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         this.var_1118 = this._localization.getKey("widgets.chatinput.mode.whisper",":tell");
         this._chatModeIdShout = this._localization.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_2239 = this._localization.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         _loc6_.addEventListener(WindowKeyboardEvent.const_179,this.windowKeyEventProcessor);
         _loc6_.addEventListener(WindowEvent.const_101,this.onInputChanged);
         this._window.addEventListener(WindowEvent.const_276,this.onWindowMoved);
         this.var_1392 = true;
         this.var_510 = "";
         this.refreshView();
      }
      ...
      private function refreshView() : void
      {
         ...
         this._window.width = _loc1_.width + const_652 + const_1017;
         _loc1_.x = const_652;
         _loc1_.y = const_1388;
      }
      ...
      {
         this.var_325 = param1 - (const_652 + const_1017);
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == this.var_1118 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  this.var_510 = "";
               }
      ...
      private function onWindowMoved(param1:WindowEvent) : void
      {
         ...
         this.setMaxWidth(this._window.context.getDesktopWindow().width - this._window.x - const_1389);
      }
