package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected var var_104:IWindowContainer;
      
      private var var_48:IBorderWindow;
      
      private var var_1202:TagListRenderer;
      
      private var var_147:IBorderWindow;
      
      private var var_2800:int;
      
      private const const_1043:int = 5;
      
      private const const_1850:int = 7829367;
      
      private const const_1851:int = 16777215;
      
      private const const_2129:int = 2000;
      
      private const const_2128:int = 50;
      ...
      public function InfoStandUserView(param1:InfostandWidget, param2:String)
      {
         ...
         this.var_1202 = new TagListRenderer(param1,this.onTagSelected);
      }
      ...
      {
         if(this.var_55 == null || this.var_48 == null || this.var_104 == null)
         {
            return;
         }
         this.var_55.height = this.var_55.scrollableRegion.height;
         this.var_48.height = this.var_55.height + 20;
         this._window.width = Math.max(this.var_48.width,this.var_104.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_48.width < this.var_104.width)
         {
         ...
         {
            this.var_104.x = this._window.width - this.var_104.width;
            this.var_48.x = 0;
         }
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         this.var_104 = this._window.getListItemByName("button_list") as IWindowContainer;
         var _loc3_:* = [];
         this.var_104.groupChildrenWithTag("CMD_BUTTON",_loc3_,true);
         ...
         while(_loc9_ < 5)
         {
            _loc8_ = this.var_48.findChildByName("badge_" + _loc9_);
            if(_loc8_ != null)
            {
         ...
         _loc8_ = this.var_48.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_147.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_147.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_147.x = _loc5_.left - this.var_147.width;
         this.var_147.y = _loc5_.top + (_loc5_.height - this.var_147.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_147.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_147.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_147.x = _loc7_.left - this.var_147.width;
         this.var_147.y = _loc7_.top + (_loc7_.height - this.var_147.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_147 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_147 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      public function set realName(param1:String) : void
      {
         ...
         _loc2_.height = _loc2_.textHeight + this.const_1043;
      ...
      {
         var _loc3_:ITextWindow = this.var_55.getListItemByName("motto_text") as ITextWindow;
         var _loc4_:IWindowContainer = this.var_55.getListItemByName("motto_spacer") as IWindowContainer;
         ...
         if(param2)
         {
            if(param1 == "")
            {
               ...
               _loc3_.textColor = this.const_1850;
            }
            else
            {
               _loc3_.textColor = this.const_1851;
            }
            _loc3_.enable();
         }
         else
         ...
         _loc3_.text = param1;
         _loc3_.height = Math.min(_loc3_.textHeight + this.const_1043,this.const_2128);
         if(param2)
         {
            _loc3_.addEventListener(WindowKeyboardEvent.const_339,this.onMottoKeyboard);
            _loc3_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onMottoClicked);
         }
         else
         {
            _loc3_.removeEventListener(WindowKeyboardEvent.const_339,this.onMottoClicked);
         }
         this.updateWindow();
      }
      ...
      public function setTags(param1:Array, param2:Array = null) : void
      {
         ...
         if(param1.length != 0)
         {
            _loc3_.height = this.var_1202.renderTags(param1,_loc3_,param2);
            _loc4_.height = 1;
         }
         else
         {
      ...
      protected function updateInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         this.setMotto(param1.motto,param1.type == RoomWidgetUserInfoUpdateEvent.const_125);
      ...
      private function enableButton(param1:String, param2:Boolean = true) : void
      {
         ...
         var _loc3_:IRegionWindow = this.var_104.getChildByName(param1) as IRegionWindow;
      ...
      protected function showButton(param1:String, param2:Boolean) : void
      {
         ...
         var _loc3_:IWindow = this.var_104.getChildByName(param1);
         if(_loc3_ != null)
         {
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.const_912:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_705:
      ...
      protected function onMottoKeyboard(param1:WindowKeyboardEvent) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc2_:ITextWindow = this.var_55.getListItemByName("motto_text") as ITextWindow;
         var _loc3_:String = _loc2_.text;
         if(param1.keyCode == Keyboard.ENTER)
         {
            _loc5_ = getTimer();
            if(_loc5_ - this.var_2800 > this.const_2129 && _loc3_ != this._widget.localizations.getKey("infostand.motto.change"))
            {
               ...
               this.var_2800 = _loc5_;
            }
         }
         else
         {
            _loc2_.textColor = this.const_1850;
         }
      }
      ...
      {
         var _loc5_:* = null;
         this.var_104.width = 250;
         var _loc2_:* = [];
         this.var_104.groupChildrenWithTag("CMD_BUTTON_REGION",_loc2_,true);
         var _loc3_:int = 250;
         var _loc4_:int = 0;
