package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_424:IFrameWindow;
      ...
      private const const_2087:int = 1100;
      ...
      public function PetCommandTool(param1:InfostandWidget)
      {
         ...
         this.var_348 = new Timer(this.const_2087);
         this.var_348.addEventListener(TimerEvent.TIMER,this.onButtonDisableTimeout);
      }
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:CommandConfiguration = this.var_1144.getValue(param1) as CommandConfiguration;
         if(_loc6_ == null)
         {
            this.disableAllButtons();
            this.requestEnabledCommands(this.var_497);
         }
         else
         {
      ...
      {
         var _loc2_:CommandConfiguration = this.var_1144.getValue(this.var_497) as CommandConfiguration;
      ...
      {
         this.var_1144.remove(param1);
         this.var_1144.add(param1,param2);
         if(param1 != this.var_497)
         {
            return;
         }
      ...
      private function createCommandWindow() : void
      {
         ...
         this.var_42.setParamFlag(WindowParam.const_99,true);
         ...
         this.var_42.position = DEFAULT_LOCATION;
      }
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_424 == null)
         {
            ...
            this.var_424 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_424 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_424.x = 200;
            this.var_424.procedure = this.onInfoWindowProcedure;
         }
         else
         {
            this.var_424.visible = true;
         }
      }
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_400,this.var_497));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_607,this.var_497,this.var_1732 + " " + _loc6_);
      ...
      private function onTrainButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc6_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_607,this.var_497,this.var_1732 + " " + _loc5_);
