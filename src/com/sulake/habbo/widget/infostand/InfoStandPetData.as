package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetData
   {
      ...
      public function setData(param1:RoomWidgetPetInfoUpdateEvent) : void
      {
         ...
         this.var_1750 = param1.id;
         this._type = param1.petType;
         this.var_2157 = param1.petRace;
         this.var_49 = param1.image;
         this.var_2407 = param1.isOwnPet;
         this.var_2409 = param1.ownerId;
         this._ownerName = param1.ownerName;
         this._canOwnerBeKicked = param1.canOwnerBeKicked;
         this.var_1491 = param1.level;
         this.var_2410 = param1.levelMax;
         this.var_2221 = param1.experience;
         this.var_2408 = param1.experienceMax;
         this._energy = param1.energy;
         this.var_2413 = param1.energyMax;
         this._nutrition = param1.nutrition;
         this.var_2406 = param1.nutritionMax;
         this._petRespect = param1.petRespect;
         this.var_2411 = param1.roomIndex;
