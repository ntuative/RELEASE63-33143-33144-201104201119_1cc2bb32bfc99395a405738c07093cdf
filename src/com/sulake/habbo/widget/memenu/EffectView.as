package com.sulake.habbo.widget.memenu
{
   ...
   public class EffectView
   {
      ...
      private const const_2130:int = 1000;
      
      private var _container:MeMenuEffectsView;
      
      private var _window:IWindowContainer;
      
      private var var_196:IWidgetAvatarEffect;
      
      private var var_1047:IWindow;
      
      private var var_325:Number;
      
      private var var_852:ITextWindow;
      
      private var var_209:Timer;
      
      private var var_1048:IWindow;
      
      public function EffectView()
      {
         super();
         this.var_209 = new Timer(this.const_2130);
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         if(this.var_196.isActive)
         {
            _loc2_ = this.var_196.secondsLeft / Number(this.var_196.duration);
            this.var_1047.width = _loc2_ * this.var_325;
         }
         else
         {
            this.var_1047.width = 0;
            this.var_209.stop();
         }
         this.setTimeLeft();
      }
      ...
      private function setTimeLeft() : void
      {
         ...
         {
            this.var_852 = this._window.findChildByName("time_left") as ITextWindow;
            if(this.var_852 == null)
            {
               return;
            }
         ...
         if(!this.var_196.isActive)
         {
            this.var_852.caption = "${widgets.memenu.effects.activate}";
            return;
         }
         this.var_852.caption = "${widgets.memenu.effects.active.timeleft}";
         var _loc1_:String = this.var_852.text;
         var _loc2_:int = this.var_196.secondsLeft;
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var _loc7_:* = null;
         var _loc3_:String = "";
         if(this.var_196.isInUse)
         {
            _loc3_ = "memenu_effect_selected";
         }
         else if(this.var_196.isActive)
         {
         ...
         else
         {
            ...
            this.var_1048 = this._window.findChildByName("effect_hilite");
            this.var_1048.visible = false;
         }
         this.setTimeLeft();
         this.var_1047 = this._window.findChildByName("loader_bar");
         if(this.var_1047 != null)
         {
            this.var_325 = this.var_1047.width;
            this.var_209.start();
            this.onUpdate();
         }
         if(this.var_196.icon)
         {
            this.setElementBitmap("effect_icon",this.var_196.icon);
         }
      }
