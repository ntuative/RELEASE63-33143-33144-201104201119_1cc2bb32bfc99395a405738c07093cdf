package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      private var var_1017:MeMenuSoundSettingsSlider;
      ...
      {
         this.var_548 = param1.volume;
         if(this.var_1017 != null)
         {
            this.var_1017.setValue(this.var_548);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1979 = (_loc5_.content as BitmapData).clone();
         }
         ...
         this.var_1017 = new MeMenuSoundSettingsSlider(this,this._window.findChildByName("volume_container") as IWindowContainer,this._widget.assets,0,1);
         this.setSoundsOffIcon();
         this.setSoundsOnIcon();
         ...
         this._widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_847));
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_548 == 0)
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1976);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1979);
         }
      }
      ...
      private function setSoundsOnIcon(param1:BitmapData = null) : void
      {
         ...
         else if(this.var_548 == 1)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1978);
         }
         else
         {
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_767);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_925);
         }
