   ...
   public class PlayListEditorItemListView
   {
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_574);
            }
            return;
         }
         ...
         if(this.var_1108 >= 0 && this.var_1108 < this._items.length)
         {
            _loc2_ = this._items[this.var_1108] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_574);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1191);
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            if(param2.name == "button_remove_from_playlist" || _loc3_)
            {
               ...
               this._widget.sendRemoveFromPlayListMessage(this.var_1109);
               this.var_102 = null;
               this.var_1109 = -1;
            }
            else
