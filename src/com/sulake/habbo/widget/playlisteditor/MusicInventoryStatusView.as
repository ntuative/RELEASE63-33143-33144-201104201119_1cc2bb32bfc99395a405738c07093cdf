package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryStatusView
   {
      ...
      public static const const_828:String = "MISV_BUY_MORE";
      
      public static const const_763:String = "MISV_PREVIEW_PLAYING";
      ...
      private var var_1863:ITextWindow;
      
      private var var_1864:ITextWindow;
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_445.getValues())
         {
            _loc1_.destroy();
         }
         this.var_445 = null;
      ...
      public function selectView(param1:String) : void
      {
         ...
         this._container.addChildAt(this.var_445[param1] as IWindowContainer,0);
         this.var_46 = param1;
      }
      ...
      public function set authorName(param1:String) : void
      {
         ...
         this.var_1864.text = param1;
      }
      
      public function setPreviewPlayingBackgroundImage(param1:BitmapData, param2:Boolean = true) : void
      {
         this.blitBackgroundImage(const_763,"preview_play_background_image",param1);
      ...
      {
         this.blitBackgroundImage(const_828,"get_more_music_background_image",param1);
         if(param2 && param1 != null)
         {
            param1.dispose();
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_445.add(const_763,_loc1_);
            this.var_1863 = _loc1_.getChildByName("preview_play_track_name") as ITextWindow;
            this.var_1864 = _loc1_.getChildByName("preview_play_author_name") as ITextWindow;
            ...
            this.setPreviewPlayingBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_464));
         ...
         if(_loc1_ != null)
         {
            this.var_445.add(const_828,_loc1_);
            ...
            this.setGetMoreMusicBackgroundImage(this._widget.getImageGalleryAssetBitmap(PlayListEditorWidgetAssetsEnum.const_511));
         }
      }
      ...
      {
         var _loc6_:* = null;
         var _loc4_:IWindowContainer = this.var_445[param1] as IWindowContainer;
         if(_loc4_ == null)
         {
            return;
         }
