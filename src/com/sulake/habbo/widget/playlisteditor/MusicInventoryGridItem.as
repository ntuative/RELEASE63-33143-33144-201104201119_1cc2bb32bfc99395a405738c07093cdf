package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridItem
   {
      ...
      private static const const_1310:uint = 14612159;
      ...
      private var var_2185:IContainerButtonWindow = null;
      ...
      private function createWindow() : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_2185 = _loc2_.getChildByName("button_to_playlist") as IContainerButtonWindow;
         }
         ...
         this.playButtonState = const_493;
      }
