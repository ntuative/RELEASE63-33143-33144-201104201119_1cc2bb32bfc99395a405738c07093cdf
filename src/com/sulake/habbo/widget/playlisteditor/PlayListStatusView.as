package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_888:String = "PLSV_ADD_SONGS";
      
      public static const const_1162:String = "PLSV_START_PLAYBACK";
      
      public static const const_547:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_46 != const_547)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_445[this.var_46];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_445[const_888];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_445.add(const_547,_loc1_);
