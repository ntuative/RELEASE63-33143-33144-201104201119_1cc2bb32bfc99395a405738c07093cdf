package com.sulake.habbo.widget.playlisteditor
{
   ...
   public class MusicInventoryGridView
   {
      ...
      public function destroy() : void
      {
         ...
         {
            this.var_673.destroyGridItems();
            this.var_673 = null;
         }
         if(this.var_70 != null)
         {
            if(this.var_70.events != null)
            {
      ...
      public function refresh() : void
      {
         ...
         this._items = new Map();
         var _loc4_:int = this.var_70.getSongDiskInventorySize();
         var _loc5_:int = 0;
         while(_loc5_ < _loc4_)
         {
            _loc7_ = this.var_70.getSongDiskInventoryDiskId(_loc5_);
            _loc8_ = this.var_70.getSongDiskInventorySongId(_loc5_);
            _loc9_ = this.var_70.getSongInfo(_loc8_);
            _loc10_ = null;
            _loc11_ = null;
            if(_loc9_ != null)
            {
            ...
            this.var_673.addGridItem(_loc12_.window);
      ...
      public function setPreviewIconToPause() : void
      {
         ...
         {
            this.var_102.playButtonState = MusicInventoryGridItem.const_1202;
         }
      }
      ...
      public function setPreviewIconToPlay() : void
      {
         if(this.var_102 != null)
         {
            this.var_102.playButtonState = MusicInventoryGridItem.const_493;
         }
      }
      ...
      private function gridItemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || _loc3_)
         {
            ...
            {
               if(this.var_102.playButtonState == MusicInventoryGridItem.const_493)
               {
                  this.var_102.playButtonState = MusicInventoryGridItem.const_1241;
            ...
            {
               _loc4_ = this.var_673.getGridItemIndex(param1.window);
               if(_loc4_ != -1)
               {
