package com.sulake.habbo.widget.purse
{
   ...
   public class PurseWidget extends RoomWidgetBase
   {
      ...
      private const const_2132:uint = 4.291993382E9;
      
      private const const_2133:uint = 4.29080704E9;
      
      private const const_2134:uint = 4.285767869E9;
      
      private const const_2131:uint = 4.28366404E9;
      ...
      public function PurseWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager)
      {
         ...
         if(_loc4_)
         {
            ...
            this._view.x = _loc5_.width - this._view.width - this.const_1853;
            this._view.y = this.const_1853;
      ...
      {
         this.var_2065 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("credits").caption = this.var_2065.toString();
            this._view.findChildByName("credits_shadow").caption = this.var_2065.toString();
         }
      }
      
      private function onPixelBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         this.var_2066 = param1.balance;
         if(this._view)
         {
            this._view.findChildByName("pixels").caption = this.var_2066.toString();
            this._view.findChildByName("pixels_shadow").caption = this.var_2066.toString();
         }
      }
      
      private function onCreditsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1070));
      }
      
      private function onPixelsClick(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetOpenCatalogMessage(RoomWidgetOpenCatalogMessage.const_1104));
      }
      
      private function onOrangeMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2133;
      }
      
      private function onOrangeMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2132;
      }
      
      private function onBlueMouseOver(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2131;
      }
      
      private function onBlueMouseOut(param1:WindowMouseEvent) : void
      {
         param1.window.color = this.const_2134;
      }
   }
}
