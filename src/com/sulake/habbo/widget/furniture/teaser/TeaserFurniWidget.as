package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1830:int = 0;
      
      private const const_1825:int = 1;
      
      private const const_1831:int = 2;
      
      private const const_1827:int = 3;
      
      private const const_1829:int = 4;
      
      private const const_2113:int = 0;
      
      private const const_2115:int = 1;
      
      private const const_2117:int = 2;
      
      private const const_2112:int = 3;
      
      private const const_2120:int = 4;
      
      private const const_2119:int = 5;
      
      private const const_1828:String = "deco_img";
      
      private const const_1826:String = "dialog_bg";
      
      private const const_2116:String = "%campaign%_dialog_bg.png";
      
      private const const_357:String = "%campaign%_gift_package.png";
      
      private const const_2114:String = "%campaign%_gift_content.png";
      
      private const const_2118:String = "%campaign%_friend_gift_package.png";
      ...
      public function TeaserFurniWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager, param5:IHabboInventory)
      {
         ...
         this.var_1470 = this.var_158.getKey("image.library.url","http://images.habbo.com/c_images/");
         this.var_1470 += "Viral/";
      }
      ...
      override public function dispose() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.var_1473.length)
         {
            _loc2_ = this.var_1473.pop();
            _loc2_.dispose();
            _loc1_++;
         }
         this.var_158 = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_794,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_908,this.onObjectUpdate);
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_496:
               _loc2_ = this.const_1830;
               this._shareId = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_908:
               ...
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_794:
               _loc2_ = this.const_1825;
               this.var_369 = param1.objectId;
         ...
         if(this._window && (this.var_1471 != _loc2_ || _loc3_ != this.var_186))
         {
            this._window.dispose();
            this._window = null;
         }
         ...
         if(!this._window)
         {
            switch(this.var_1471)
            {
               case this.const_1830:
                  ...
                  break;
               case this.const_1825:
                  if(this.var_401 == this.const_2113)
                  {
                  ...
                  else if(this.var_401 == this.const_2115)
                  {
                  ...
                  else if(this.var_401 == this.const_2117)
                  {
                  ...
                  else if(this.var_401 == this.const_2112)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                  ...
                  else if(this.var_401 == this.const_2120)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
                     this.sendConversionPoint("viral_" + this.var_186,"client.show.not_enough_fb_friends");
                  ...
                  else if(this.var_401 == this.const_2119)
                  {
                     _loc1_ = assets.getAssetByName("notification_gift_alert") as XmlAsset;
            ...
            _loc5_ = this.const_2116.replace("%campaign%",this.var_186);
            this.setDecoImage(_loc5_,this.const_1826);
            _loc2_ = _loc2_.replace("%campaign%",this.var_186);
            this.setDecoImage(_loc2_,this.const_1828);
            if(_loc3_)
            {
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_900);
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(this._inventory)
         {
            if(this.var_1472 != 0)
            {
               this._inventory.toggleInventoryPage(this.var_1472 == 1 ? "null" : InventoryCategory.const_150);
            }
         }
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_782,"ViralGift",param1,param2,param3);
      ...
      private function setDecoImage(param1:String, param2:String) : void
      {
         ...
         if(!_loc4_)
         {
            this.var_1473.push(new ImageDownloader(this,_assets,this.var_186,this.var_1470,param1,param2));
            return;
         }
         var _loc5_:BitmapData = (_loc4_.content as BitmapData).clone();
         switch(param2)
         {
            case this.const_1826:
            case this.const_1828:
