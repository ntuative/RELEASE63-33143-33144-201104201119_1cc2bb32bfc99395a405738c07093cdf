package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class ImageDownloader implements IDisposable
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_45)
         {
            this.var_45.removeEventListener(AssetLoaderEvent.const_29,this.onImageReady);
         }
         this.var_45 = null;
         this._disposed = true;
      }
      ...
      public function downloadImage(param1:String, param2:String) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_45.addEventListener(AssetLoaderEvent.const_29,this.onImageReady);
         }
      }
