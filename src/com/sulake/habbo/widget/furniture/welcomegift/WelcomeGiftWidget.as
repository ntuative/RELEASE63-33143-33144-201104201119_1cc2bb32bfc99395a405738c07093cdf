package com.sulake.habbo.widget.furniture.welcomegift
{
   ...
   public class WelcomeGiftWidget extends RoomWidgetBase
   {
      ...
      private const const_668:String = "welcome_gift_email_unverified";
      
      private const const_1054:String = "welcome_gift_email_verified";
      
      private const const_1490:String = "welcome_gift_email_change";
      
      private const const_2135:int = 4;
      ...
      private function createMainView() : void
      {
         ...
         if(this.var_1312)
         {
            this.setViewState(this.const_1054);
         }
         else
         {
            this.setViewState(this.const_668);
         }
      }
      ...
      private function setViewState(param1:String) : void
      {
         ...
         switch(param1)
         {
            case this.const_668:
               ...
               this._view.findChildByName("edit_text").visible = this.var_1063;
               this._view.findChildByName("edit").setParamFlag(WindowParam.const_31,this.var_1063);
               break;
            case this.const_1054:
            ...
            case this.const_1490:
               ...
               this.setBitmap("email_icon","email_icon");
               this.setButtonState("save_email",this.var_1063);
               _loc6_ = this._view.findChildByName("email_input") as ITextFieldWindow;
               _loc6_.caption = this.var_1603;
               _loc6_.focus();
      ...
      {
         this.setViewState(this.const_1490);
      }
      
      private function openGift(param1:WindowMouseEvent) : void
      {
         messageListener.processWidgetMessage(new RoomWidgetFurniActionMessage(RoomWidgetFurniActionMessage.const_689,this._furniId,0));
         this.disposeView();
      }
      
      private function cancelEmailChange(param1:WindowMouseEvent) : void
      {
         this.setViewState(!!this.var_1312 ? this.const_1054 : this.const_668);
      }
      ...
      private function saveEmail(param1:WindowMouseEvent) : void
      {
         ...
         this.var_1602 = _loc2_.text;
         messageListener.processWidgetMessage(new RoomWidgetChangeEmailMessage(this.var_1602));
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_563,this.updateEventHandler);
         param1.addEventListener(RoomWidgetChangeEmailResultEvent.const_856,this.emailChangeHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWelcomeGiftUpdateEvent.const_563,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetChangeEmailResultEvent.const_856,this.emailChangeHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetWelcomeGiftUpdateEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetWelcomeGiftUpdateEvent.const_563:
               this.var_1603 = param1.email;
               this.var_1312 = param1.isVerified;
               this.var_1063 = param1.allowEmailChange;
      ...
      private function emailChangeHandler(param1:RoomWidgetChangeEmailResultEvent) : void
      {
         if(param1.result == 0)
         {
            this.var_1603 = this.var_1602;
            this.setViewState(this.const_668);
         }
         else
         {
            if(param1.result == this.const_2135)
            {
               this.var_1063 = false;
            }
      ...
      private function showEmailChangeError(param1:int) : void
      {
         ...
         this.setCaption("email_input",this.var_1602);
