package com.sulake.habbo.widget.furniture.stickie
{
   ...
   public class StickieFurniWidget extends RoomWidgetBase
   {
      ...
      private static const const_1297:int = 14;
      
      private static const const_1296:int = 500;
      
      private static const const_1406:Number = 100;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetStickieDataUpdateEvent.const_907,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetStickieDataUpdateEvent.const_907,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetStickieDataUpdateEvent) : void
      {
         ...
         this.var_1062 = param1.objectType;
         this._text = param1.text;
         this.var_859 = param1.colorHex;
      ...
      private function showInterface() : void
      {
         ...
         if(this.var_1062 == "greeting_note")
         {
            _loc1_ = assets.getAssetByName("greeting_note");
         }
         else
         {
            _loc1_ = assets.getAssetByName("stickie");
         }
         ...
         {
            this._window = windowManager.createWindow("stickieui_container","",HabboWindowType.const_69,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1406,WINDOW_INITIAL_Y,2,2),null,0) as IWindowContainer;
         ...
         if(_loc3_ != null)
         {
            ...
            _loc3_.addEventListener(WindowEvent.const_101,this.onTextWindowEvent);
         }
         _loc6_ = this._window.findChildByTag("bg") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
            if(this.var_1062 == "post_it_vd")
            {
               _loc4_ = assets.getAssetByName("stickie_vd") as BitmapDataAsset;
            }
            else if(this.var_1062 == "greeting_note")
            {
               _loc4_ = assets.getAssetByName("greeting_note_bg") as BitmapDataAsset;
               _loc6_.color = uint("0xFF" + this.var_859);
            }
            else
            {
         ...
         this.setColorButtons(this._controller && (this.var_1062 == "post_it" || this.var_1062 == "greeting_note"));
      }
      ...
      private function sendUpdate() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_501,this.var_369,this._text,this.var_859);
      ...
      private function sendSetColor(param1:uint) : void
      {
         ...
         if(messageListener != null)
         {
            _loc3_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_501,this.var_369,this._text,this.var_859);
      ...
      private function sendDelete() : void
      {
         ...
         {
            _loc1_ = new RoomWidgetStickieSendUpdateMessage(RoomWidgetStickieSendUpdateMessage.const_748,this.var_369);
            messageListener.processWidgetMessage(_loc1_);
         }
      }
      ...
      private function onTextWindowEvent(param1:WindowEvent) : void
      {
         ...
         _loc2_.maxChars = const_1296;
         if(_loc2_.numLines < const_1297)
         {
            return;
         }
