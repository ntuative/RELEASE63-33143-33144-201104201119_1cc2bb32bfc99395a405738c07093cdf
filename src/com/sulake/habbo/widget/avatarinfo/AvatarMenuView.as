package com.sulake.habbo.widget.avatarinfo
{
   ...
   public class AvatarMenuView extends AvatarInfoView
   {
      ...
      protected static const const_959:uint = 0;
      
      protected static const const_634:uint = 1;
      
      protected static const const_1293:uint = 2;
       
      
      protected var _data:AvatarInfoData;
      
      protected var var_573:uint = 0;
      ...
      public function AvatarMenuView(param1:AvatarInfoWidget, param2:int, param3:String, param4:int, param5:int, param6:AvatarInfoData)
      {
         ...
         this._data = param6;
         var_1334 = XmlAsset(_widget.assets.getAssetByName("avatar_menu_widget")).content as XML;
      }
      ...
      override protected function createWindow() : void
      {
         ...
         _window = _widget.windowManager.buildFromXML(var_1334,0) as IWindowContainer;
         if(!_window)
         {
            return;
         }
      ...
      protected function updateButtons() : void
      {
         ...
         if(this.var_573 == const_959 || this.var_573 == const_634)
         {
            ...
            else
            {
               ...
               this.var_573 = const_634;
            }
         }
         if(this.var_573 == const_634)
         {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "report":
                  ...
                  break;
               case "link_moderate":
                  this.var_573 = const_1293;
                  this.updateButtons();
                  break;
               case "link_show_actions":
                  this.var_573 = const_959;
                  this.updateButtons();
                  break;
