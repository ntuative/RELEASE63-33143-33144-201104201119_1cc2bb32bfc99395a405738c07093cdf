package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1030:Array = [];
      
      private static var var_2024:int = 200;
      ...
      {
         this.var_835 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1687;
      }
      ...
      private function getRoomRowWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1030.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_835.clone());
      }
      ...
      private function storeRoomRowWindow(param1:IWindowContainer) : void
      {
         ...
         if(var_1030.length < var_2024)
         {
            ...
            param1.width = this.var_835.width;
            param1.height = this.var_835.height;
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1563)
         {
