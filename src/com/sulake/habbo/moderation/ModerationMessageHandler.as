package com.sulake.habbo.moderation
{
   ...
   public class ModerationMessageHandler
   {
      ...
      private function onUserInfo(param1:ModeratorUserInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1168)
         {
      ...
      private function onRoomInfo(param1:ModeratorRoomInfoEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1170)
         {
      ...
      private function onCfhChatlog(param1:CfhChatlogEvent) : void
      {
         ...
         this.onChatlog("Call For Help Chatlog: " + _loc2_.data.chatRecordId,WindowTracker.const_1217,_loc2_.data.callId,_loc3_,_loc4_);
      }
      ...
      private function onRoomChatlog(param1:RoomChatlogEvent) : void
      {
         ...
         var _loc4_:Dictionary = new Dictionary();
         this.onChatlog("Room Chatlog: " + _loc2_.data.roomName,WindowTracker.const_825,_loc2_.data.roomId,_loc3_,_loc4_);
      }
      ...
      private function onUserChatlog(param1:UserChatlogEvent) : void
      {
         ...
         this.onChatlog("User Chatlog: " + _loc2_.data.userName,WindowTracker.const_1079,_loc2_.data.userId,_loc2_.data.rooms,_loc3_);
      }
      
      private function onChatlog(param1:String, param2:int, param3:int, param4:Array, param5:Dictionary) : void
      {
         var _loc6_:* = null;
         for each(_loc6_ in this.var_1169)
         {
      ...
      private function onRoomVisits(param1:RoomVisitsEvent) : void
      {
         ...
         for each(_loc3_ in this.var_1171)
         {
      ...
      private function onRoomEnter(param1:RoomEntryInfoMessageEvent) : void
      {
         ...
         if(_loc2_.privateRoom)
         {
            ...
            this.var_67.startPanel.guestRoomEntered(_loc2_);
         }
         else
         {
            this.var_67.currentFlatId = 0;
         }
         for each(_loc3_ in this.var_942)
         {
            _loc3_.onRoomChange();
         }
      }
      ...
      private function onPublicSpaceCastLibs(param1:PublicSpaceCastLibsEvent) : void
      {
         ...
         this.var_67.startPanel.publicSpaceEntered(_loc2_);
      }
      ...
      private function onRoomExit(param1:CloseConnectionMessageEvent) : void
      {
         var _loc2_:* = null;
         this.var_67.currentFlatId = 0;
         this.var_67.startPanel.roomExited();
         for each(_loc2_ in this.var_942)
         {
            _loc2_.onRoomChange();
         }
      }
      ...
      public function removeChatlogListener(param1:ChatlogCtrl) : void
      {
         var _loc3_:* = null;
         var _loc2_:Array = new Array();
         for each(_loc3_ in this.var_1169)
         {
            if(_loc3_ != param1)
            {
               _loc2_.push(_loc3_);
