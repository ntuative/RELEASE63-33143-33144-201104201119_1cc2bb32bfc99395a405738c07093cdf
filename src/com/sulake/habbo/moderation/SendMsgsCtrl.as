package com.sulake.habbo.moderation
{
   ...
   public class SendMsgsCtrl implements IDisposable, TrackedWindow
   {
      ...
      {
         return WindowTracker.const_1499;
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.messageTemplates[this.var_1151.selection];
         if(_loc3_ != null)
         {
            this.var_680 = false;
      ...
      private function onSendMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModMessageMessageComposer(this.var_1482,this.var_513.text,this.var_1483));
         this.dispose();
      }
