package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_999:Array = [];
      
      private static var var_1921:int = 1000;
      
      private static var var_1000:Array = [];
      
      private static var var_1919:int = 200;
      ...
      private var var_1672:IMessageComposer;
      ...
      {
         this.var_801 = IWindowContainer(this.var_36.getXmlWindow("chatlog_roomheader"));
         this.var_802 = IWindowContainer(this.var_36.getXmlWindow("chatlog_chatline"));
         this.var_505 = new Timer(1000,1);
         ...
         this.var_36.connection.send(this.var_1672);
      ...
      private function getChatLineWindow() : IWindowContainer
      {
         if(false)
         {
            return var_999.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_802.clone());
      }
      
      private function storeChatLineWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_999.length < var_1921)
         {
            ...
            param1.width = this.var_802.width;
            param1.height = this.var_802.height;
            var_999.push(param1);
         }
         else
         {
      ...
      private function getChatHeaderWindow() : IWindowContainer
      {
         if(false)
         {
            return var_1000.pop() as IWindowContainer;
         }
         return IWindowContainer(this.var_801.clone());
      }
      
      private function storeChatHeaderWindow(param1:IWindowContainer) : void
      {
         var _loc2_:* = null;
         if(var_1000.length < var_1919)
         {
            _loc2_ = ITextWindow(param1.findChildByName("room_name_txt"));
            _loc2_.procedure = null;
            param1.width = this.var_801.width;
            param1.height = this.var_801.height;
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = this.var_1920[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            if(!this.var_1516.getValue(param2.chatterName))
            {
               this.var_1516.add(param2.chatterName,param2.chatterId);
            }
         }
      ...
      private function onChatLogUserClick(param1:WindowMouseEvent) : void
      {
         ...
         var _loc3_:int = this.var_1516.getValue(_loc2_);
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_1515)
         {
            this.storeChatLineWindow(_loc1_);
         }
         for each(_loc1_ in this.var_1517)
         {
