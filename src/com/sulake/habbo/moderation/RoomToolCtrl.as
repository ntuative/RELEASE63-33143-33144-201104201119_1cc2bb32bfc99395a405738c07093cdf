package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1151:IDropMenuWindow;
      
      private var var_513:ITextFieldWindow;
      
      private var var_680:Boolean = true;
      
      private var var_922:ICheckBoxWindow;
      ...
      public function show() : void
      {
         ...
         this.var_36.connection.send(new GetModeratorRoomInfoMessageComposer(this.var_339));
         Logger.log("BEGINNING TO SHOW: " + this.var_339);
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1576;
      }
      ...
      public function populate() : void
      {
         ...
         this.var_1151 = IDropMenuWindow(this._frame.findChildByName("msgTemplatesSelect"));
         this.prepareMsgSelect(this.var_1151);
         this.var_1151.procedure = this.onSelectTemplate;
         this.var_922 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1427 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1428 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_825,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_922.isSelected);
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1760,_loc2_,this.var_513.text,"",""));
         if(this.var_1427.isSelected || this.var_1428.isSelected || this.var_922.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1427.isSelected,this.var_1428.isSelected,this.var_922.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1556);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1653);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1151.selection];
         if(_loc3_ != null)
         {
            this.var_680 = false;
