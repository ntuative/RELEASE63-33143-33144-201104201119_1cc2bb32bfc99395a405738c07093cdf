package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_1225:String = "issue_bundle_open";
      
      public static const const_764:String = "issue_bundle_my";
      
      public static const const_1078:String = "issue_bundle_picked";
      
      public static const const_1573:int = 15000;
       
      
      private var var_67:ModerationManager;
      
      private var var_616:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         this.var_616 = new IssueBrowser(this,this.var_67.windowManager,this.var_67.assets);
         this.var_1154 = [];
         this.var_1153 = [];
         this.var_924 = new Map();
         this.var_2352 = parseInt(this.var_67.configuration.getKey("chf.score.updatefactor","60"));
         this.var_1766 = new Timer(const_1573,0);
         this.var_1766.addEventListener(TimerEvent.TIMER,this.updatePriorities);
         this.var_1766.start();
      }
      ...
      public function pickBundle(param1:int, param2:Boolean = false, param3:int = 0) : void
      {
         ...
         this.var_1154 = this.var_1154.concat(_loc4_.getIssueIds());
      }
      ...
      public function autoPick(param1:Boolean = false, param2:int = 0) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_181 && (_loc4_ == null || _loc5_.prioritySum > _loc4_.prioritySum))
            {
               _loc4_ = _loc5_;
            }
         }
      ...
      public function releaseAll() : void
      {
         ...
         {
            if(_loc3_.state == IssueMessageData.const_392 && _loc3_.pickerUserId == _loc1_)
            {
      ...
      private function sendRelease(param1:Array) : void
      {
         ...
         this.var_1153 = this.var_1153.concat(param1);
      }
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(this.var_616 == null || !this.var_616.isOpen())
         {
            this.var_67.soundManager.playSound(HabboSoundTypesEnum.const_1279);
         }
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         var _loc2_:int = int(this.var_925.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  this.var_925.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1641)
         {
            this._issues.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in this.var_105)
            {
               if(this.validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.updateIssue(param1);
                  this.var_925.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            _loc2_ = this.var_2351++;
            _loc3_ = new IssueBundle(_loc2_,param1);
            this.var_925.add(param1.issueId,_loc2_);
         ...
         if(param1.state == IssueMessageData.const_181)
         {
            ...
            _loc9_ = this.var_1153.indexOf(param1.issueId);
            if(_loc9_ == -1 && _loc7_)
            {
      ...
      public function updatePriorities(param1:Event = null) : void
      {
         ...
         for each(_loc4_ in this._issues)
         {
            if(_loc4_ != null)
            {
               ...
               _loc4_.temporalPriority = int(_loc3_ / this.var_2352);
            }
         }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = this.var_925.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = this.var_105.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
      ...
      public function getBundles(param1:String) : Array
      {
         ...
         for each(_loc4_ in this.var_105)
         {
            ...
            {
               case const_1225:
                  if(_loc4_.state == IssueMessageData.const_181)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
               case const_764:
                  if(_loc4_.state == IssueMessageData.const_392 && _loc4_.pickerUserId == _loc3_)
                  {
                     _loc2_.push(_loc4_);
                  }
                  break;
      ...
      public function autoHandle(param1:int) : void
      {
         ...
         {
            if(_loc5_.state == IssueMessageData.const_392 && _loc5_.pickerUserId == _loc4_ && _loc5_.id != param1 && (_loc3_ == null || _loc5_.prioritySum > _loc3_.prioritySum))
            {
               _loc3_ = _loc5_;
            }
         }
