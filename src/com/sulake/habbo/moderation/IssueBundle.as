package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_827:IssueMessageData = null;
      
      private var var_826:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2751 = param2.pickerUserName;
         this.var_1452 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         this.var_1255 += param1.priority;
         if(param1.message != null && param1.message != "")
         {
            ++this.var_1256;
         }
         if(this.var_827 == null || param1.timeStamp < this.var_827.timeStamp)
         {
            this.var_827 = param1;
         }
         if(this.var_826 == null || param1.priority > this.var_826.timeStamp)
         {
            this.var_826 = param1;
         }
      }
      ...
      public function removeIssue(param1:int) : IssueMessageData
      {
         ...
         if(_loc2_ != null)
         {
            this.var_1255 -= _loc2_.priority;
            if(_loc2_.message != null && _loc2_.message != "")
            {
               --this.var_1256;
            }
            if(this.var_827 == _loc2_)
            {
               this.var_827 = null;
            }
            if(this.var_826 == _loc2_)
            {
               this.var_826 = null;
            }
         }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_826;
         if(_loc1_ == null)
         {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:IssueMessageData = this.var_827;
         if(_loc2_ == null)
         {
