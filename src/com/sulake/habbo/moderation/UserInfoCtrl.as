package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_1021:int = 60;
      
      private static const const_1022:int = 3600;
      
      private static const const_1024:int = 86400;
      
      private static const const_1023:int = 31536000;
      ...
      {
         if(param1 < 2 * const_1021)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_1022)
         {
            return Math.round(param1 / const_1021) + " mins ago";
         }
         if(param1 < 2 * const_1024)
         {
            return Math.round(param1 / const_1022) + " hours ago";
         }
         if(param1 < 2 * const_1023)
         {
            return Math.round(param1 / const_1024) + " days ago";
         }
         return Math.round(param1 / const_1023) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1210.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_36.getXmlWindow("user_info"));
            this.var_1210.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_36,WindowTracker.const_1079,this._data.userId),this._callerFrame,this.var_1209,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new RoomVisitsCtrl(this.var_36,this._data.userId),this._callerFrame,this.var_1209,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new SendMsgsCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1483),this._callerFrame,this.var_1209,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ModActionCtrl(this.var_36,this._data.userId,this._data.userName,this.var_1483),this._callerFrame,this.var_1209,false,true);
      }
