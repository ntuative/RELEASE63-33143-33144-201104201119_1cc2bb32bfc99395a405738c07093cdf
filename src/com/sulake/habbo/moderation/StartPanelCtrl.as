package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl implements IDisposable
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!this.var_1741 ? 0 : 1,this._roomId),this.var_36,WindowTracker.const_825,this._roomId),this._frame,false,false,true);
      }
