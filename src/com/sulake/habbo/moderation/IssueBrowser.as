package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2111:String = "my_issues";
      
      private const const_2110:String = "open_issues";
      
      private const const_2109:String = "picked_issues";
      
      private const const_2136:String = "closed_issues";
      ...
      private var var_1840:IIssueBrowserView;
      
      private var var_1839:IIssueBrowserView;
      
      private var var_1841:PickedIssuesView;
      ...
      private function createMainFrame() : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_266 = this._window.findChildByName("tab_context") as ITabContextWindow;
            _loc6_ = 0;
            while(_loc6_ < this.var_266.numTabItems)
            {
               _loc5_ = this.var_266.getTabItemAt(_loc6_);
               _loc5_.addEventListener(WindowEvent.const_57,this.onTabSelected);
               _loc6_++;
            }
         }
         this.var_266 = this._window.findChildByName("tab_context") as ITabContextWindow;
         if(this.var_266 == null || this.var_266.container == null)
         {
            return;
         }
         var _loc1_:ISelectableWindow = this.var_266.selector.getSelectableByName("open_issues");
         this.var_266.selector.setSelected(_loc1_);
      }
      
      private function selectView(param1:String) : void
      {
         var _loc2_:IIssueBrowserView = this.getView(param1);
         if(this.var_362 == _loc2_)
         {
            return;
         }
         ...
         this.var_362.view.width = this.var_266.container.width;
         this.var_362.view.height = this.var_266.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2111:
               if(this.var_1840 == null)
               {
                  this.var_1840 = new MyIssuesView(this.issueManager,this,this.var_266.container);
               }
               return this.var_1840;
            case this.const_2110:
               if(this.var_1839 == null)
               {
                  this.var_1839 = new OpenIssuesView(this.issueManager,this,this.var_266.container);
               }
               return this.var_1839;
            case this.const_2109:
               if(this.var_1841 == null)
               {
                  this.var_1841 = new PickedIssuesView(this.issueManager,this,this.var_266.container);
               }
