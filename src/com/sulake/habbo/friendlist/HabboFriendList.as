package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList, IAvatarImageListener
   {
      ...
      private var var_145:IHabboMessenger;
      ...
      private var var_2253:FriendListLookAndFeel;
      
      private var var_448:FriendListTabs;
      
      private var _view:FriendListView;
      
      private var var_1687:OpenedToWebPopup;
      ...
      private var var_1686:AvatarSearchResults;
      ...
      {
         this.var_2253 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         this.var_103 = new FriendCategories(new FriendCategoriesDeps(this));
         this.var_1686 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_602.stop();
            this.var_602.removeEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_602 = null;
         }
         ...
         if(this.var_145)
         {
            this.var_145.release(new IIDHabboMessenger());
            this.var_145 = null;
         }
         if(this.var_184)
         {
         ...
         if(this.var_1122)
         {
            this.var_1122.release(new IIDAvatarRenderManager());
            this.var_1122 = null;
         }
         ...
         if(this.var_725)
         {
            this.var_725.release(new IIDSessionDataManager());
            this.var_725 = null;
         }
         super.dispose();
      }
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         {
            this.var_1687 = new OpenedToWebPopup(this);
         }
         this.var_1687.show(x,y);
      }
      ...
      {
         this.openFriendListWithTab(FriendListTab.const_103);
      }
      
      public function openFriendRequests() : void
      {
         this.openFriendListWithTab(FriendListTab.const_91);
      }
      
      public function openFriendSearch() : void
      {
         this.openFriendListWithTab(FriendListTab.const_297);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = this._windowManager.createWindow(param1,"",HabboWindowType.const_343,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6) as IBitmapWrapperWindow;
      ...
      {
         var _loc2_:IAvatarImage = this.var_1122.createAvatarImage(param1,AvatarScaleType.const_93,null,this);
         if(!_loc2_)
         {
            return null;
         }
      ...
      {
         var _loc1_:String = this.var_184.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      
      private function getVariable(param1:String, param2:Dictionary) : String
      {
         return this.var_184.getKey(param1,param1,param2);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_145 = param2 as IHabboMessenger;
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         this._view = new FriendListView(this,this.var_184);
         ...
         this.var_103.addCategory(new FriendCategory(FriendCategory.const_1246,this.getText("friendlist.friends")));
         this.var_103.addCategory(new FriendCategory(FriendCategory.const_426,this.getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in this.getSortedFriends(_loc2_.friends))
         {
            this.var_103.addFriend(new Friend(_loc4_));
         }
         this.var_448 = new FriendListTabs(new FriendListTabsDeps(this));
         if(!this.var_602)
         {
            this.var_602 = new Timer(120000);
            this.var_602.addEventListener(TimerEvent.TIMER,this.sendFriendListUpdate);
            this.var_602.start();
         }
         this.getBuddyRequests();
         this.registerListeners();
         this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.FRIENDLIST));
         ...
         {
            _loc5_ = this.var_103.findCategory(FriendCategory.const_426);
            if(_loc5_)
            {
               _loc5_.setOpen(true);
            }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            this._view.openFriendList();
            _loc1_ = this.var_448.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_430));
            }
            else
            {
               switch(_loc1_.id)
               {
                  case FriendListTab.const_103:
                     this.trackFriendListEvent(HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_FRIENDS);
                     break;
                  case FriendListTab.const_297:
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            this.var_448.findTab(FriendListTab.const_91).setNewMessageArrived(true);
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = this.var_448.findTab(FriendListTab.const_91);
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         this.var_1686.searchReceived(_loc2_.friends,_loc2_.others);
      ...
      {
         var _loc2_:FriendListTab = this.var_448.findTab(FriendListTab.const_91);
         if(!_loc2_)
         {
            return;
         }
      ...
      {
         if(!this.var_725 || !this._friendRequests)
         {
            return;
         }
         var _loc2_:int = 0;
         if(this.var_725.hasUserRight("fuse_super_extended_buddylist",HabboClubLevelEnum.const_47))
         {
            _loc2_ = this._friendRequests.vipLimit;
         }
         else if(this.var_725.hasUserRight("fuse_extended_buddylist",HabboClubLevelEnum.const_45))
         {
