package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1842:String = "no_reqs_info";
      ...
      {
         this.var_1970 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1971 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1971.procedure = this.onDismissAllButtonClick;
         this.var_1970.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_181)
         {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_369;
         ...
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_63,param1));
         }
      }
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_376;
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_369 && _loc4_.state != FriendRequest.const_376)
            {
               _loc4_.state = FriendRequest.const_376;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_369 && _loc4_.state != FriendRequest.const_376)
            {
               ...
               _loc4_.state = FriendRequest.const_369;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_63,_loc4_.requestId));
               }
            }
         }
         this._friendList.send(_loc3_);
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1970,_loc1_);
         this.setEnabled(this.var_1971,_loc1_);
      }
