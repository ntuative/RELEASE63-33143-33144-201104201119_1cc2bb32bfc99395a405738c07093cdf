package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_409:int = 100;
      ...
      {
         return Math.ceil(this.var_227.length / const_409);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_967 * const_409;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_967 + 1) * const_409,this.var_227.length);
      }
