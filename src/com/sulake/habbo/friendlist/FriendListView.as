package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1837:String = "noconvinfo";
      
      private static const const_1836:String = "messageinput";
      ...
      private var var_1527:FriendListTabsView;
      
      private var var_15:IFrameWindow;
      
      private var var_1027:IWindowContainer;
      
      private var var_260:IWindowContainer;
      
      private var var_1526:ITextWindow;
      ...
      public function FriendListView(param1:HabboFriendList, param2:IHabboConfigurationManager)
      {
         ...
         this.var_1527 = new FriendListTabsView(this._friendList);
      ...
      private function prepare() : void
      {
         ...
         this.var_1027 = IWindowContainer(this.var_15.content.findChildByName("main_content"));
         this.var_260 = IWindowContainer(this.var_15.content.findChildByName("footer"));
         this.var_1527.prepare(this.var_1027);
         this.var_15.procedure = this.onWindow;
         this.var_15.content.setParamFlag(HabboWindowParam.const_1260,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_1118,true);
         this.var_15.header.setParamFlag(HabboWindowParam.const_718,false);
         this.var_15.header.setParamFlag(HabboWindowParam.const_802,true);
         this.var_15.content.setParamFlag(HabboWindowParam.const_718,false);
         this.var_15.content.setParamFlag(HabboWindowParam.const_802,true);
         this.var_15.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1526 = ITextWindow(this.var_15.findChildByName("info_text"));
         this.var_1526.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_1945 == -1 ? 0 : int(this.var_15.height - this.var_1945);
         var _loc4_:int = this.var_1947 == -1 ? 0 : int(this.var_15.width - this.var_1947);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_260.y = Util.getLowestPoint(this.var_15.content);
         this.var_260.width = this._friendList.tabs.windowWidth;
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1231,this._friendList.tabs.findSelectedTab() != null);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_718,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1260,false);
         ...
         this.var_1945 = this.var_15.height;
         this.var_1947 = this.var_15.width;
