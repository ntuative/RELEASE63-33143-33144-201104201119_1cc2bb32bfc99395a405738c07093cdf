package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_1992:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2153:IContainerButtonWindow;
      
      private var var_2155:IContainerButtonWindow;
      
      private var var_2156:IContainerButtonWindow;
      
      private var var_2154:IContainerButtonWindow;
      
      private var var_63:IItemListWindow;
      
      private var var_628:AvatarPopupCtrl;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_628 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2153 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2155 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2156 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2154 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_103).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_103,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_103,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2153,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2155,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2156,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2154,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_628.setData(_loc3_.online,_loc3_.name,_loc3_.motto,_loc3_.figure,_loc3_.lastAccess);
            this.var_628.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_628.closePopup();
         }
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_103,param4);
         _loc6_.visible = true;
      }
