package com.sulake.habbo.navigator.mainview
{
   ...
   public class GuestRoomListCtrl implements IViewCtrl
   {
      ...
      private var var_560:RoomPopupCtrl;
      ...
      public function GuestRoomListCtrl(param1:HabboNavigator)
      {
         ...
         this.var_560 = new RoomPopupCtrl(this._navigator,5,-5);
      ...
      public function set content(param1:IWindowContainer) : void
      {
         ...
         this.var_569 = IScrollbarWindow(this.var_181.findChildByName("scroller"));
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.var_569.scrollV = 0;
         }
         this.var_181.findChildByName("no_rooms_found").visible = _loc1_.length < 1;
      }
      ...
      private function getListEntry(param1:int) : IWindowContainer
      {
         ...
         _loc2_.setParamFlag(HabboWindowParam.const_1697,true);
      ...
      public function refreshEntryDetails(param1:IWindowContainer, param2:GuestRoomData) : void
      {
         ...
         this._navigator.refreshButton(param1,"doormode_doorbell_small",param2.doorMode == RoomSettingsFlatInfo.const_198,null,0);
      ...
      private function onRow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(this.var_560.visible && this.var_2890)
            {
               return;
            }
            ...
            this.var_560.room = _loc4_;
            this.var_560.showPopup(param2);
         }
      ...
      private function hilite(param1:IWindowContainer) : void
      {
         ...
         {
            _loc2_ = this.var_1604.tags[0];
            this.var_1604.color = this.getBgColor(_loc2_);
         }
      ...
      private function checkFastHorizontalMove(param1:WindowEvent) : void
      {
         ...
         var _loc3_:int = Math.abs(this.var_2889 - _loc2_.stageX);
         this.var_2889 = _loc2_.stageX;
         this.var_2890 = _loc3_ > 2;
      }
   }
}
