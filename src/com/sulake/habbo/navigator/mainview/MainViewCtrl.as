package com.sulake.habbo.navigator.mainview
{
   ...
   public class MainViewCtrl implements IUpdateReceiver, IDisposable
   {
      ...
      public static const const_1964:int = 3;
      ...
      private var var_953:PopularTagsListCtrl;
      
      private var var_954:GuestRoomListCtrl;
      
      private var var_1178:OfficialRoomListCtrl;
      
      private var var_266:ITabContextWindow;
      ...
      private var var_1454:IWindow;
      
      private var var_1177:IRegionWindow;
      ...
      private const const_971:Point = new Point(100,10);
      
      public function MainViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_953 = new PopularTagsListCtrl(this._navigator);
         this.var_954 = new GuestRoomListCtrl(this._navigator);
         this.var_1178 = new OfficialRoomListCtrl(this._navigator);
         this.var_505 = new Timer(300,1);
         this.var_505.addEventListener(TimerEvent.TIMER,this.onResizeTimer);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_505)
            {
               this.var_505.removeEventListener(TimerEvent.TIMER,this.onResizeTimer);
               this.var_505.reset();
               this.var_505 = null;
            }
            if(this.var_953)
      ...
      public function open() : void
      {
         ...
         {
            this.prepare();
            this.var_15.position = this.const_971;
            _loc1_ = true;
         }
         this.refresh();
      ...
      private function prepare() : void
      {
         ...
         this.var_266 = ITabContextWindow(this.var_15.findChildByName("tab_context"));
         if(!this.var_266)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _tabContext is null!");
         }
         this.var_181 = IWindowContainer(this.var_15.findChildByName("tab_content"));
         this.var_226 = IWindowContainer(this.var_15.findChildByName("custom_content"));
         this.var_211 = IWindowContainer(this.var_15.findChildByName("list_content"));
         this.var_260 = IWindowContainer(this.var_15.findChildByName("custom_footer"));
         this.var_1454 = this.var_15.findChildByName("loading_text");
         var _loc1_:IWindow = this.var_15.findChildByTag("close");
         _loc1_.procedure = this.onWindowClose;
         this.var_1177 = IRegionWindow(this.var_15.findChildByName("to_hotel_view"));
         if(!this.var_1177)
         {
            ErrorReportStorage.addDebugData("MainViewCtrl","prepare: _toHotelView is null!");
         }
         this.var_1177.procedure = this.onHotelView;
         this.refreshToHotelViewButton(false);
         this.var_15.procedure = this.onWindow;
         for each(_loc2_ in this._navigator.tabs.tabs)
         {
            _loc3_ = this.var_266.getTabItemByID(_loc2_.id);
            if(!_loc3_)
            {
         ...
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_913,false);
         this.var_15.scaler.setParamFlag(HabboWindowParam.const_1702,true);
      }
      ...
      public function refresh() : void
      {
         ...
         Util.moveChildrenToColumn(this.var_181,["custom_content","list_content"],this.var_226.y,8);
         this.var_211.height = this.var_211.height + _loc1_ - this.var_211.y - this.var_260.height + this.var_2469;
         Util.moveChildrenToColumn(this.var_181,["list_content","custom_footer"],this.var_211.y,0);
         this.var_2469 = this.var_260.height;
      ...
      {
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         var _loc2_:ISelectableWindow = this.var_266.selector.getSelected();
         if(_loc1_.button != _loc2_)
         {
            this.var_1818 = true;
            this.var_266.selector.setSelected(_loc1_.button);
         }
      }
      ...
      private function refreshCustomContent() : void
      {
         ...
         var _loc1_:Tab = this._navigator.tabs.getSelected();
         _loc1_.tabPageDecorator.refreshCustomContent(this.var_226);
         if(Util.hasVisibleChildren(this.var_226))
         {
      ...
      {
         this.refreshList(param1,param2,this.var_953,"popular_tags");
      }
      
      private function refreshOfficialRooms(param1:Boolean, param2:Boolean) : void
      {
         this.refreshList(param1,param2,this.var_1178,"official_rooms");
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         if(this.var_634 == const_1013)
         {
            _loc3_ = Math.min(1,Math.max(0,this.var_211.blend - _loc2_));
            this.var_211.blend = _loc3_;
            this.var_226.blend = !!this.var_1176 ? Number(_loc3_) : Number(1);
            this.var_260.blend = !!this.var_1176 ? Number(_loc3_) : Number(1);
            if(_loc3_ == 0)
            {
               this.var_634 = const_649;
            }
         }
         else if(this.var_634 == const_649)
         {
            if(this.var_1455 % 10 == 1)
            {
               this.var_1454.visible = !this.var_1454.visible;
            }
            ++this.var_1455;
            if(!this._navigator.data.isLoading())
            {
               this.var_634 = const_1012;
            }
         }
         else if(this.var_634 == const_1012)
         {
            this.refresh();
            this.var_634 = const_1380;
         }
         else
         {
      ...
      {
         if(param1.type != WindowEvent.const_40 || param2 != this.var_15)
         {
            return;
         }
      ...
      {
         this.refreshScrollbar(this.var_953);
      ...
      {
         this._navigator.refreshButton(this.var_1177,"icon_hotelview",!param1,null,0);
         this._navigator.refreshButton(this.var_1177,"icon_hotelview_reactive",param1,null,0);
      }
