package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_436:RoomInfoViewCtrl;
      
      private var var_1189:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_448:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2972:Dictionary;
      ...
      private var var_2510:RoomThumbnailRenderer;
      
      private var var_892:GuestRoomPasswordInput;
      
      private var var_292:GuestRoomDoorbell;
      
      private var var_1190:OfficialRoomEntryManager;
      
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         this.var_2511 = new Array();
         ...
         this.var_436 = new RoomInfoViewCtrl(this);
         this.var_1189 = new RoomCreateViewCtrl(this);
         this.var_2510 = new RoomThumbnailRenderer(this);
         this.var_892 = new GuestRoomPasswordInput(this);
         this.var_292 = new GuestRoomDoorbell(this);
         this.var_448 = new Tabs(this);
         this.var_1190 = new OfficialRoomEntryManager(this);
      }
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_343,HabboWindowStyle.const_44,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_436.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_130,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         if(param1.type == HabboToolbarEvent.const_36)
         {
            ...
            {
               this.var_436.handleToolbarEvent(param1);
            }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = this.var_184.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_306.startSearch(Tabs.const_229,Tabs.const_420,param1);
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_306.startSearch(Tabs.const_320,Tabs.const_261);
         this.var_448.getTab(Tabs.const_320).tabPageDecorator.tabSelected();
      }
