package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1160:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         ...
         this.var_618 = new Timer(100);
         this.var_618.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         this.var_47 = new Array();
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,104,"a"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,94,"b"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,36,"c"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,84,"d"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,80,"e"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,80,"f"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,416,"i"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,320,"j"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,448,"k"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,352,"l"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,384,"m"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_54,372,"n"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_45,80,"g"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_45,74,"h"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_45,416,"o"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_45,352,"p"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_45,304,"q"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_45,336,"r"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_45,748,"u"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_45,438,"v"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_47,540,"t"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_47,512,"w"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_47,396,"x"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_47,440,"y"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_47,456,"z"));
         this.var_47.push(new RoomLayout(HabboClubLevelEnum.const_47,208,"0"));
      }
      ...
      public function dispose() : void
      {
         if(this.var_618)
         {
            this.var_618.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_618.reset();
            this.var_618 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1160.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1777 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1777 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_181 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_63 = IItemListWindow(this.var_181.findChildByName("item_list"));
         ...
         var _loc3_:IWindow = this.var_181.findChildByTag("close");
         this.addMouseClickListener(_loc3_,this.onCancelButtonClick);
         this.var_1161 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_181.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc4_:Rectangle = Util.getLocationRelativeTo(this.var_181.desktop,this.var_181.width,this.var_181.height);
         this.var_181.x = _loc4_.x;
         this.var_181.y = _loc4_.y;
      }
      
      public function refresh() : void
      {
         this.var_1161.goBackToInitialState();
         this.var_1161.input.textBackgroundColor = 4294967295;
         this.var_1160 = this.var_47[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_69,HabboWindowStyle.const_30,HabboWindowParam.const_61,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         return Boolean(this.var_1161.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_181.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_181.findChildByName("back_button"));
      }
      ...
      {
         var _loc2_:String = this.var_1161.getText();
         var _loc3_:String = "model_" + this.var_1160.name;
