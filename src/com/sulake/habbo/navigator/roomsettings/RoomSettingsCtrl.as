package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_892:TextFieldManager;
      
      private var var_1101:TextFieldManager;
      
      private var var_1106:ICheckBoxWindow;
      
      private var var_1104:ICheckBoxWindow;
      
      private var var_1102:ICheckBoxWindow;
      
      private var var_585:ICheckBoxWindow;
      ...
      public function onRoomSettings(param1:RoomSettingsData) : void
      {
         ...
         this._active = true;
         this.var_1642 = true;
         this.var_411.roomSettingsRefreshNeeded();
      }
      ...
      {
         if(param1 != this.var_339 || this.var_1105 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1105 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1538)
         {
            this.var_721.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1663)
         {
            this.var_721.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1767)
         {
            this.var_1103.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1752)
         {
            this.setTagError(this.var_893,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_894,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1503)
         {
            this.setTagError(this.var_893,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            this.setTagError(this.var_894,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1763)
         {
            this.var_892.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
      ...
      private function clearErrors() : void
      {
         ...
         this.var_1103.clearErrors();
         this.var_893.clearErrors();
         this.var_894.clearErrors();
         this.var_892.clearErrors();
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_302,this.onDoorModePasswordSelect);
         ...
         this.var_721 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1103 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_893 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_894 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_892 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1101 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1106 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1104 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1102 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_585 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         ...
         this.var_1100 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_1643 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1368 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_245 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1107 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1369 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1369.mouseThreshold = 0;
         this.var_1369.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1107.visible = false;
         if(!this._inRoom)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_1643.visible = this._inRoom;
         if(this.var_720)
         {
            this.var_1100.visible = true;
            this.var_1368.visible = false;
            this.refreshFlatControllers();
            this.var_1100.height = Util.getLowestPoint(this.var_1100) + 4;
         }
         else
         {
            this.populateForm();
         ...
         this.var_1369.text = !!this.var_720 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this._thumbnailContainer.name,this.var_1099.name,this.var_1100.name,this.var_1368.name,this.var_1643.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_721.setText(_loc1_.name);
         this.var_1103.setText(_loc1_.description);
         this.var_892.setText("");
         this.var_1101.setText("");
         ...
         {
            case RoomSettingsData.const_198:
         ...
         this.changePasswordField(_loc1_.doorMode == RoomSettingsData.const_126);
         Logger.log("CATEGORY ID: " + _loc1_.categoryId);
         this.setCategorySelection(_loc1_.categoryId);
         this.refreshMaxVisitors(_loc1_);
         this.setTag(this.var_893,_loc1_.tags[0]);
         this.setTag(this.var_894,_loc1_.tags[1]);
         if(this.var_1106)
         {
            if(_loc1_.allowPets)
            {
               this.var_1106.select();
            }
            else
            {
               this.var_1106.unselect();
            }
         }
         if(this.var_1104)
         {
            ...
            {
               this.var_1104.select();
            }
            else
            {
               this.var_1104.unselect();
            }
         }
         if(this.var_1102)
         {
            ...
            {
               this.var_1102.select();
            }
            else
            {
               this.var_1102.unselect();
            }
         }
         if(this.var_585)
         {
            ...
            {
               this.var_585.unselect();
            }
            _loc6_ = 1;
            _loc7_ = 16777215;
            if(!this.hideWallsAllowed())
            {
               this.var_585.disable();
               _loc6_ = 0.5;
               _loc7_ = 8421504;
            }
            else
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_721.getText();
         _loc2_.description = this.var_1103.getText();
         var _loc3_:ISelectorWindow = this._window.findChildByName("doormode") as ISelectorWindow;
         var _loc4_:IWindow = _loc3_.getSelected();
         switch(_loc4_.name)
         {
            case "doormode_doorbell":
               _loc2_.doorMode = RoomSettingsFlatInfo.const_198;
               break;
         ...
         {
            _loc8_ = this.var_892.getText();
            _loc9_ = this.var_1101.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_892.clearErrors();
               this.var_1101.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1106.isSelected;
         _loc2_.allowFoodConsume = this.var_1104.isSelected;
         _loc2_.allowWalkThrough = this.var_1102.isSelected;
         _loc2_.hideWalls = this.var_585.isSelected;
         _loc2_.tags = new Array();
         this.addTag(this.var_893,_loc2_.tags);
         this.addTag(this.var_894,_loc2_.tags);
         this.clearErrors();
         this.var_1105 = _loc2_.roomId;
      ...
      private function onConfirmRoomDelete(param1:WindowMouseEvent, param2:int) : void
      {
         ...
         this._navigator.toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_182,HabboToolbarIconEnum.ROOMINFO));
      }
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow(param1,"",HabboWindowType.const_69,HabboWindowStyle.const_30,HabboWindowParam.const_61,new Rectangle(0,0,100,20)));
      }
