package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private static const const_1852:int = 10;
      ...
      private var var_684:RoomEventData;
      ...
      private var var_278:GuestRoomData;
      ...
      {
         return this.var_278 != null && !this._currentRoomOwner;
      }
      ...
      {
         var _loc2_:int = 0;
         this.var_2804 = param1.limit;
         this.var_1570 = param1.favouriteRoomIds.length;
         this._favouriteIds = new Dictionary();
      ...
      public function favouriteChanged(param1:int, param2:Boolean) : void
      {
         ...
         this.var_1570 += !!param2 ? 1 : -1;
      }
      
      public function isCurrentRoomFavourite() : Boolean
      {
         var _loc1_:int = this.var_278.flatId;
      ...
      {
         return this.var_1570 >= this.var_2804;
      }
