package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_626:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:AlertView = var_626[this.var_1071] as AlertView;
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
