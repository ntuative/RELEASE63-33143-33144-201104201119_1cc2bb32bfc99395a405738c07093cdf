package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_876:int = 0;
      
      protected var var_696:BitmapData;
      
      protected var var_2559:int;
      
      protected var var_1614:Boolean;
      
      protected var var_2123:Boolean;
      
      protected var var_2905:BitmapData;
      
      private const const_2078:int = 8947848;
      
      private const const_2077:int = 13421772;
      
      private const const_1816:Number = 1;
      
      private const const_1817:Number = 0.2;
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2906 == FurniModel.const_46)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1540));
         }
         else
         {
            _loc2_ = this._roomEngine.getWallItemIcon(this._type,this,this.var_2122);
         }
         if(_loc2_.id > 0)
         {
            if(param1)
      ...
      public function getTotalCount() : int
      {
         ...
         var _loc2_:int = 0;
         var _loc3_:* = null;
         if(this.category == FurniCategory.const_882)
         {
            _loc1_ = 0;
            _loc2_ = 0;
            while(_loc2_ < this._items.length)
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               this._window.blend = this.const_1817;
               _loc1_.blend = this.const_1817;
            }
            else
            {
               this._window.blend = this.const_1816;
               _loc1_.blend = this.const_1816;
            }
         }
         if(this.isSelected)
         {
         ...
         if(_loc5_)
         {
            if(this.var_2123 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_2905;
               _loc5_.visible = true;
            }
            else
            {
