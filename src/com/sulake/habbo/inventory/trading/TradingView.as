package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_1010:uint = 4284532064;
      
      private static const const_1009:uint = 2577770;
      ...
      private var var_628:ItemPopupCtrl;
      ...
      private var var_1809:IWindowContainer;
      
      private var var_209:Timer;
      
      private var var_946:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager, param6:IHabboSoundManager)
      {
         ...
         this.var_628 = new ItemPopupCtrl(_loc9_,this._assetLibrary);
      ...
      public function getWindowContainer() : IWindowContainer
      {
         if(this.var_71 == null)
         {
            this.var_71 = this.createNormalWindow();
         }
         if(this.var_1809 == null)
         {
            this.var_1809 = this.createMinimizedWindow();
         }
         if(!this.var_2456)
         {
            return this.var_71;
      ...
      {
         return this.var_71.findChildByTag("OWN_USER_GRID") as IItemGridWindow;
      }
      
      protected function getOtherUsersItemGrid() : IItemGridWindow
      {
         return this.var_71.findChildByTag("OTHER_USER_GRID") as IItemGridWindow;
      }
      ...
      public function updateUserInterface() : void
      {
         ...
         {
            this.updateActionState();
            _loc2_ = this.var_71.findChildByTag("OTHER_USER_NAME") as ITextWindow;
            if(_loc2_)
            {
               _loc2_.text = this.var_18.otherUserName;
            }
            _loc1_ = this.var_71.findChildByTag("OWN_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.ownUserAccepts ? uint(const_1010) : uint(const_1009);
            }
            _loc3_ = this.var_71.findChildByTag("OWN_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
            ...
            _loc1_ = this.var_71.findChildByTag("OTHER_USER_BORDER");
            if(_loc1_)
            {
               _loc1_.color = !!this.var_18.otherUserAccepts ? uint(const_1010) : uint(const_1009);
            }
            _loc3_ = this.var_71.findChildByTag("OTHER_USER_LOCK") as IBitmapWrapperWindow;
            if(_loc3_)
            {
               if(_loc3_.bitmap == null)
               {
      ...
      public function updateActionState() : void
      {
         ...
         if(this.var_71)
         {
            _loc1_ = this.var_71.findChildByName("button_accept");
            if(!_loc1_)
            {
               return;
            }
      ...
      {
         var _loc2_:ITextWindow = this.var_71.findChildByName("help_text") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
      }
      ...
      {
         var _loc2_:ITextWindow = this.var_71.findChildByName("info_text_0") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = this.var_71.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc3_)
         {
      ...
      {
         var _loc1_:ITextWindow = this.var_71.findChildByName("info_text_0") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = this.var_71.findChildByName("item_grid_0") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      {
         var _loc2_:ITextWindow = this.var_71.findChildByName("info_text_1") as ITextWindow;
         _loc2_.text = param1;
         _loc2_.visible = true;
         var _loc3_:IItemGridWindow = this.var_71.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc3_)
         {
            _loc3_.visible = false;
         }
      ...
      {
         var _loc1_:ITextWindow = this.var_71.findChildByName("info_text_1") as ITextWindow;
         _loc1_.visible = false;
         var _loc2_:IItemGridWindow = this.var_71.findChildByName("item_grid_1") as IItemGridWindow;
         if(_loc2_)
         {
            _loc2_.visible = true;
         }
      ...
      private function thumbEventProc(param1:WindowEvent, param2:IWindow, param3:Boolean) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc5_.category == FurniCategory.const_187)
            {
               _loc7_ = "${poster_" + _loc5_.stuffData + "_name}";
            }
            if(_loc5_.category == FurniCategory.const_1765)
            {
            ...
            if(_loc5_.category == FurniCategory.const_1239)
            {
               _loc7_ = this.getTraxSongFurniName(_loc4_,_loc7_,true,param2.id,param3);
            }
            this.var_628.updateContent(param2 as IWindowContainer,_loc7_,_loc6_,ItemPopupCtrl.const_625);
            this.var_628.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_628.hideDelayed();
         }
      }
         ...
         if(this.var_183.length > 0)
         {
            ...
            if(_loc5_.extra == param1.id)
            {
               if(_loc2_ && this.var_18.ownUserItems.getWithIndex(_loc4_) == _loc3_ || !_loc2_ && this.var_18.otherUserItems.getWithIndex(_loc4_) == _loc3_)
               {
                  ...
                  this.var_628.updateContent(_loc8_ as IWindowContainer,_loc6_,_loc7_,ItemPopupCtrl.const_625);
               }
            }
            else
            {
