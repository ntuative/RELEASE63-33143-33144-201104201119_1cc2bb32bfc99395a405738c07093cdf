package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      public static const const_625:int = 2;
      
      private static const const_979:int = 5;
      
      private static const const_1325:int = 250;
      ...
      {
         this.var_341 = new Timer(const_1325,1);
         this.var_340 = new Timer(const_1323,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         this._assets = param2;
         this.var_341.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
         this.var_340.addEventListener(TimerEvent.TIMER,this.onHideTimer);
         var _loc3_:BitmapDataAsset = this._assets.getAssetByName("popup_arrow_right_png") as BitmapDataAsset;
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_900 = _loc3_.content as BitmapData;
         }
         _loc3_ = this._assets.getAssetByName("popup_arrow_left_png") as BitmapDataAsset;
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_722 = _loc3_.content as BitmapData;
         }
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_341.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_341.stop();
            this.var_341 = null;
         }
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1324,param3.width),Math.min(const_1322,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         {
            case const_1284:
               this.var_80.x = -1 * this.var_80.width - const_979;
               break;
            case const_625:
               this.var_80.x = this._parent.width + const_979;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         {
            case const_1284:
               _loc2_.bitmap = this.var_900.clone();
               _loc2_.width = this.var_900.width;
               _loc2_.height = this.var_900.height;
               _loc2_.y = (this.var_80.height - this.var_900.height) / 2;
               _loc2_.x = this.var_80.width - 1;
               break;
            case const_625:
               _loc2_.bitmap = this.var_722.clone();
               _loc2_.width = this.var_722.width;
               _loc2_.height = this.var_722.height;
               _loc2_.y = (this.var_80.height - this.var_722.height) / 2;
               _loc2_.x = -1 * this.var_722.width + 1;
         }
         _loc2_.invalidate();
      }
