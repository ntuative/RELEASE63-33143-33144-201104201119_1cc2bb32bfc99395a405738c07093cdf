package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsView implements IInventoryView
   {
      ...
      private var var_69:AchievementsModel;
      ...
      public function AchievementsView(param1:AchievementsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:ISessionDataManager)
      {
         ...
         this.var_63 = IItemListWindow(this._view.getChildByName("achievements_itemlist"));
         this.var_446 = new Timer(1000,1);
         this.var_446.addEventListener(TimerEvent.TIMER,this.doBadgeRefresh);
         this.var_440.events.addEventListener(BadgeImageReadyEvent.const_158,this.onBadgeImageReady);
      }
      ...
      public function updateList() : void
      {
         ...
         var _loc1_:Array = this.var_69.getAchievements();
      ...
      {
         Logger.log("Got badge: " + param1.badgeId + ", " + this.var_446.running);
         this.var_1222[param1.badgeId] = param1.badgeImage;
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc4_:BitmapData = this.var_1222[param2.badgeId];
         if(_loc4_ == null)
         {
            _loc4_ = this.var_440.getBadgeImage(param2.badgeId);
            this.var_1222[param2.badgeId] = _loc4_;
         }
