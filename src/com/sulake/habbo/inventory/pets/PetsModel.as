package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsModel implements IInventoryModel
   {
      ...
      {
         if(this.var_406.add(param1.id,param1))
         {
      ...
      {
         if(param1 == InventoryCategory.const_150 && this._controller.isVisible)
         {
      ...
      public function placePetToRoom(param1:int, param2:Boolean = false) : void
      {
         ...
         {
            this.var_1900 = this._roomEngine.initializeRoomObjectInsert(_loc3_.id,RoomObjectCategoryEnum.const_34,RoomObjectTypeEnum.const_216,_loc3_.figureString);
      ...
      {
         var _loc2_:* = null;
         for each(_loc2_ in this.var_406)
         {
            if(_loc2_.id == param1)
            {
               return _loc2_;
      ...
      public function onObjectPlaced(param1:Event) : void
      {
         ...
         if(this.var_1900 && param1.type == RoomEngineObjectEvent.const_171)
         {
