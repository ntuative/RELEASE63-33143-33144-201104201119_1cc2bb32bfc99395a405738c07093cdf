package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private var var_69:PetsModel;
      
      private var _disposed:Boolean = false;
      
      private var var_271:IItemGridWindow;
      ...
      private var var_391:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_271 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_391);
      }
      
      public function removePet(param1:int) : void
      {
         var _loc2_:PetsGridItem = this.var_691.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         this.var_271.removeGridItem(_loc2_.window);
      ...
      {
         if(this.var_691 == null || this.var_691.length == 0)
         {
            this.updatePreview();
            return;
         }
         this.setSelectedGridItem(this.var_691.getWithIndex(0));
      }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(this.var_691.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            this.var_271.addGridItem(_loc2_.window);
            this.var_691.add(param1.id,_loc2_);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_271.removeGridItems();
         this.var_691.reset();
         var _loc1_:Map = this.var_69.pets;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_391.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_69.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_57)
         {
            ...
            {
               case "tab_floor":
                  this.var_69.switchCategory(FurniModel.const_46);
                  break;
               case "tab_wall":
                  this.var_69.switchCategory(FurniModel.const_51);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_391 != null)
         {
            this.var_391.setSelected(false);
         }
         this.var_391 = param1;
         if(this.var_391 != null)
         {
            this.var_391.setSelected(true);
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_69.roomSession != null)
         {
            _loc8_ = this.var_69.roomSession.arePetsAllowed;
            _loc9_ = this.var_69.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {
