package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_42:
               this.var_1560.setSelectedGridItem(this);
               this.var_1559 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1559 = false;
                  this.var_1560.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1374.color = !!this._isSelected ? uint(this.const_2078) : uint(this.const_2077);
      }
