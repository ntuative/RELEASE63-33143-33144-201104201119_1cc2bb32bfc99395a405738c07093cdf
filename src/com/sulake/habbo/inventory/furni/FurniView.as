package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniView implements IInventoryView, IGetImageListener
   {
      ...
      private const const_2138:int = 0;
      
      private const const_962:int = 1;
      
      private const const_1846:int = 2;
      
      private const const_1844:int = 3;
      
      private const const_1845:int = 42;
      
      private const const_1847:int = 120;
      ...
      private var var_775:MarketplaceModel;
      ...
      public function FurniView(param1:FurniModel, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboSoundManager)
      {
         ...
         this.var_460.add(FurniModel.const_46,new FurniGridView(this.var_69,FurniModel.const_46,this._windowManager,this._assetLibrary,this._roomEngine));
         this.var_460.add(FurniModel.const_51,new FurniGridView(this.var_69,FurniModel.const_51,this._windowManager,this._assetLibrary,this._roomEngine));
      ...
      private function showCategoryGrid(param1:String = null) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_460.getValue(this.var_461);
         if(_loc3_)
         {
      ...
      {
         var _loc2_:int = 0;
         var _loc1_:Array = this.var_69.getCategoryContent(this.var_461);
         ...
         {
            _loc2_ = this.const_1846;
         }
         else
         {
            _loc2_ = this.const_1844;
         }
         if(this.var_2649 == _loc2_)
         {
            return;
         }
         this.var_2649 = _loc2_;
      ...
      public function clearViews() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         var _loc1_:Array = [FurniModel.const_46,FurniModel.const_51];
         var _loc4_:int = 0;
         while(_loc4_ < _loc1_.length)
         {
            _loc2_ = _loc1_[_loc4_];
            _loc3_ = this.var_460.getValue(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.clearGrid();
            }
      ...
      public function updateItem(param1:String, param2:GroupItem, param3:int) : void
      {
         ...
         var _loc4_:FurniGridView = this.var_460.getValue(param1);
         if(_loc4_ == null)
         {
            return;
         }
      ...
      public function addItemToBottom(param1:String, param2:GroupItem) : void
      {
         ...
         var _loc3_:FurniGridView = this.var_460.getValue(param1);
         if(_loc3_ == null)
         {
            return;
         }
      ...
      public function updateActionView() : void
      {
         ...
         _loc4_ = this.var_69.getGroupItemInIndex(_loc3_,this.var_461);
         if(_loc3_ > -1 && _loc4_ != null && _loc4_.peek() != null)
         {
            ...
            _loc18_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_324);
            ...
            if(_loc5_.category == FurniCategory.const_290)
            {
         ...
         if(_loc11_)
         {
            if(_loc1_ && this.var_775 && this.var_775.isEnabled && _loc5_.sellable)
            {
               _loc11_.enable();
            }
            else
      ...
      private function setPreviewImage(param1:BitmapData) : void
      {
         ...
         if(_loc3_ > this.const_1847)
         {
            _loc3_ = this.const_1847;
         }
         else if(_loc3_ < this.const_1845)
         {
            _loc3_ = this.const_1845;
         }
         else
         {
         ...
         else if(param1.type == WindowEvent.const_57)
         {
            switch(param2.name)
            {
               ...
               case "tab_wall":
                  ...
                  break;
               case "tab_pets":
                  this.switchCategory(FurniModel.const_370);
            }
         }
      }
