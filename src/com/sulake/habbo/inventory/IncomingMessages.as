   ...
   public class IncomingMessages
   {
      ...
      public function onFurniListInsert(param1:IMessageEvent) : void
      {
         ...
         while(_loc7_ < _loc6_.length)
         {
            ...
            {
               _loc4_ = new FloorItem(_loc5_.stripId,_loc5_.classId,_loc5_.objId,_loc5_.category,_loc5_.isGroupable,_loc5_.method_2,_loc5_.isRecyclable,_loc5_.isSellable,_loc5_.stuffData,_loc5_.extra,_loc5_.expiryTime,0,0,0,_loc5_.slotId,_loc5_.songId);
            }
            else
            {
               ...
               _loc4_ = new WallItem(_loc5_.stripId,_loc5_.classId,_loc5_.objId,_loc5_.category,_loc5_.isGroupable,_loc5_.method_2,_loc5_.isRecyclable,_loc5_.isSellable,_loc5_.stuffData,_loc5_.extra);
            }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_757);
         _loc2_.refreshViews();
      ...
      public function onClubStatus(param1:IMessageEvent) : void
      {
         ...
         {
            this._inventory.setClubStatus(_loc2_.periodsSubscribedAhead,_loc2_.daysToPeriodEnd,_loc2_.hasEverBeenMember,_loc2_.method_1);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_346);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_407);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         this._inventory.toggleInventorySubPage(InventorySubCategory.const_313);
      ...
      private function onTradingItemList(param1:IMessageEvent) : void
      {
         ...
         while(_loc10_ < _loc5_)
         {
            ...
            if(_loc9_.category == FurniCategory.const_187)
            {
            ...
            else
            {
               ...
               if(_loc6_ == null)
               {
                  _loc6_ = _loc11_.createNewGroupItemTemplate(_loc7_,FurniModel.const_51,_loc9_.category,_loc9_.stuffData);
                  _loc3_.add(_loc8_,_loc6_);
               }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_150);
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         this._inventory.setInventoryCategoryInit(InventoryCategory.const_411);
      ...
      {
         var _loc2_:* = null;
         if(this._inventory.isInventoryCategoryInit(InventoryCategory.const_411))
         {
