package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesView implements IInventoryView
   {
      ...
      private var var_1229:IItemGridWindow;
      
      private var var_1230:IItemGridWindow;
      ...
      public function BadgesView(param1:BadgesModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         this.var_1229 = this._view.findChildByName("inactive_items") as IItemGridWindow;
         this.var_1229.procedure = this.inactiveGridEventProc;
         this.var_1230 = this._view.findChildByName("active_items") as IItemGridWindow;
         this.var_1230.procedure = this.activeGridEventProc;
      }
      ...
      private function updateListViews() : void
      {
         ...
         this.var_1229.removeGridItems();
         this.var_1230.removeGridItems();
         var _loc1_:Array = this.var_69.getBadges(0);
         var _loc3_:int = 0;
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(!_loc2_.isInUse)
            {
               this.var_1229.addGridItem(_loc2_.window);
               _loc2_.window.procedure = this.inactiveGridEventProc;
            }
            _loc3_++;
         }
         var _loc4_:Array = this.var_69.getBadges(1);
         _loc3_ = 0;
         while(_loc3_ < _loc4_.length)
         {
            _loc2_ = _loc4_[_loc3_] as Badge;
            this.var_1230.addGridItem(_loc2_.window);
      ...
      private function updateActionView() : void
      {
         ...
         else
         {
            ...
            _loc3_ = this.var_69.getBadges(1);
      ...
      private function inactiveGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc3_ = this.var_1229.getGridItemIndex(param1.window);
      ...
      private function activeGridEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = this.var_1230.getGridItemIndex(param1.window);
