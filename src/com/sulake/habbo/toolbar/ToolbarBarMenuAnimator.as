package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_218:Boolean = true;
      
      private static const const_1401:Number = 25;
      
      private static const const_1403:Number = 90;
      
      private static const const_1041:int = 50;
      
      private static const const_1460:int = 50;
       
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_1552:IToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:IToolbarView)
      {
         ...
         this.var_669 = new Object();
         this.var_671 = new Array();
         this.var_670 = new Array();
         super();
         this._windowManager = param1;
         this.var_1552 = param2;
         this.var_834 = new Timer(const_1401);
         this.var_834.addEventListener(TimerEvent.TIMER,this.animationUpdate);
      }
      ...
      public function refresh() : void
      {
         ...
         {
            this.repositionWindow(this.var_385[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_1041 + this._toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_1041 || param1.desktop.height - param1.y < const_1460;
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = this.var_1552.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
            ...
            this.var_385.push(_loc3_.menuId);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:Point = this.var_1552.getIconLoc(param1.iconId);
      ...
      {
         return this.var_671[this.var_670.indexOf(param1)];
      }
      
      private function getWindowMenuId(param1:String) : String
      {
         return this.var_670[this.var_671.indexOf(param1)];
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         var _loc3_:int = this.var_670.indexOf(param2);
         if(_loc3_ > -1)
         {
            this.var_670.splice(_loc3_,1);
            this.var_671.splice(_loc3_,1);
         }
         this.var_671.push(param1.name);
         this.var_670.push(param2);
         param1.addEventListener(WindowEvent.const_276,this.windowEventListener);
         param1.addEventListener(WindowEvent.const_186,this.windowEventListener);
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(this.var_669[_loc3_] == null)
            {
               this.var_669[_loc3_] = new Array();
            }
            if(this.var_669[_loc3_].indexOf(param1) < 0)
            {
               this.var_669[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         if(this.var_385.indexOf(param1) > -1)
         {
            if(const_218)
            {
            ...
            else
            {
               ...
               this.var_385.splice(this.var_385.indexOf(param1),1);
            }
         }
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_671.length)
         {
            if(this.var_671[_loc2_] == param1.window.name)
            {
               _loc3_ = this.var_670[_loc2_];
               if(this.var_669[_loc3_] != null)
               {
                  _loc4_ = 0;
                  while(_loc4_ < this.var_669[_loc3_].length)
                  {
                     this.repositionWindow(this.var_669[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
      ...
      private function animationUpdate(param1:TimerEvent) : void
      {
         ...
         if(this.var_385.length == 0)
         {
            this.var_834.stop();
         }
         var _loc7_:int = 0;
         while(_loc7_ < this.var_385.length)
         {
            _loc2_ = this._itemList[this.var_385[_loc7_]];
            if(_loc2_.active)
            {
