package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return this.var_1441.indexOf(param1) > -1;
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = this.var_2434.elements("menu");
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = this.var_761.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = this.getIconById(param1);
            if(_loc3_ != null)
      ...
      {
         return this.var_761.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < this.var_1440.length)
         {
            _loc2_ = this.var_761.indexOf(this.var_1440[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = this.var_301[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(this.var_1258 + _loc3_);
                  _loc3_ += this.var_1442;
               }
            }
            _loc4_++;
         }
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return this.var_301[this.var_761.indexOf(param1)];
      }
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         this.var_44.addChild(_loc2_.window);
