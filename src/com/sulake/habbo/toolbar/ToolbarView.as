package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView implements IToolbarView
   {
      ...
      private var var_492:String = "LEFT";
      
      private var var_152:Number = 50;
      
      private var var_1126:Boolean = true;
      
      private var var_1127:Number = 1;
      
      private var _toolbarMarginBottom:Number = 0;
      
      private var _toolbarMinGroupMargin:Number = 15;
      
      private var var_1696:Number = 5;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         this.var_152 = this._window.width;
         this.var_222 = param2.createWindow("extrabar_container_window","",HabboWindowType.const_69,HabboWindowStyle.const_1166,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1126 = String(_loc9_.relocate_by_drag.@state) == "true";
         if(this.var_1126)
         {
         ...
         this.var_1127 = _loc9_.toolbar.@margin_top;
         this._toolbarMarginBottom = _loc9_.toolbar.@margin_bottom;
         this._toolbarMinGroupMargin = _loc9_.toolbar.@min_group_margin;
         this.var_1696 = _loc9_.toolbar.@margin_to_extrabar;
         this.var_328 = new ToolbarBarMenuAnimator(param2,this);
         var _loc10_:XMLList = XMLList(_loc9_.toolbar).children();
         var _loc11_:XMLList = XMLList(_loc9_.extras).children();
         this.createGroupsFromXmlList(_loc10_,this.var_249,param2,param3,param4,this._window,this.var_328);
         this.createGroupsFromXmlList(_loc11_,this.var_605,param2,param3,param4,this.var_222,this.var_328);
         this.alignWindows();
      }
      ...
      private function createGroupsFromXmlList(param1:XMLList, param2:Array, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IConnection, param6:IWindowContainer, param7:ToolbarBarMenuAnimator) : void
      {
         ...
         while(_loc11_ < param1.length())
         {
            ...
            _loc10_ = new ToolbarIconGroup(param3,param4,param5,_loc11_,this._events,param6,param7,this.var_152,this._config);
      ...
      {
         var _loc1_:* = null;
         while(this.var_249.length > 0)
         {
            _loc1_ = this.var_249.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(this.var_605.length > 0)
         {
            _loc1_ = this.var_605.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_152,this.var_492,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_492);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_152,this.var_492);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_152,this.var_492);
         }
      }
      ...
      {
         this.alignWindows();
         var _loc2_:HabboToolbarEvent = new HabboToolbarEvent(HabboToolbarEvent.const_745);
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_605.length)
         {
            _loc2_ = this.var_605[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         if(this._window == null || this.var_222 == null)
         {
            return;
         }
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_222.x = this.var_152 + this.var_1696;
               this.var_222.y = 0;
               _loc4_ = this._window.height;
               break;
            case "RIGHT":
               this._window.width = this.var_152;
               this._window.height = _loc1_.height;
               this._window.x = _loc1_.width - this.var_152;
               this._window.y = 0;
               this.var_222.x = 0;
               this.var_222.y = 0;
               _loc4_ = this._window.height;
            ...
            case "TOP":
               ...
               this._window.height = this.var_152;
               this._window.x = 0;
               this._window.y = 0;
               this.var_222.x = 0;
               this.var_222.y = this.var_152 + this.var_1696;
            ...
            case "BOTTOM":
               ...
               this._window.height = this.var_152;
               this._window.x = 0;
               this._window.y = _loc1_.height - this.var_152;
               this.var_222.x = 0;
               this.var_222.y = 0;
               _loc4_ = this._window.width;
         }
         _loc4_ -= this._toolbarMarginBottom;
         _loc4_ -= this.var_1127;
         var _loc5_:* = 0;
         _loc2_ = 0;
         ...
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1127;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_249.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.height - _loc5_ * _loc8_ - this.var_1127 - this._toolbarMarginBottom) / (this.var_249.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this._toolbarMinGroupMargin,(this._window.width - _loc5_ * _loc8_ - this.var_1127 - this._toolbarMarginBottom) / (this.var_249.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_249.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_492;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_605.length)
         {
            _loc3_ = this.var_605[_loc2_];
            if(_loc3_ != null)
            {
      ...
      private function getTargetOrientationFromXY(param1:Number, param2:Number) : String
      {
         ...
         if(param1 >= _loc3_.width - this.var_152)
         {
            return "RIGHT";
         }
         if(param2 <= this.var_152)
         {
            return "TOP";
         }
         if(param2 >= _loc3_.height - this.var_152)
         {
            return "BOTTOM";
         }
         return null;
