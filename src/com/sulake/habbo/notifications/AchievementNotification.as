package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1833:String = "badge_bg_001_png";
      
      private const const_2075:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this.var_1492 = param7;
         this.var_2197 = param5;
         this.var_1890 = param6;
         this.var_62 = param10;
         this._assets = param8;
         this.var_440 = param13;
         this._communication = param12;
         param13.events.addEventListener(BadgeImageReadyEvent.const_158,this.onBadgeImageReady);
         ...
         this._window.center();
         this.var_2616 = this.var_62.getBadgeName(this.var_308);
         this.var_2617 = this.var_62.getBadgeDesc(this.var_308);
         this.var_2615 = this.var_62.getAchievementNameForFacebook(this.var_308,this.var_440.userName,this.var_440.realName,this.var_1491);
         this.var_2618 = this.var_62.getAchievementDescForFacebook(this.var_308,this.var_440.userName,this.var_440.realName,this.var_1491);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2613 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this.var_62.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1760.toString());
         this.var_62.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1492.toString());
         this.var_62.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1492.toString());
         var _loc15_:IWindow = this._window.findChildByName("level_reward_points");
         var _loc16_:String = "notifications.text.achievement.reward." + this.var_1890;
         var _loc17_:String = this.var_1890 == 0 ? "pixels" : "activitypoints";
         this.var_62.registerParameter(_loc16_,_loc17_,"" + this.var_2197);
         _loc15_.caption = this.var_62.getKey(_loc16_);
         this._window.findChildByName("achievement_info").caption = this._desc;
         this.setBadge(param13.getBadgeImage(param1),this.const_1833);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_2075) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1492 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_308,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_308,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_308,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this.var_62.registerParameter(param1,"badge_name",this.var_2616);
         this.var_62.registerParameter(param1,"badge_desc",this.var_2617);
         this.var_62.registerParameter(param1,"badge_name_fb",this.var_2615);
         this.var_62.registerParameter(param1,"badge_desc_fb",this.var_2618);
         this.var_62.registerParameter(param1,"level",this.var_1491.toString());
         this.var_62.registerParameter(param1,"name",this.var_440.userName);
         return this.var_62.registerParameter(param1,"realname",this.var_440.realName);
      }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_440.events.removeEventListener(BadgeImageReadyEvent.const_158,this.onBadgeImageReady);
            this.var_440 = null;
         }
         if(this._window != null)
         {
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_308)
         {
            return;
         }
         this.setBadge(param1.badgeImage,this.const_1833);
      }
      
      public function requestPostDialog(param1:String) : void
      {
         HabboWebTools.facebookAchievementPost(this.var_308,this._feedTitleFb,this.var_2613,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2614));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_308,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_308,"client.skip_post"));
               this.dispose();
               return;
         }
      }
