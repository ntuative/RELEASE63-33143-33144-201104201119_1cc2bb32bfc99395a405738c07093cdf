package com.sulake.habbo.notifications
{
   ...
   public class HabboNotificationViewManager implements IUpdateReceiver
   {
      ...
      private static const const_1442:int = 78;
      ...
      public function showItem(param1:HabboNotificationItem) : Boolean
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(this._assetLibrary.getAssetByName("layout_notification_xml"),this._windowManager,this.var_2745,this.var_429,this._toolbar,param1);
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < this.var_189.length)
         {
            ...
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_548 + const_1037;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      {
         var _loc4_:* = null;
         this.var_1543 = const_1442 + param1;
         var _loc2_:int = this.var_1543;
         var _loc3_:int = 0;
         while(_loc3_ < this.var_189.length)
         {
            _loc4_ = this.var_189[_loc3_] as HabboNotificationItemView;
            _loc4_.reposition(_loc2_);
            _loc2_ = _loc4_.verticalPosition + HabboNotificationItemView.const_548 + const_1037;
            _loc3_++;
         }
      }
   }
