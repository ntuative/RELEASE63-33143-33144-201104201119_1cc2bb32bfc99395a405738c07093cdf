package com.sulake.core.window.graphics
{
   ...
   public class BitmapSkinParser
   {
      ...
      public static const const_111:String = "active";
      
      public static const const_82:String = "focused";
      ...
      public static const const_84:String = "disabled";
      
      public static const const_73:String = "locked";
      ...
      protected static function parseLayoutEntity(param1:XML, param2:Map) : SkinLayoutEntity
      {
         ...
         if(_loc8_.length() > 0)
         {
            ...
            {
               case "fixed":
                  _loc5_.var_397 = SkinLayoutEntity.const_480;
                  break;
               case "move":
                  _loc5_.var_397 = SkinLayoutEntity.const_310;
                  break;
               case "strech":
                  _loc5_.var_397 = SkinLayoutEntity.const_459;
                  break;
               case "tiled":
                  _loc5_.var_397 = SkinLayoutEntity.const_307;
                  break;
               case "center":
                  _loc5_.var_397 = SkinLayoutEntity.const_1169;
            }
            ...
            {
               case "fixed":
                  _loc5_.var_398 = SkinLayoutEntity.const_480;
                  break;
               case "move":
                  _loc5_.var_398 = SkinLayoutEntity.const_310;
                  break;
               case "strech":
                  _loc5_.var_398 = SkinLayoutEntity.const_459;
                  break;
               case "tiled":
                  _loc5_.var_398 = SkinLayoutEntity.const_307;
                  break;
               case "center":
                  _loc5_.var_398 = SkinLayoutEntity.const_1169;
            }
         }
      ...
      protected static function parseState(param1:ISkinRenderer, param2:XML, param3:Dictionary, param4:Map) : void
      {
         ...
         switch(_loc5_)
         {
            case BitmapSkinParser.const_111:
               _loc10_ = 0;
               break;
