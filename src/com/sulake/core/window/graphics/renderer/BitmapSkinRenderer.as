package com.sulake.core.window.graphics.renderer
{
   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_878:Dictionary;
      
      private var var_262:Matrix;
      ...
      {
         super(param1);
         this.var_877 = new Dictionary(false);
         this.var_878 = new Dictionary(false);
         this.var_262 = new Matrix();
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            this.var_262 = null;
            this.var_771 = null;
            for(_loc1_ in this.var_877)
            {
               _loc2_ = this.var_877[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_877[_loc1_];
            }
            this.var_877 = null;
            for(_loc1_ in this.var_878)
            {
               _loc2_ = this.var_878[_loc1_] as BitmapData;
               _loc2_.dispose();
               delete this.var_878[_loc1_];
            }
            this.var_878 = null;
         }
      }
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         var _loc7_:ISkinLayout = var_469[param4];
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_771.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_771.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_771.blueMultiplier = (param1.color & 255) / 255;
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_771);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_397 == SkinLayoutEntity.const_310)
                  {
                     var_28.x += _loc14_;
                  }
                  else if(_loc10_.var_397 == SkinLayoutEntity.const_459)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_397 == SkinLayoutEntity.const_307)
                  {
                     _loc12_ = true;
                     var_28.right += _loc14_;
                     if(true)
                  ...
                  if(_loc10_.var_398 == SkinLayoutEntity.const_310)
                  {
                     var_28.y += _loc15_;
                  }
                  else if(_loc10_.var_398 == SkinLayoutEntity.const_459)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_398 == SkinLayoutEntity.const_307)
                  {
                     _loc13_ = true;
                     var_28.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_398 == SkinLayoutEntity.const_307 || _loc10_.var_397 == SkinLayoutEntity.const_307)
                  {
                  ...
                  {
                     this.var_262.a = var_28.width;
                     this.var_262.d = var_28.height;
                     this.var_262.tx = var_28.x;
                     this.var_262.ty = var_28.y;
                     ALPHA.alphaMultiplier = (_loc19_.getPixel32(0,0) >>> 24) / 255;
                     _loc6_.draw(_loc18_,this.var_262,ALPHA);
                  }
                  else
                  {
                     this.var_262.a = 0 / _loc18_.width;
                     this.var_262.d = 0 / _loc18_.height;
                     this.var_262.tx = 0;
                     this.var_262.ty = 0;
                     _loc31_ = new BitmapData(var_28.width,var_28.height,_loc18_.transparent);
                     _loc31_.draw(_loc18_,this.var_262);
                     _loc32_ = new BitmapData(var_28.width,var_28.height,true,0);
                     _loc32_.draw(_loc19_,this.var_262,null);
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_397 == SkinLayoutEntity.const_310)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_398 == SkinLayoutEntity.const_310)
               {
      ...
      private function getBitmapFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc4_:BitmapData = this.var_877[_loc3_];
         if(_loc4_ == null)
         {
      ...
      private function getAlphaFromCache(param1:ISkinTemplate, param2:String) : BitmapData
      {
         ...
         var _loc6_:* = null;
         var _loc3_:String = param2 + "@" + param1.name;
         var _loc4_:BitmapData = this.var_878[_loc3_];
         if(_loc4_ == null)
         {
            _loc5_ = param1.getChildByName(param2) as ISkinTemplateEntity;
            if(_loc5_ == null)
