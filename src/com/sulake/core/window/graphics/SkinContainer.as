package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      private static const const_1046:uint = 8;
      
      private static const const_1479:String = "skin";
      
      private static const const_1474:String = "bitmap";
      
      private static const const_1477:String = "fill";
      
      private static const const_1475:String = "text";
      
      private static const const_1476:String = "label";
      
      private static const const_1478:String = "shape";
      ...
      private var var_2834:Dictionary;
      
      private var var_2832:Dictionary;
      
      private var var_2833:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         this.var_1051 = new Dictionary();
         this.var_1050 = new Dictionary();
         this.var_2046 = new Dictionary();
         this.var_2834 = new Dictionary();
         TypeCodeTable.fillTables(this.var_2046,this.var_2834);
         this.var_2832 = new Dictionary();
         this.var_2833 = new Dictionary();
         StateCodeTable.fillTables(this.var_2832,this.var_2833);
         this.var_463 = new Dictionary();
         this.var_463[const_1479] = BitmapSkinRenderer;
         this.var_463[const_1474] = BitmapDataRenderer;
         this.var_463[const_1477] = FillSkinRenderer;
         this.var_463[const_1475] = TextSkinRenderer;
         this.var_463[const_1476] = LabelRenderer;
         this.var_463[const_1478] = ShapeSkinRenderer;
         this.var_463[RENDERER_TYPE_UNKNOWN] = SkinRenderer;
         this.var_463[RENDERER_TYPE_NULL] = NullSkinRenderer;
         if(var_334 == null)
         {
            var_334 = new Array();
            var_334.push(WindowState.const_73);
            var_334.push(WindowState.const_84);
            var_334.push(WindowState.const_89);
            var_334.push(WindowState.const_55);
            var_334.push(WindowState.const_90);
            var_334.push(WindowState.const_82);
            var_334.push(WindowState.const_111);
            var_334.push(WindowState.const_102);
         }
         if(param1 != null)
         {
            ...
            if(_loc4_ > 0)
            {
               ...
               while(_loc18_ < _loc4_)
               {
                  ...
                  _loc17_.var_2895 = !!_loc5_.@treshold[0] ? uint(uint(_loc5_.@treshold[0])) : uint(10);
                  ...
                  this.addSkinRenderer(this.var_2046[_loc7_],uint(_loc8_),_loc14_,_loc17_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         if(this.var_1051[param1] == null)
         {
            this.var_1051[param1] = new Array(const_1046);
         }
         this.var_1051[param1][param2] = param3;
         if(this.var_1050[param1] == null)
         {
            this.var_1050[param1] = new Array(const_1046);
         }
         this.var_1050[param1][param2] = param4;
      }
      
      public function getSkinRendererByTypeAndStyle(param1:uint, param2:uint) : ISkinRenderer
      {
         var _loc4_:* = null;
         var _loc3_:Array = this.var_1051[param1];
         if(_loc3_)
         {
            _loc4_ = _loc3_[param2];
            if(!_loc4_ && param2 != WindowStyle.const_167)
            {
               _loc4_ = _loc3_["null"];
            }
         }
