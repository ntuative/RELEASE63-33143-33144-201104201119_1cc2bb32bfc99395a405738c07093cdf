package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_2016:uint = 64;
      
      public static const const_1925:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_575:uint = 0;
      
      protected static var var_332:uint = 0;
       
      
      protected var var_219:DisplayObjectContainer;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               while(this.var_219.numChildren > 0)
               {
                  this.var_219.removeChildAt(0);
               }
            }
            this.var_219 = null;
            while(numChildren > 0)
      ...
      public function setDrawRegion(param1:Rectangle, param2:Boolean, param3:Rectangle) : void
      {
         ...
         if(param3)
         {
            if(!this.var_197)
            {
               this.var_197 = new Shape();
               this.var_197.visible = false;
               this.var_197.cacheAsBitmap = true;
               super.addChild(this.var_197);
            }
            this.var_197.graphics.clear();
            this.var_197.graphics.beginFill(255);
            this.var_197.graphics.drawRect(param3.x,param3.y,param3.width,param3.height);
            this.var_197.graphics.endFill();
            this.getDisplayObject().mask = this.var_197;
         }
         else if(this.var_197)
         {
            super.removeChild(this.var_197);
            this.var_197.graphics.clear();
            this.var_197 = null;
         ...
         if(this.var_875)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_332 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_2121,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_2121,16777215);
                  }
                  var_332 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_875)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_332 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this.var_219 == null)
         {
            this.var_219 = new Sprite();
            this.var_219.name = this.name + " - Child Container";
            this.var_219.mouseEnabled = false;
      ...
      {
         return this.var_219 != null ? int(this.var_219.numChildren) : 0;
      }
