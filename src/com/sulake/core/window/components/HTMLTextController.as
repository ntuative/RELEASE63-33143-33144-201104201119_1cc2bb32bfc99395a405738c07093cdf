package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_921:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
       
      
      private var var_742:String;
      
      private var var_1150:String = null;
      
      private var var_1758:StyleSheet = null;
      ...
      {
         this.var_742 = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private static function setHtmlStyleSheetString(param1:HTMLTextController, param2:String) : void
      {
         ...
         if(param1.var_1150 == param2)
         {
            return;
         }
         param1.var_1150 = param2;
         param1.var_1758 = null;
         if(param1.var_1150 != null)
         {
            _loc3_ = new StyleSheet();
            _loc3_.parseCSS(param1.var_1150);
            param1.var_1758 = _loc3_;
         }
      }
      ...
      {
         if(PropertyDefaults.const_739.indexOf(param1) > -1)
         {
            this.var_742 = param1;
         }
      }
      ...
      {
         return this.var_742 == LinkTarget.const_30 ? defaultLinkTarget : this.var_742;
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_20);
            _field.styleSheet = this.var_1758;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1238)
            {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_742 != PropertyDefaults.HTML_LINK_TARGET_VALUE)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_738,this.var_742,PropertyStruct.const_56,true,PropertyDefaults.const_739));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1572);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_738)
            {
               this.var_742 = _loc2_.value as String;
               break;
            }
