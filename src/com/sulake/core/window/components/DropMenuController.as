package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow, ITouchAwareWindow
   {
      ...
      protected static const const_435:String = "_DROPMENU_TITLETEXT";
      ...
      private var var_617:int = -1;
      
      private var var_926:Boolean = false;
      
      private var var_180:DropMenuController;
      ...
      {
         if(param1 > this.var_255.lenght - 1)
         {
            throw new Error("Menu selection index out of range!");
         }
         var _loc2_:WindowEvent = WindowEvent.allocate(WindowEvent.const_302,this,null,true);
      ...
      {
         if(this.var_180 != null && !this.var_180.disposed)
         {
            this.var_180.destroy();
            this.var_180 = null;
         }
         super.dispose();
      }
      ...
      {
         return getChildByName(DropMenuController.const_435) as ILabelWindow;
      }
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         if(this.var_180 == null || this.var_180.disposed)
         {
            this.var_180 = context.create(name + "::submenu","",WindowType.const_620,var_79,0 | 0,_loc1_,this.subMenuEventProc,null,0,null,[WindowController.TAG_EXCLUDE]) as DropMenuController;
         }
         else
         {
            this.var_180.setGlobalRectangle(_loc1_);
         }
      ...
      override public function populate(param1:Array) : void
      {
         ...
         {
            this.var_255.push(param1[_loc2_]);
            _loc2_++;
         }
         this.var_926 = true;
         this.closeMenuView();
      ...
      public function getMenuItemIndex(param1:IDropMenuItemWindow) : int
      {
         ...
         if(_loc2_ == -1)
         {
            ...
            {
               _loc2_ = this.var_180.getMenuItemIndex(param1);
            }
         }
         return _loc2_;
      }
      ...
      protected function openMenuView() : void
      {
         if(!this.var_926)
         {
            if(this.open())
            {
               if(this.var_255.length)
               {
                  this.populateMenuItemContainer(this.var_255,this.getSubMenu(),this.subMenuEventProc);
                  this.var_926 = true;
               }
            }
         }
      ...
      protected function closeMenuView() : void
      {
         if(this.close())
         {
            ...
            this.var_926 = false;
            this.getTitleLabel().text = this.var_617 < this.var_255.length && this.var_617 > -1 ? this.var_255[this.var_617] : caption;
         }
      }
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_556,var_79,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_385,var_79,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         _loc4_.addListItem(_loc10_);
         _loc4_.autoArrangeItems = true;
         this.fitToDesktop(param2);
         param2.activate();
         if(this.var_617 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(this.var_617).setStateFlag(WindowState.const_55,true);
         }
      }
      ...
      {
         var _loc3_:* = 0;
         if(param1.type == WindowMouseEvent.const_42 || param1.type == WindowTouchEvent.const_883)
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowTouchEvent.const_1277:
            case WindowMouseEvent.const_52:
               ...
               break;
            case WindowTouchEvent.const_752:
      ...
      public function open() : Boolean
      {
         ...
         _loc1_.recycle();
         visible = true;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1519,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1685,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         visible = false;
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1553,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enumerateSelection() : Array
      {
         ...
         if(!_disposed)
         {
            ...
            {
               _loc1_.push(this.var_255[_loc2_]);
               _loc2_++;
            }
         }
         return _loc1_;
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_255.length)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_832,this.var_255,PropertyStruct.const_133,true));
         }
         else
         {
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         {
            if(_loc2_.key == PropertyDefaults.const_832)
            {
