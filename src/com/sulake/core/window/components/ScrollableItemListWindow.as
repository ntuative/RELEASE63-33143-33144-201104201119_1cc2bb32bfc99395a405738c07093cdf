package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1182:IItemListWindow;
      
      private var var_432:IScrollbarWindow;
      ...
      public function ScrollableItemListWindow(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         if(this._scrollBar.testStateFlag(WindowState.const_84))
         {
            this.hideScrollBar();
         }
      }
      ...
      override public function dispose() : void
      {
         if(this.var_432)
         {
            this.var_432.removeEventListener(WindowEvent.const_237,this.scrollBarEventProc);
            this.var_432.removeEventListener(WindowEvent.const_186,this.scrollBarEventProc);
            this.var_432 = null;
         }
         if(this.var_1182)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1182)
         {
            this.var_1182 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_432)
         {
            this.var_432 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_432)
            {
               this.var_432.addEventListener(WindowEvent.const_237,this.scrollBarEventProc);
               this.var_432.addEventListener(WindowEvent.const_186,this.scrollBarEventProc);
            }
         }
         return this.var_432;
      }
      ...
      {
         return this._itemList.method_4(param1);
      }
