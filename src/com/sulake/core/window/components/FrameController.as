package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1320:String = "_TITLE";
      
      private static const const_1319:String = "_HEADER";
      
      private static const const_1317:String = "_CONTENT";
      
      private static const const_1318:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1373:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1320) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1373 = findChildByTag(const_1319) as IHeaderWindow;
            if(!this.var_1373)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_181 = findChildByTag(const_1317) as IWindowContainer;
            if(!this.var_181)
            {
      ...
      {
         return findChildByTag(const_1318) as IScalerWindow;
      }
      ...
      override public function set color(param1:uint) : void
      {
         ...
         groupChildrenWithTag(const_1289,_loc2_,false);
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_298);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_278);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_284);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_278,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_278,false);
            }
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_284,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_284,false);
            }
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_289,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         if(_loc2_)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_246,_loc3_.left,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_244,_loc3_.top,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_277,0 - _loc3_.right,PropertyStruct.const_43,_loc2_));
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_275,0 - _loc3_.bottom,PropertyStruct.const_43,_loc2_));
         }
         else
         {
