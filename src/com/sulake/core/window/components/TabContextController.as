package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1435:String = "_CONTENT";
       
      
      protected var var_1076:ITabSelectorWindow;
      
      protected var var_2131:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1076 = findChildByTag(const_1434) as ITabSelectorWindow;
            if(this.var_1076 != null)
            {
               this.var_1076.procedure = this.selectorEventProc;
            }
         }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_2131 = findChildByTag(const_1435) as IWindowContainer;
         }
      ...
      {
         return !!this.var_729 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_1076.numSelectables;
      }
