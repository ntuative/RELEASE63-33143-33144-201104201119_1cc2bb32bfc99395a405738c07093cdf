package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      protected var var_1615:uint = 500;
      
      protected var var_1345:String = "";
      
      protected var var_1335:Boolean = false;
      
      protected var var_729:Boolean = false;
      ...
      {
         this.var_1345 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_729 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_179,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
         {
            _context.handleError(WindowContext.const_412,e);
         }
      }
      ...
      private function onKeyUpEvent(param1:KeyboardEvent) : void
      {
         ...
         try
         {
            windowEvent = WindowKeyboardEvent.allocate(WindowKeyboardEvent.const_339,event,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      private function onChangeEvent(param1:Event) : void
      {
         ...
         {
            this.refreshAutoSize();
            windowEvent = WindowEvent.allocate(WindowEvent.const_101,this,null);
            this.update(this,windowEvent);
            windowEvent.recycle();
         }
         catch(e:Error)
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_813,false,PropertyStruct.const_39,true) : PropertyDefaults.const_1505);
         _loc1_.push(this.var_1335 != PropertyDefaults.const_1060 ? new PropertyStruct(PropertyDefaults.const_850,this.var_1335,PropertyStruct.const_39,true) : PropertyDefaults.const_1637);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1179 ? new PropertyStruct(PropertyDefaults.const_889,_field.selectable,PropertyStruct.const_39,true) : PropertyDefaults.const_1583);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1123 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_39,true) : PropertyDefaults.const_1680);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_813:
                  ...
                  break;
               case PropertyDefaults.const_1252:
