package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_340)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1250)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_874;
         if(this.var_874 != param1)
         {
            if(this.var_874 != null)
            {
               if(!this.var_874.disposed)
               {
                  this.var_874.deactivate();
               }
            }
            this.var_874 = param1;
