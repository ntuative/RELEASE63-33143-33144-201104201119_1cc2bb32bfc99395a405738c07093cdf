package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static const const_1292:Dictionary = createPropertySetterTable();
       
      
      protected var _field:TextField;
      
      protected var var_881:Number;
      
      protected var var_569:Number;
      ...
      protected var var_130:Boolean = false;
      
      protected var var_1079:Boolean = false;
      
      private var var_458:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_458,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_458 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_458,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         if(!_loc4_)
         {
            _loc4_ = TextStyleManager.getStyle(TextStyleManager.const_205);
         }
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_721 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_458);
      }
      ...
      {
         this.var_881 = param1;
         this._field.scrollH = this.var_881 * Number(this._field.maxScrollH);
      ...
      {
         return new Rectangle(this.var_881 * this.maxScrollH,this.var_569 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_458);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_936,this._field.antiAliasType,PropertyStruct.const_56,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1184));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1068 ? new PropertyStruct(PropertyDefaults.const_915,this._autoSize,PropertyStruct.const_56,true,PropertyDefaults.const_1056) : PropertyDefaults.const_1565);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_251,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1073 ? new PropertyStruct(PropertyDefaults.const_1186,this._field.gridFitType,PropertyStruct.const_56,true,PropertyDefaults.const_1281) : PropertyDefaults.const_1559);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_700) ? new PropertyStruct(PropertyDefaults.const_373,this._field.textColor,PropertyStruct.const_153,true) : PropertyDefaults.const_1253);
         _loc1_.push(this.var_458 != TextStyleManager.const_205 ? new PropertyStruct(PropertyDefaults.const_429,this.var_458,PropertyStruct.const_56,true,PropertyDefaults.const_709) : PropertyDefaults.const_1181);
         _loc1_.push(this.var_43.left != PropertyDefaults.const_690 ? new PropertyStruct(PropertyDefaults.const_246,this.var_43.left,PropertyStruct.const_43,true) : PropertyDefaults.const_469);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_886 ? new PropertyStruct(PropertyDefaults.const_244,this.var_43.top,PropertyStruct.const_43,true) : PropertyDefaults.const_499);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_711 ? new PropertyStruct(PropertyDefaults.const_277,this.var_43.right,PropertyStruct.const_43,true) : PropertyDefaults.const_518);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_884 ? new PropertyStruct(PropertyDefaults.const_275,this.var_43.bottom,PropertyStruct.const_43,true) : PropertyDefaults.const_516);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1101 ? new PropertyStruct(PropertyDefaults.const_800,this._field.mouseWheelEnabled,PropertyStruct.const_39,true) : PropertyDefaults.const_1581);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_120,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_120,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_120,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
