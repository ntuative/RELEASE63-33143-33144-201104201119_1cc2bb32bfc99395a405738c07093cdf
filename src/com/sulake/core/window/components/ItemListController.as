package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_2127:Boolean = false;
      
      protected var var_565:Boolean = false;
      ...
      protected var var_1339:Number;
      
      protected var var_1336:Number;
      
      protected var var_1337:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         var_175 = var_472 || !testParamFlag(WindowParam.const_33);
         this._container = _context.create("_CONTAINER","",WindowType.const_385,WindowStyle.const_167,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
         this._container.addEventListener(WindowEvent.const_40,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_419,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_146,this.containerEventHandler);
         this._container.addEventListener(WindowEvent.const_190,this.containerEventHandler);
         this._container.clipping = clipping;
         this.resizeOnItemUpdate = this.var_1338;
      }
      ...
      {
         return new Rectangle(this.var_697 * this.maxScrollH,this.var_700 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            this.var_697 = param1;
            this._container.x = -this.var_697 * this.maxScrollH;
            _context.invalidate(this._container,this.visibleRegion,WindowRedrawFlag.const_60);
            _loc2_ = WindowEvent.allocate(WindowEvent.const_536,this,null);
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(this._container)
         {
            if(this._horizontal)
            {
               this._container.setParamFlag(WindowParam.const_561,param1);
            }
            else
            {
               this._container.setParamFlag(WindowParam.const_471,param1);
            }
         }
      }
      ...
      override public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            this._container.removeEventListener(WindowEvent.const_419,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_146,this.containerEventHandler);
            this._container.removeEventListener(WindowEvent.const_190,this.containerEventHandler);
            super.dispose();
         }
      }
      ...
      public function method_4(param1:uint) : IWindow
      {
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_209:
               if(this.var_1337)
               {
                  this.var_1339 = this.var_2128 - _loc3_;
                  this.var_1336 = this.var_2126 - _loc4_;
                  if(this._horizontal)
                  {
                     if(this.var_1339 != 0 && this.var_112 != 0)
                     {
                        this.scrollH += this.var_1339 / this.var_112;
                     }
                  }
                  else if(this.var_1336 != 0 && this.var_99 != 0)
                  {
                     this.scrollV += this.var_1336 / this.var_99;
                  }
                  this.var_2128 = _loc3_;
                  this.var_2126 = _loc4_;
                  _loc2_ = true;
            ...
            case WindowMouseEvent.const_207:
               if(this.var_1337)
               {
                  if(this._horizontal)
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,-this.var_1339,0);
                  }
                  else
                  {
                     _context.getWindowServices().getGestureAgentService().begin(this,this.scrollAnimationCallback,0,0,-this.var_1336);
                  }
                  this.var_1337 = false;
                  _loc2_ = true;
               }
      ...
      protected function updateScrollAreaRegion() : void
      {
         ...
         var _loc3_:int = 0;
         var _loc4_:int = 0;
         if(this.var_1075 && !this.var_565 && this._container)
         {
            this.var_565 = true;
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_734)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_388,this._spacing,PropertyStruct.const_43,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1197);
         }
         if(this.var_1075 != PropertyDefaults.const_1204)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_920,this.var_1075,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1747);
         }
         if(this.var_468 != PropertyDefaults.const_1143)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_863,this.var_468,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1523);
         }
         if(this.var_1338 != PropertyDefaults.const_1132)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_831,this.var_1338,PropertyStruct.const_39,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1535);
         }
         if(this.var_698 != PropertyDefaults.const_1276)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_788,this.var_698,PropertyStruct.const_120,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1617);
         }
         if(this.var_699 != PropertyDefaults.const_1096)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_935,this.var_699,PropertyStruct.const_120,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1497);
         }
         return _loc1_;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_388:
                  this.spacing = _loc2_.value as int;
                  break;
               case PropertyDefaults.const_863:
               ...
               case PropertyDefaults.const_788:
                  ...
                  break;
               case PropertyDefaults.const_935:
