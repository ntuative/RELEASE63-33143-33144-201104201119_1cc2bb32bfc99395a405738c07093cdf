package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_617)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_617)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_780,param1.toolTipCaption,PropertyStruct.const_56,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1658);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1095)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_930,param1.toolTipDelay,PropertyStruct.const_251,true));
         }
         else
         {
      ...
      {
         this.var_1345 = param1 == null ? "null" : param1;
      }
