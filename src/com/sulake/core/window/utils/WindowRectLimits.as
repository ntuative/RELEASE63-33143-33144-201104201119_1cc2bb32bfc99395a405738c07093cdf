package com.sulake.core.window.utils
{
   ...
   public class WindowRectLimits implements IRectLimiter
   {
      ...
      private var var_324:int = -2.147483648E9;
      ...
      {
         this.var_324 = param1;
         if(this.var_324 > int.MIN_VALUE && !this._target.disposed && this._target.width < this.var_324)
         {
      ...
      {
         this.var_325 = param1;
         if(this.var_325 < int.MAX_VALUE && !this._target.disposed && this._target.width > this.var_325)
         {
      ...
      {
         return this.var_324 == int.MIN_VALUE && this.var_325 == int.MAX_VALUE && this.var_323 == int.MIN_VALUE && this.var_322 == int.MAX_VALUE;
      }
      
      public function setEmpty() : void
      {
         this.var_324 = int.MIN_VALUE;
      ...
      public function limit() : void
      {
         ...
         {
            if(this._target.width < this.var_324)
            {
               this._target.width = this.var_324;
            }
            else if(this._target.width > this.var_325)
            {
               this._target.width = this.var_325;
            }
