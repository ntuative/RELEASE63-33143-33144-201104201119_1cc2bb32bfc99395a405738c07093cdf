package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1106:String = "_EXCLUDE";
      
      public static const const_1910:String = "_INCLUDE";
      
      public static const const_1873:String = "_TEMP";
      
      private static const const_1346:String = "layout";
      
      private static const const_987:String = "window";
      
      private static const const_988:String = "variables";
      
      private static const const_986:String = "filters";
      
      private static const const_450:String = "name";
      
      private static const const_1344:String = "style";
      
      private static const const_644:String = "params";
      
      private static const const_1340:String = "tags";
      ...
      private static const const_1336:String = "visible";
      
      private static const const_1345:String = "caption";
      ...
      private static const const_1343:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1333:String = "treshold";
      
      private static const const_1337:String = "children";
      
      private static const const_1347:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1342:String = "height_min";
      
      private static const const_1334:String = "height_max";
      
      private static const const_643:String = "true";
      
      private static const const_168:String = "0";
      
      private static const const_1335:String = "$";
      
      private static const const_1339:String = ",";
      
      private static const const_49:String = "";
      
      private static const const_1341:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      ...
      protected var var_1609:Dictionary;
      
      protected var var_2118:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1329,this.var_1330);
         this.var_1070 = new Dictionary();
         this.var_1609 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1070,this.var_1609);
         this.var_2118 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1338,const_49);
         return param1.replace(const_1341,const_49);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1070)
            {
               delete this.var_1070[_loc1_];
            }
            for(_loc1_ in this.var_1609)
            {
               delete this.var_1609[_loc1_];
            }
            this.var_2118.dispose();
            this.var_2118 = null;
            this._context = null;
            this._disposed = true;
         }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1346)
         {
            ...
            _loc9_ = param1.child(const_986).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1329[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_450,variables,"")));
         style = uint(this.parseAttribute(xml,const_1344,variables,style));
         params = uint(this.parseAttribute(xml,const_644,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1340,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_168));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_168));
         rect.width = Number(this.parseAttribute(xml,name_5,variables,const_168));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_168));
         visible = this.parseAttribute(xml,const_1336,variables,visible.toString()) == const_643;
         id = int(this.parseAttribute(xml,ID,variables,id.toString()));
         if(xml.child(const_644).length() > 0)
         {
            list = xml.child(const_644).children();
            length = list.length();
            i = 0;
            while(i < length)
            {
               node = list[i];
               param = this.parseAttribute(node,const_450,variables,"") as String;
               if(this.var_1070[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_450)) + "\"!");
               }
               params |= this.var_1070[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_49) : const_49;
         caption = unescape(String(this.parseAttribute(xml,const_1345,variables,caption)));
         if(tag != const_49)
         {
            tags = tag.split(const_1339);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window.limits.minWidth = int(this.parseAttribute(xml,const_1347,variables,window.limits.minWidth));
         ...
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1334,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_643;
         blend = Number(this.parseAttribute(xml,const_1151,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1343,variables,window.clipping.toString()) == const_643;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1333,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_986).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(window != null)
         {
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  ...
                  {
                     if((params & 0) == WindowParam.const_208)
                     {
                        window.x = rect.x;
                     }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:* = const_49;
         var _loc3_:String = this.var_1330[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1106) == -1)
                  {
