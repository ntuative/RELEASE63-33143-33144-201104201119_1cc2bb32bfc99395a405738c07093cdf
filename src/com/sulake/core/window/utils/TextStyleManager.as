package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_205:String = "regular";
      
      public static const ITALIC:String = "italic";
      
      public static const BOLD:String = "bold";
      
      private static var var_89:Map;
      
      private static var var_544:Array;
      
      private static var _eventDispatcher:IEventDispatcher;
      
      private static const const_661:String = "{";
      
      private static const const_660:String = "}";
      
      private static const const_1464:String = "/*";
      ...
      {
         return var_89.getWithIndex(param1);
      }
      
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         var _loc3_:* = var_89.getKeys().indexOf(param1) == -1;
         param2.name = param1;
         var_89[param1] = param2;
         if(_loc3_)
         {
            var_544.push(param1);
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_89[const_205],var_89[ITALIC],var_89[BOLD]];
            var_89.reset();
            var_89[const_205] = _loc5_[0];
            var_89[ITALIC] = _loc5_[1];
            var_89[BOLD] = _loc5_[2];
         }
         var _loc3_:int = 0;
         for each(_loc4_ in param1)
         {
            var_89[_loc4_.name] = _loc4_;
            if(var_544.indexOf(_loc4_.name) == -1)
            {
               var_544.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
         if(var_89.length != _loc3_)
         {
            _eventDispatcher.dispatchEvent(new Event(Event.ADDED));
         }
      }
      ...
      public static function enumerateStyles() : Array
      {
         ...
         while(_loc3_ < _loc2_)
         {
            _loc1_.push(var_89.getWithIndex(_loc3_));
            _loc3_++;
         }
         return _loc1_;
      }
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_660);
         if(countSubStrings(param1,const_661) != countSubStrings(param1,const_660))
         {
            throw new Error("Mismatching amount of \"" + const_661 + "\" versus \"" + const_660 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1464) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1465) + 2,_loc5_.length);
            }
            _loc5_ = _loc5_.slice(0,_loc5_.indexOf(const_661)).split(" ").join("");
            if(_loc5_.length)
            {
               _loc2_.push(_loc5_);
            }
