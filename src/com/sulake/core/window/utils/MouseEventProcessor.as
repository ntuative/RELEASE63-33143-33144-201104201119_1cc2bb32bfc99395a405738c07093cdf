package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_879:IWindowContextStateListener;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_333 = new Array();
            var_333[0] = MouseCursorType.const_353;
            var_333[1] = MouseCursorType.const_30;
            var_333[2] = MouseCursorType.const_353;
            var_333[3] = MouseCursorType.const_353;
            var_333[4] = MouseCursorType.const_353;
            var_333[5] = MouseCursorType.const_30;
            var_333[6] = MouseCursorType.const_353;
         }
         if(var_289 == null)
         {
            var_289 = new Array();
            var_289[0] = WindowState.const_111;
            var_289[1] = WindowState.const_82;
            var_289[2] = WindowState.const_90;
            var_289[3] = WindowState.const_73;
            var_289[4] = WindowState.const_55;
            var_289[5] = WindowState.const_89;
            var_289[6] = WindowState.const_84;
         }
      }
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_65 = state.var_1323 as WindowController;
         this.var_176 = state.var_1326 as WindowController;
         this.var_164 = state.renderer;
         this.var_879 = state.var_1325;
         eventQueue.begin();
         this.var_701.x = -1;
         this.var_701.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_701.x || event.stageY != this.var_701.y)
            {
               ...
               array = new Array();
               this.var_83.groupParameterFilteredChildrenUnderPoint(this.var_701,array,WindowParam.const_31);
            }
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_65.getGlobalPosition(var_404);
               ...
               if(child != null && child.visible)
               {
                  ...
                  else if(event.type == MouseEvent.MOUSE_UP || event.type == MouseEvent.CLICK)
                  {
                     if(this.var_65 && !this.var_65.disposed)
                     {
                        ...
                        {
                           this.var_879.mouseEventReceived(event.type,this.var_65);
                        }
                     }
                  }
                  temp = child.parent;
         ...
         state.var_1323 = this.var_65;
         state.var_1326 = this.var_176;
         state.renderer = this.var_164;
         state.var_1325 = this.var_879;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         if(param1.testParamFlag(WindowParam.const_618))
         {
