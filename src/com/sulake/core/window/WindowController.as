package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IGraphicContextHost
   {
      ...
      private static var var_1148:uint = 0;
      
      protected static const TAG_EXCLUDE:String = "_EXCLUDE";
      
      protected static const TAG_INTERNAL:String = "_INTERNAL";
      
      protected static const const_1289:String = "_COLORIZE";
      
      protected static const const_1290:String = "_IGNORE_INHERITED_STYLE";
      
      private static const const_994:Point = new Point();
      ...
      public function WindowController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this.var_352 = new Rectangle();
         if(_loc12_ != null)
         {
            var_402 = new Rectangle(0,0,int(_loc12_.attribute("width")),int(_loc12_.attribute("height")));
            var_64 = var_402.clone();
            var_11 = var_402.clone();
         ...
         if(_loc13_)
         {
            var_745 = _loc13_.blend;
            var_471 = _loc13_.var_2895;
            if(var_472 != _loc13_.background)
            {
               this.background = _loc13_.background;
            }
            if(var_241 != _loc13_.color)
            {
      ...
      {
         var_472 = param1;
         var_241 = !!var_472 ? uint(var_241 | var_567) : uint(var_241 & 16777215);
      ...
      {
         var_567 = param1 & 4278190080;
         var_241 = !!var_472 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      ...
      {
         var_567 = param1 << 24;
         var_241 = !!var_472 ? uint(var_567 | var_241) : uint(16777215 & var_241);
         _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
      }
      
      public function set blend(param1:Number) : void
      {
         var_745 = param1 > 1 ? 1 : (param1 < 0 ? 0 : Number(param1));
      ...
      {
         var_471 = param1 > 255 ? 255 : uint(param1);
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            _context.invalidate(this,var_11,WindowRedrawFlag.const_707);
         }
      }
      ...
      public function set style(param1:uint) : void
      {
         ...
         if(param1 != var_79)
         {
            ...
            while(--_loc3_ > -1)
            {
               ...
               if(_loc4_.tags.indexOf(const_1290) == -1)
               {
                  _loc4_.style = var_79;
               }
            }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(this._parent != param1)
         {
            ...
            if(this._parent != null)
            {
               this.var_352 = this._parent.rectangle.clone();
               var_64.x = var_11.x;
               var_64.y = var_11.y;
               var_64.width = var_11.width;
               var_64.height = var_11.height;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_534,this,this._parent);
            ...
            else
            {
               this.var_352.x = 0;
               this.var_352.y = 0;
               this.var_352.width = 0;
               this.var_352.height = 0;
               _loc4_ = WindowEvent.allocate(WindowEvent.const_1748,this,_loc2_);
               this.update(this,_loc4_);
            }
            _loc4_.recycle();
         }
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,_type,var_79,var_19,_context,var_11,null,this.var_695,this.properties,var_880.concat(),_id) as WindowController;
         _loc2_.var_471 = var_471;
         _loc2_.var_175 = this.var_175;
         _loc2_._debug = this._debug;
         _loc2_.var_352 = this.var_352.clone();
         _loc2_.var_11 = var_11.clone();
         _loc2_.var_402 = var_402.clone();
      ...
      override public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            ...
            if(true)
            {
               ...
               {
                  if(this.getStateFlag(WindowState.const_111))
                  {
                     this.deactivate();
                  }
               }
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + this.var_2315 + "]";
      }
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_510)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_557)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_19 & 0);
            if(_loc7_ == WindowParam.const_613)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_558)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         ...
         if(_loc5_ || _loc6_)
         {
            ...
            if(_loc6_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_1234,this,null,true);
               this.update(this,_loc9_);
               if(_loc9_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc5_)
            {
               _loc9_ = WindowEvent.allocate(WindowEvent.const_276,this,null);
               this.update(this,_loc9_);
               _loc9_.recycle();
            }
            if(_loc6_)
      ...
      public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = 0;
         if(!testParamFlag(WindowParam.const_714))
         {
         ...
         if(param2 is WindowMouseEvent)
         {
            switch(param2.type)
            {
               case WindowMouseEvent.const_42:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_1220;
                  if(testParamFlag(WindowParam.const_422))
                  {
                     _loc3_ = {};
                     while(_loc3_ != null)
                     {
                  ...
                  if((var_19 & 0) > 0)
                  {
                     ...
                     while(_loc3_ != null)
                     {
                        if(_loc3_.testParamFlag(WindowParam.const_298))
                        {
               ...
               case WindowMouseEvent.const_52:
                  ...
                  if(testParamFlag(WindowParam.const_298))
                  {
         ...
         else if(param2 is WindowEvent)
         {
            switch(param2.type)
            {
               case WindowEvent.const_40:
                  ...
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_691,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(testParamFlag(WindowParam.const_208,WindowParam.const_170))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_204,WindowParam.const_165))
                     {
                        this.updateScaleRelativeToParent();
                     }
                     if(this._parent != null)
                     {
                        _loc6_ = uint(var_19);
                        var_19 &= ~(0 | 0);
                        if(testParamFlag(WindowParam.const_561))
                        {
                           this._parent.width += 0 - 0;
                        }
                        if(testParamFlag(WindowParam.const_471))
                        {
                           this._parent.height += 0 - 0;
                        }
                        var_19 = _loc6_;
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_146,this._parent,this);
               ...
               case WindowEvent.const_276:
                  _context.invalidate(this,var_11.union(var_64),WindowRedrawFlag.const_1128);
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1729,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_190,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_481:
                  if(param1 == this)
                  {
                     _loc5_ = WindowEvent.allocate(WindowEvent.const_1250,this,null);
                     this.notifyChildren(_loc5_);
                     _loc5_.recycle();
                     if(this._parent != null)
                     {
                        _loc5_ = WindowEvent.allocate(WindowEvent.const_340,this._parent,this);
                        this._parent.update(this,_loc5_);
                        _loc5_.recycle();
                     }
                  }
               ...
               case WindowEvent.const_534:
                  ...
                  _context.invalidate(this,var_11,WindowRedrawFlag.const_60);
                  break;
               case WindowEvent.const_691:
                  this._parent.getRegionProperties(null,this.var_352);
                  this.updateScaleRelativeToParent();
                  break;
               case WindowEvent.const_453:
               ...
               case WindowEvent.const_419:
                  break;
               case WindowEvent.const_340:
                  this.activate();
                  break;
               case WindowEvent.const_146:
                  if(testParamFlag(WindowParam.const_67))
                  {
                     expandToAccommodateChild(this,param2.related);
                  }
                  break;
               case WindowEvent.const_190:
                  if(testParamFlag(WindowParam.const_67))
                  {
                     expandToAccommodateChild(this,param2.related);
                  }
      ...
      {
         return this.testLocalPointHitAgainstAlpha(param1,param2,var_471);
      }
      ...
      public function validateGlobalPointIntersection(param1:Point, param2:BitmapData) : Boolean
      {
         ...
         return this.testLocalPointHitAgainstAlpha(_loc3_,param2,var_471);
      }
         ...
         if(this.var_175 && var_471 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_11.width && param1.y <= var_11.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(const_994,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(const_994,param3,param1)) : false;
            }
         }
      ...
      public function expandToAccommodateChildren() : void
      {
         ...
         var _loc8_:Boolean = this.getParamFlag(WindowParam.const_67);
         ...
         if(_loc7_)
         {
            if(_loc8_)
            {
               this.setParamFlag(WindowParam.const_67,false);
            }
            ...
            if(_loc8_)
            {
               this.setParamFlag(WindowParam.const_67,true);
            }
         }
      }
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_79 != _loc3_)
         {
            ...
            while(--_loc5_ > -1)
            {
               ...
               if(_loc6_.tags.indexOf(const_1290) == -1)
               {
                  _loc6_.style = var_79;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_148,WindowParam.const_170);
         var _loc2_:* = !testParamFlag(WindowParam.const_156,WindowParam.const_165);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_11.clone();
            if(_loc1_)
            {
               _loc4_ = this._parent.width - this.var_352.width;
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.const_404)
               {
                  _loc3_.width += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_424)
               {
                  _loc3_.x += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_208)
               {
            ...
            if(_loc2_)
            {
               _loc4_ = this._parent.height - this.var_352.height;
               _loc5_ = uint(var_19 & 0);
               if(_loc5_ == WindowParam.const_344)
               {
                  _loc3_.height += _loc4_;
               }
               else if(_loc5_ == WindowParam.const_259)
               {
                  _loc3_.y += _loc4_;
               }
      ...
      public function destroy() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1776,this,null);
         ...
         _loc1_.recycle();
         _loc1_ = WindowEvent.allocate(WindowEvent.const_352,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         this.dispose();
         return true;
      ...
      public function minimize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1594,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function maximize() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1779,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_73,true);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1537,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function restore() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1609,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_111,true);
      ...
      public function deactivate() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1688,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_111,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_571,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unlock() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1646,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_.recycle();
         this.setStateFlag(WindowState.const_73,false);
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1515,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function enable() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_678,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
      ...
      public function disable() : Boolean
      {
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_186,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function unfocus() : Boolean
      {
         ...
         var _loc1_:WindowEvent = WindowEvent.allocate(WindowEvent.const_1710,this,null);
         this.update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            _loc1_.recycle();
         ...
         _loc1_ = WindowEvent.allocate(WindowEvent.const_1712,this,null);
         this.update(this,_loc1_);
         _loc1_.recycle();
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(this.var_1147 || _loc2_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc3_:WindowEvent = WindowEvent.allocate(WindowEvent.const_453,this,param1);
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(this.var_1147 || _loc3_.hasGraphicsContext())
         {
            this.setupGraphicsContext();
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_453,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         var _loc4_:WindowEvent = WindowEvent.allocate(WindowEvent.const_419,this,param1);
         this.update(this,_loc4_);
         _loc4_.recycle();
         return param1;
      }
