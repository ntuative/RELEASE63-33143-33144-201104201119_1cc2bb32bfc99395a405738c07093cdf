package com.sulake.core.utils
{
   public class ErrorReportStorage
   {
      ...
      private static var var_1194:Map = new Map();
      
      private static var var_776:Map = new Map();
      ...
      public static function getDebugData() : String
      {
         var _loc1_:String = "";
         var _loc2_:int = 0;
         while(_loc2_ < var_776.length)
         {
            if(_loc2_ == 0)
            {
               _loc1_ = var_776.getWithIndex(_loc2_);
            }
            else
            {
               _loc1_ = _loc1_ + " ** " + var_776.getWithIndex(_loc2_);
            }
            _loc2_++;
         }
      ...
      {
         var_776.remove(param1);
         var_776.add(param1,param2);
      }
      
      public static function setParameter(param1:String, param2:String) : void
      {
         var_1194[param1] = param2;
      }
