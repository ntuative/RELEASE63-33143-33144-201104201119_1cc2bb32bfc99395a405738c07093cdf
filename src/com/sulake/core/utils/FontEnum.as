package com.sulake.core.utils
{
   ...
   public class FontEnum
   {
      ...
      private static const const_360:Map = new Map();
      
      private static var var_1299:Boolean = false;
      ...
      {
         return const_360.getValue(param1) != null;
      }
      ...
      public static function registerFont(param1:Class) : Font
      {
         ...
         const_360.add(_loc4_.fontName,_loc4_);
         return _loc4_;
      }
      ...
      public static function refresh() : void
      {
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            _loc3_ = const_360.getValue(_loc2_.fontName);
            if(!_loc3_ || _loc3_.fontType != _loc2_.fontType || _loc3_.fontStyle != _loc2_.fontStyle)
            {
               const_360.add(_loc2_.fontName,_loc2_);
            }
            _loc5_++;
         }
      }
