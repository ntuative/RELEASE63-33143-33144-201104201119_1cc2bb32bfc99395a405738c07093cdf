package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1255:String = "AssetLibraryReady";
      
      public static const const_835:String = "AssetLibraryLoaded";
      
      public static const const_1595:String = "AssetLibraryUnloaded";
      
      public static const const_1665:String = "AssetLibraryLoadError";
      
      private static const const_450:String = "name";
      
      private static const const_1015:String = "asset";
      
      private static const const_1014:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1016:String = "library";
      
      private static var var_305:Dictionary;
      
      private static var var_1826:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_507:uint = 0;
      
      private static var var_960:Array = new Array();
      ...
      private var var_962:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         this.var_508 = new Dictionary(false);
         this.var_962 = new Dictionary(false);
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         var _loc5_:XMLList = param2.child(const_1016);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1015);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1014);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_635 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_960.splice(var_960.indexOf(this),1);
            --var_507;
            this.var_508 = null;
            this.var_962 = null;
            this.var_161 = null;
      ...
      {
         if(this.var_635 == param1.url && this.var_961)
         {
            if(!this.var_963 && param2)
            {
               AssetLibrary.fetchLibraryContents(this,this._manifest,this.var_636);
            }
            this.var_963 = param2;
            dispatchEvent(new Event(AssetLibrary.const_1255));
         }
         else
         {
      ...
      public function unload() : void
      {
         ...
         for(_loc1_ in this.var_962)
         {
            delete this.var_962[_loc1_];
         }
         if(this.var_45 != null)
         {
            this.var_45.dispose();
         ...
         this.var_961 = false;
         this.var_635 = null;
         dispatchEvent(new Event(AssetLibrary.const_1595));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_962[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_508[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1168,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1254,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1147,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_508[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_508[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.const_29:
               ...
               if(decl != null)
               {
                  ...
                  {
                     ++this.var_433;
                     this.var_435.push(struct.assetName);
                  }
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_508[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         return param1 < this.var_435.length ? this.getAssetByName(this.var_435[param1]) : null;
      }
      ...
      public function getAssetIndex(param1:IAsset) : int
      {
         ...
         for(_loc2_ in this.var_161)
         {
            ...
            {
               return this.var_435.indexOf(_loc2_);
            }
         }
         return -1;
      }
      ...
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         ...
         if((param3 || _loc4_) && param2)
         {
            ...
            {
               ++this.var_433;
               this.var_435.push(param1);
            }
            this.var_161[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_1826.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function removeAsset(param1:IAsset) : IAsset
      {
         ...
         if(param1)
         {
            for(_loc2_ in this.var_161)
            {
               if(this.var_161[_loc2_] == param1)
               {
                  this.var_435.splice(this.var_435.indexOf(_loc2_),1);
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         if(param2)
         {
            if(var_305.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_305[param1.mimeType] = param1;
         }
         else
         {
            if(this.var_434.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_434[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            _loc3_ = AssetTypeDeclaration(var_305[param1]);
            if(_loc3_ != null)
            {
               return _loc3_;
            }
         }
         return AssetTypeDeclaration(this.var_434[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc4_ in var_305)
            {
               _loc3_ = AssetTypeDeclaration(var_305[_loc4_]);
               if(_loc3_ != null)
               {
         ...
         for(_loc4_ in this.var_434)
         {
            _loc3_ = AssetTypeDeclaration(this.var_434[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         if(param2)
         {
            for(_loc5_ in var_305)
            {
               _loc4_ = AssetTypeDeclaration(var_305[_loc5_]);
               if(_loc4_ != null)
               {
         ...
         for(_loc5_ in this.var_434)
         {
            _loc4_ = AssetTypeDeclaration(this.var_434[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         this.var_961 = true;
         dispatchEvent(new Event(AssetLibrary.const_835));
         dispatchEvent(new Event(AssetLibrary.const_1255));
         if(this.var_963)
         {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1665));
         this.var_45 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1016);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1015);
            _loc5_ = null;
            ...
            while(_loc8_ < _loc7_)
            {
               ...
               if(_loc3_.attribute(const_450).toString() == param1)
               {
                  ...
                  _loc6_ = _loc3_.child(const_1014);
                  if(_loc6_.length())
                  {
