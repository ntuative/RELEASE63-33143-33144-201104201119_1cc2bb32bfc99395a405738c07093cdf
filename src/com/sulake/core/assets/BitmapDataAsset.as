   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_531 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_110 is BitmapDataAsset)
         {
            ...
            this.var_1530 = BitmapDataAsset(this.var_110).var_1530;
            this.var_1531 = BitmapDataAsset(this.var_110).var_1531;
            if(this._bitmap != null)
            {
               this.var_110 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1530 = _loc4_ == "1" || _loc4_ == "true";
                  break;
               case "flipV":
                  this.var_1531 = _loc4_ == "1" || _loc4_ == "true";
                  break;
            }
            _loc2_++;
         }
